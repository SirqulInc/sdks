//
// UserLocationSearchResponse.swift
//
...
public struct UserLocationSearchResponse: Sendable, Codable, Hashable {
    ...
    public var userLocations: [UserLocationListResponse]?
    public var returning: String?

    public init(valid: Bool? = nil, message: String? = nil, version: Double? = nil, serializeNulls: Bool? = nil, startTimeLog: Int64? = nil, errorCode: String? = nil, request: [NameStringValueResponse]? = nil, hasMoreResults: Bool? = nil, count: Int? = nil, userLocations: [UserLocationListResponse]? = nil, returning: String? = nil) {
        self.valid = valid
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(userLocations, forKey: .userLocations)
