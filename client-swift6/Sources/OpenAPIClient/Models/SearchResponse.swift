...
public struct SearchResponse: Sendable, Codable, Hashable {
    ...
    public init(valid: Bool? = nil, message: String? = nil, version: Double? = nil, serializeNulls: Bool? = nil, startTimeLog: Int64? = nil, errorCode: String? = nil, request: [NameStringValueResponse]? = nil, items: [JSONValue]? = nil, count: Int? = nil, hasMoreResults: Bool? = nil, countTotal: Int64? = nil, start: Int64? = nil, limit: Int64? = nil, returning: String? = nil) {
        self.valid = valid
