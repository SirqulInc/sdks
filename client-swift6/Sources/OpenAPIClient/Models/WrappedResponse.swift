...
public struct WrappedResponse: Sendable, Codable, Hashable {
    ...
    public init(valid: Bool? = nil, message: String? = nil, version: Double? = nil, serializeNulls: Bool? = nil, startTimeLog: Int64? = nil, errorCode: String? = nil, request: [NameStringValueResponse]? = nil, type: String? = nil, item: JSONValue? = nil, messages: MessageListResponse? = nil, returning: String? = nil) {
        self.valid = valid
