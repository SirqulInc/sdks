...
public struct InviteResponse: Sendable, Codable, Hashable {
    ...
    public init(valid: Bool? = nil, message: String? = nil, version: Double? = nil, serializeNulls: Bool? = nil, startTimeLog: Int64? = nil, errorCode: String? = nil, request: [NameStringValueResponse]? = nil, url: String? = nil, token: String? = nil, offerId: Int64? = nil, offerLocationId: Int64? = nil, returning: String? = nil) {
        self.valid = valid
