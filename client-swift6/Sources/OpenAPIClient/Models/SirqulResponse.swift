...
public struct SirqulResponse: Sendable, Codable, Hashable {
    ...
    public init(valid: Bool? = nil, message: String? = nil, version: Double? = nil, serializeNulls: Bool? = nil, startTimeLog: Int64? = nil, errorCode: String? = nil, request: [NameStringValueResponse]? = nil, returning: String? = nil) {
        self.valid = valid
