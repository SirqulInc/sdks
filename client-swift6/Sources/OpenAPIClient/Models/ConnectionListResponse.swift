...
public struct ConnectionListResponse: Sendable, Codable, Hashable {
    ...
    public init(valid: Bool? = nil, message: String? = nil, version: Double? = nil, serializeNulls: Bool? = nil, startTimeLog: Int64? = nil, errorCode: String? = nil, request: [NameStringValueResponse]? = nil, connections: [ConnectionResponse]? = nil, friendCount: Int? = nil, followingCount: Int? = nil, itemCount: Int? = nil, hasMoreResults: Bool? = nil, returning: String? = nil) {
        self.valid = valid
