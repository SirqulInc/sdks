...
open class SimulationAPI {
     ...
     */
    open class func simulation(data: String, realTime: Bool, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SirqulResponse {
        return try await simulationWithRequestBuilder(data: data, realTime: realTime, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func simulationWithRequestBuilder(data: String, realTime: Bool, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<SirqulResponse> {
        let localVariablePath = "/simulation/routing"
