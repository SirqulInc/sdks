...
open class SimulationAPI {
     ...
     */
    open class func simulation(version: Double, data: String, realTime: Bool, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SirqulResponse {
        return try await simulationWithRequestBuilder(version: version, data: data, realTime: realTime, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func simulationWithRequestBuilder(version: Double, data: String, realTime: Bool, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<SirqulResponse> {
        var localVariablePath = "/api/{version}/simulation/routing"
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            ...
            "realTime": (wrappedValue: realTime.asParameter(codableHelper: apiConfiguration.codableHelper), isExplode: true),
        ])
