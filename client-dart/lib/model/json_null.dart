...
class JsonNull {
  /// Returns a new [JsonNull] instance.
  JsonNull({
    this.asInt,
    this.asJsonObject,
    this.jsonNull,
  ...
  /// Returns a new [JsonNull] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static JsonNull? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "JsonNull[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "JsonNull[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<JsonNull> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <JsonNull>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = JsonNull.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, JsonNull> mapFromJson(dynamic json) {
    final map = <String, JsonNull>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = JsonNull.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of JsonNull-objects as value to a dart map
  static Map<String, List<JsonNull>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<JsonNull>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = JsonNull.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
