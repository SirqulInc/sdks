...
class SearchResponse {
  ...
  @override
  String toString() => 'SearchResponse[valid=$valid, message=$message, version=$version, serializeNulls=$serializeNulls, startTimeLog=$startTimeLog, errorCode=$errorCode, request=$request, items=$items, count=$count, hasMoreResults=$hasMoreResults, countTotal=$countTotal, start=$start, limit=$limit, returning=$returning]';
