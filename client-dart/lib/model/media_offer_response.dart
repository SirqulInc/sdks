...
class MediaOfferResponse {
  /// Returns a new [MediaOfferResponse] instance.
  MediaOfferResponse({
    this.title,
    this.details,
    this.subTitle,
  ...
  MediaOfferResponseSpecialOfferTypeEnum? specialOfferType;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MediaOfferResponse &&
    other.title == title &&
  ...
  /// Returns a new [MediaOfferResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MediaOfferResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MediaOfferResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MediaOfferResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return MediaOfferResponse(
        ...
        offerVisibility: mapValueOfType<String>(json, r'offerVisibility'),
        ...
        specialOfferType: MediaOfferResponseSpecialOfferTypeEnum.fromJson(json[r'specialOfferType']),
        ...
        flagThreshold: mapValueOfType<int>(json, r'flagThreshold'),
        externalId: mapValueOfType<String>(json, r'externalId'),
        parentOffer: BaseOfferResponse.fromJson(json[r'parentOffer']),
  ...
  static List<MediaOfferResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MediaOfferResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MediaOfferResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MediaOfferResponse> mapFromJson(dynamic json) {
    final map = <String, MediaOfferResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MediaOfferResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MediaOfferResponse-objects as value to a dart map
  static Map<String, List<MediaOfferResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MediaOfferResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = MediaOfferResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class MediaOfferResponseSpecialOfferTypeEnum {
  /// Instantiate a new enum with the provided [value].
  const MediaOfferResponseSpecialOfferTypeEnum._(this.value);
  ...
  static const ALL = MediaOfferResponseSpecialOfferTypeEnum._(r'ALL');
  static const RESERVABLE = MediaOfferResponseSpecialOfferTypeEnum._(r'RESERVABLE');
  static const REGULAR_OFFER = MediaOfferResponseSpecialOfferTypeEnum._(r'REGULAR_OFFER');
  static const ACT_NOW = MediaOfferResponseSpecialOfferTypeEnum._(r'ACT_NOW');
  static const GET_THERE_NOW = MediaOfferResponseSpecialOfferTypeEnum._(r'GET_THERE_NOW');
  static const SQOOT = MediaOfferResponseSpecialOfferTypeEnum._(r'SQOOT');
  static const TICKETS = MediaOfferResponseSpecialOfferTypeEnum._(r'TICKETS');
  static const YIPIT = MediaOfferResponseSpecialOfferTypeEnum._(r'YIPIT');

  /// List of all possible values in this [enum][MediaOfferResponseSpecialOfferTypeEnum].
  static const values = <MediaOfferResponseSpecialOfferTypeEnum>[
    ALL,
    RESERVABLE,
    REGULAR_OFFER,
    ACT_NOW,
  ...
  static MediaOfferResponseSpecialOfferTypeEnum? fromJson(dynamic value) => MediaOfferResponseSpecialOfferTypeEnumTypeTransformer().decode(value);

  static List<MediaOfferResponseSpecialOfferTypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MediaOfferResponseSpecialOfferTypeEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MediaOfferResponseSpecialOfferTypeEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [MediaOfferResponseSpecialOfferTypeEnum] to String,
/// and [decode] dynamic data back to [MediaOfferResponseSpecialOfferTypeEnum].
class MediaOfferResponseSpecialOfferTypeEnumTypeTransformer {
  factory MediaOfferResponseSpecialOfferTypeEnumTypeTransformer() => _instance ??= const MediaOfferResponseSpecialOfferTypeEnumTypeTransformer._();

  const MediaOfferResponseSpecialOfferTypeEnumTypeTransformer._();

  String encode(MediaOfferResponseSpecialOfferTypeEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a MediaOfferResponseSpecialOfferTypeEnum.
  ///
  ...
  MediaOfferResponseSpecialOfferTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'ALL': return MediaOfferResponseSpecialOfferTypeEnum.ALL;
        case r'RESERVABLE': return MediaOfferResponseSpecialOfferTypeEnum.RESERVABLE;
        case r'REGULAR_OFFER': return MediaOfferResponseSpecialOfferTypeEnum.REGULAR_OFFER;
        case r'ACT_NOW': return MediaOfferResponseSpecialOfferTypeEnum.ACT_NOW;
        case r'GET_THERE_NOW': return MediaOfferResponseSpecialOfferTypeEnum.GET_THERE_NOW;
        case r'SQOOT': return MediaOfferResponseSpecialOfferTypeEnum.SQOOT;
        case r'TICKETS': return MediaOfferResponseSpecialOfferTypeEnum.TICKETS;
        case r'YIPIT': return MediaOfferResponseSpecialOfferTypeEnum.YIPIT;
        default:
          if (!allowNull) {
  ...
  /// Singleton [MediaOfferResponseSpecialOfferTypeEnumTypeTransformer] instance.
  static MediaOfferResponseSpecialOfferTypeEnumTypeTransformer? _instance;
}
