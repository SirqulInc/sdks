...
class OrderResponse {
  ...
  bool operator ==(Object other) => identical(this, other) || other is OrderResponse &&
    ...
    other.externalDate == externalDate &&
  ...
  int get hashCode =>
    ...
    (payments.hashCode) +
    (externalOrderId == null ? 0 : externalOrderId!.hashCode) +
    (created == null ? 0 : created!.hashCode) +
    (updated == null ? 0 : updated!.hashCode) +
    (externalDate == null ? 0 : externalDate!.hashCode) +
    (description == null ? 0 : description!.hashCode) +
    (returning == null ? 0 : returning!.hashCode);

  @override
  String toString() => 'OrderResponse[valid=$valid, message=$message, version=$version, serializeNulls=$serializeNulls, startTimeLog=$startTimeLog, errorCode=$errorCode, request=$request, orderId=$orderId, application=$application, customer=$customer, amount=$amount, purchases=$purchases, credits=$credits, payments=$payments, externalOrderId=$externalOrderId, created=$created, updated=$updated, externalDate=$externalDate, description=$description, returning=$returning]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.externalOrderId != null) {
      json[r'externalOrderId'] = this.externalOrderId;
    } else {
      json[r'externalOrderId'] = null;
    }
    ...
    if (this.externalDate != null) {
      json[r'externalDate'] = this.externalDate;
    } else {
      json[r'externalDate'] = null;
    }
  ...
  static OrderResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return OrderResponse(
        ...
        purchases: mapValueOfType<double>(json, r'purchases'),
        credits: mapValueOfType<double>(json, r'credits'),
        payments: PaymentTransactionResponse.listFromJson(json[r'payments']),
        externalOrderId: mapValueOfType<String>(json, r'externalOrderId'),
        created: mapValueOfType<int>(json, r'created'),
        updated: mapValueOfType<int>(json, r'updated'),
        externalDate: mapValueOfType<int>(json, r'externalDate'),
