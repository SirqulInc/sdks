...
class MessageResponse {
  ...
  @override
  String toString() => 'MessageResponse[message=$message, code=$code, ids=$ids, updateValue=$updateValue]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.updateValue != null) {
      json[r'updateValue'] = this.updateValue;
    } else {
      json[r'updateValue'] = null;
    }
    return json;
  }
  ...
  static MessageResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MessageResponse(
        ...
        ids: mapValueOfType<String>(json, r'ids'),
        updateValue: mapValueOfType<String>(json, r'updateValue'),
      );
    }
    return null;
  }
