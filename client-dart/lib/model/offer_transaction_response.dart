...
class OfferTransactionResponse {
  /// Returns a new [OfferTransactionResponse] instance.
  ...
  OfferTransactionResponseBarcodeTypeEnum? barcodeType;
  ...
  OfferTransactionResponseSpecialOfferTypeEnum? specialOfferType;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OfferTransactionResponse &&
    other.valid == valid &&
    ...
    other.usedDate == usedDate &&
    other.transactionCreated == transactionCreated &&
    other.transactionUpdated == transactionUpdated &&
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.purchasedDate != null) {
      json[r'purchasedDate'] = this.purchasedDate;
    } else {
      json[r'purchasedDate'] = null;
    }
    if (this.usedDate != null) {
      json[r'usedDate'] = this.usedDate;
    } else {
      json[r'usedDate'] = null;
    }
    if (this.transactionCreated != null) {
      json[r'transactionCreated'] = this.transactionCreated;
    } else {
      json[r'transactionCreated'] = null;
    }
    if (this.transactionUpdated != null) {
      json[r'transactionUpdated'] = this.transactionUpdated;
    } else {
      json[r'transactionUpdated'] = null;
    }
  ...
  /// Returns a new [OfferTransactionResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OfferTransactionResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OfferTransactionResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OfferTransactionResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return OfferTransactionResponse(
        ...
        barcodeType: OfferTransactionResponseBarcodeTypeEnum.fromJson(json[r'barcodeType']),
        ticketsReward: mapValueOfType<int>(json, r'ticketsReward'),
        ticketsRewardType: mapValueOfType<String>(json, r'ticketsRewardType'),
        specialOfferType: OfferTransactionResponseSpecialOfferTypeEnum.fromJson(json[r'specialOfferType']),
        ...
        purchasedDate: mapValueOfType<int>(json, r'purchasedDate'),
        usedDate: mapValueOfType<int>(json, r'usedDate'),
        transactionCreated: mapValueOfType<int>(json, r'transactionCreated'),
        transactionUpdated: mapValueOfType<int>(json, r'transactionUpdated'),
  ...
  static List<OfferTransactionResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OfferTransactionResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OfferTransactionResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OfferTransactionResponse> mapFromJson(dynamic json) {
    final map = <String, OfferTransactionResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OfferTransactionResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OfferTransactionResponse-objects as value to a dart map
  static Map<String, List<OfferTransactionResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OfferTransactionResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OfferTransactionResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class OfferTransactionResponseBarcodeTypeEnum {
  /// Instantiate a new enum with the provided [value].
  const OfferTransactionResponseBarcodeTypeEnum._(this.value);
  ...
  static const NONE = OfferTransactionResponseBarcodeTypeEnum._(r'NONE');
  static const UPC = OfferTransactionResponseBarcodeTypeEnum._(r'UPC');
  static const cODE128 = OfferTransactionResponseBarcodeTypeEnum._(r'CODE_128');
  static const QR = OfferTransactionResponseBarcodeTypeEnum._(r'QR');
  static const CUSTOM_MEDIA = OfferTransactionResponseBarcodeTypeEnum._(r'CUSTOM_MEDIA');

  /// List of all possible values in this [enum][OfferTransactionResponseBarcodeTypeEnum].
  static const values = <OfferTransactionResponseBarcodeTypeEnum>[
    NONE,
    UPC,
    cODE128,
    QR,
  ...
  static OfferTransactionResponseBarcodeTypeEnum? fromJson(dynamic value) => OfferTransactionResponseBarcodeTypeEnumTypeTransformer().decode(value);

  static List<OfferTransactionResponseBarcodeTypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OfferTransactionResponseBarcodeTypeEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OfferTransactionResponseBarcodeTypeEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [OfferTransactionResponseBarcodeTypeEnum] to String,
/// and [decode] dynamic data back to [OfferTransactionResponseBarcodeTypeEnum].
class OfferTransactionResponseBarcodeTypeEnumTypeTransformer {
  factory OfferTransactionResponseBarcodeTypeEnumTypeTransformer() => _instance ??= const OfferTransactionResponseBarcodeTypeEnumTypeTransformer._();

  const OfferTransactionResponseBarcodeTypeEnumTypeTransformer._();

  String encode(OfferTransactionResponseBarcodeTypeEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a OfferTransactionResponseBarcodeTypeEnum.
  ///
  ...
  OfferTransactionResponseBarcodeTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'NONE': return OfferTransactionResponseBarcodeTypeEnum.NONE;
        case r'UPC': return OfferTransactionResponseBarcodeTypeEnum.UPC;
        case r'CODE_128': return OfferTransactionResponseBarcodeTypeEnum.cODE128;
        case r'QR': return OfferTransactionResponseBarcodeTypeEnum.QR;
        case r'CUSTOM_MEDIA': return OfferTransactionResponseBarcodeTypeEnum.CUSTOM_MEDIA;
        default:
          if (!allowNull) {
  ...
  /// Singleton [OfferTransactionResponseBarcodeTypeEnumTypeTransformer] instance.
  static OfferTransactionResponseBarcodeTypeEnumTypeTransformer? _instance;
}



class OfferTransactionResponseSpecialOfferTypeEnum {
  /// Instantiate a new enum with the provided [value].
  const OfferTransactionResponseSpecialOfferTypeEnum._(this.value);
  ...
  static const ALL = OfferTransactionResponseSpecialOfferTypeEnum._(r'ALL');
  static const RESERVABLE = OfferTransactionResponseSpecialOfferTypeEnum._(r'RESERVABLE');
  static const REGULAR_OFFER = OfferTransactionResponseSpecialOfferTypeEnum._(r'REGULAR_OFFER');
  static const ACT_NOW = OfferTransactionResponseSpecialOfferTypeEnum._(r'ACT_NOW');
  static const GET_THERE_NOW = OfferTransactionResponseSpecialOfferTypeEnum._(r'GET_THERE_NOW');
  static const SQOOT = OfferTransactionResponseSpecialOfferTypeEnum._(r'SQOOT');
  static const TICKETS = OfferTransactionResponseSpecialOfferTypeEnum._(r'TICKETS');
  static const YIPIT = OfferTransactionResponseSpecialOfferTypeEnum._(r'YIPIT');

  /// List of all possible values in this [enum][OfferTransactionResponseSpecialOfferTypeEnum].
  static const values = <OfferTransactionResponseSpecialOfferTypeEnum>[
    ALL,
    RESERVABLE,
    REGULAR_OFFER,
    ACT_NOW,
  ...
  static OfferTransactionResponseSpecialOfferTypeEnum? fromJson(dynamic value) => OfferTransactionResponseSpecialOfferTypeEnumTypeTransformer().decode(value);

  static List<OfferTransactionResponseSpecialOfferTypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OfferTransactionResponseSpecialOfferTypeEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OfferTransactionResponseSpecialOfferTypeEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [OfferTransactionResponseSpecialOfferTypeEnum] to String,
/// and [decode] dynamic data back to [OfferTransactionResponseSpecialOfferTypeEnum].
class OfferTransactionResponseSpecialOfferTypeEnumTypeTransformer {
  factory OfferTransactionResponseSpecialOfferTypeEnumTypeTransformer() => _instance ??= const OfferTransactionResponseSpecialOfferTypeEnumTypeTransformer._();

  const OfferTransactionResponseSpecialOfferTypeEnumTypeTransformer._();

  String encode(OfferTransactionResponseSpecialOfferTypeEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a OfferTransactionResponseSpecialOfferTypeEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OfferTransactionResponseSpecialOfferTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'ALL': return OfferTransactionResponseSpecialOfferTypeEnum.ALL;
        case r'RESERVABLE': return OfferTransactionResponseSpecialOfferTypeEnum.RESERVABLE;
        case r'REGULAR_OFFER': return OfferTransactionResponseSpecialOfferTypeEnum.REGULAR_OFFER;
        case r'ACT_NOW': return OfferTransactionResponseSpecialOfferTypeEnum.ACT_NOW;
        case r'GET_THERE_NOW': return OfferTransactionResponseSpecialOfferTypeEnum.GET_THERE_NOW;
        case r'SQOOT': return OfferTransactionResponseSpecialOfferTypeEnum.SQOOT;
        case r'TICKETS': return OfferTransactionResponseSpecialOfferTypeEnum.TICKETS;
        case r'YIPIT': return OfferTransactionResponseSpecialOfferTypeEnum.YIPIT;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [OfferTransactionResponseSpecialOfferTypeEnumTypeTransformer] instance.
  static OfferTransactionResponseSpecialOfferTypeEnumTypeTransformer? _instance;
}
