...
class JsonArray {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is JsonArray &&
    other.asInt == asInt &&
  ...
  @override
  String toString() => 'JsonArray[asInt=$asInt, asString=$asString, asBoolean=$asBoolean, asNumber=$asNumber, asDouble=$asDouble, asFloat=$asFloat, asLong=$asLong, asByte=$asByte, asCharacter=$asCharacter, asBigDecimal=$asBigDecimal, asBigInteger=$asBigInteger, asShort=$asShort, asJsonObject=$asJsonObject, jsonNull=$jsonNull, jsonArray=$jsonArray, jsonObject=$jsonObject, jsonPrimitive=$jsonPrimitive, asJsonArray=$asJsonArray, asJsonPrimitive=$asJsonPrimitive, asJsonNull=$asJsonNull]';
  ...
  /// Returns a new [JsonArray] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static JsonArray? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "JsonArray[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "JsonArray[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<JsonArray> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <JsonArray>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = JsonArray.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, JsonArray> mapFromJson(dynamic json) {
    final map = <String, JsonArray>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = JsonArray.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of JsonArray-objects as value to a dart map
  static Map<String, List<JsonArray>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<JsonArray>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = JsonArray.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
