...
class NoteFullResponse {
  /// Returns a new [NoteFullResponse] instance.
  NoteFullResponse({
    this.valid,
    this.message,
    this.version,
  ...
  List<AssetShortResponse> attachedAssets;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NoteFullResponse &&
    other.valid == valid &&
    ...
    _deepEquality.equals(other.attachedAssets, attachedAssets) &&
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.locationDescription != null) {
      ...
      json[r'attachedAssets'] = this.attachedAssets;
  ...
  /// Returns a new [NoteFullResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NoteFullResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NoteFullResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NoteFullResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return NoteFullResponse(
        ...
        attachedAssets: AssetShortResponse.listFromJson(json[r'attachedAssets']),
  ...
  static List<NoteFullResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NoteFullResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NoteFullResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NoteFullResponse> mapFromJson(dynamic json) {
    final map = <String, NoteFullResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NoteFullResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NoteFullResponse-objects as value to a dart map
  static Map<String, List<NoteFullResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NoteFullResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NoteFullResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
