...
class Program {
  ...
  int get hashCode =>
    ...
    (costPerRide == null ? 0 : costPerRide!.hashCode);

  @override
  String toString() => 'Program[id=$id, active=$active, valid=$valid, name=$name, description=$description, costPerRide=$costPerRide]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.costPerRide != null) {
      json[r'costPerRide'] = this.costPerRide;
    } else {
      json[r'costPerRide'] = null;
    }
    return json;
  }
  ...
  static Program? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Program(
        ...
        costPerRide: mapValueOfType<int>(json, r'costPerRide'),
      );
    }
    return null;
  }
