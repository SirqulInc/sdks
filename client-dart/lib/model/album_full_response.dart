...
class AlbumFullResponse {
  /// Returns a new [AlbumFullResponse] instance.
  AlbumFullResponse({
    this.valid,
    this.message,
    this.version,
  ...
  AlbumFullResponseVisibilityEnum? visibility;
  ...
  AlbumFullResponseApprovalStatusEnum? approvalStatus;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AlbumFullResponse &&
    other.valid == valid &&
  ...
  int get hashCode =>
    ...
    (hasDisliked == null ? 0 : hasDisliked!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.hasDisliked != null) {
      json[r'hasDisliked'] = this.hasDisliked;
    } else {
      json[r'hasDisliked'] = null;
    }
  ...
  /// Returns a new [AlbumFullResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AlbumFullResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AlbumFullResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AlbumFullResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return AlbumFullResponse(
        ...
        visibility: AlbumFullResponseVisibilityEnum.fromJson(json[r'visibility']),
        ...
        approvalStatus: AlbumFullResponseApprovalStatusEnum.fromJson(json[r'approvalStatus']),
        ...
        assets: AssetResponse.listFromJson(json[r'assets']),
        ...
        hasDisliked: mapValueOfType<bool>(json, r'hasDisliked'),
  ...
  static List<AlbumFullResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AlbumFullResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AlbumFullResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AlbumFullResponse> mapFromJson(dynamic json) {
    final map = <String, AlbumFullResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AlbumFullResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AlbumFullResponse-objects as value to a dart map
  static Map<String, List<AlbumFullResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AlbumFullResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AlbumFullResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class AlbumFullResponseVisibilityEnum {
  /// Instantiate a new enum with the provided [value].
  const AlbumFullResponseVisibilityEnum._(this.value);
  ...
  static const PUBLIC = AlbumFullResponseVisibilityEnum._(r'PUBLIC');
  static const PRIVATE = AlbumFullResponseVisibilityEnum._(r'PRIVATE');
  static const FRIENDS = AlbumFullResponseVisibilityEnum._(r'FRIENDS');

  /// List of all possible values in this [enum][AlbumFullResponseVisibilityEnum].
  static const values = <AlbumFullResponseVisibilityEnum>[
    PUBLIC,
    PRIVATE,
    FRIENDS,
  ];

  static AlbumFullResponseVisibilityEnum? fromJson(dynamic value) => AlbumFullResponseVisibilityEnumTypeTransformer().decode(value);

  static List<AlbumFullResponseVisibilityEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AlbumFullResponseVisibilityEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AlbumFullResponseVisibilityEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [AlbumFullResponseVisibilityEnum] to String,
/// and [decode] dynamic data back to [AlbumFullResponseVisibilityEnum].
class AlbumFullResponseVisibilityEnumTypeTransformer {
  factory AlbumFullResponseVisibilityEnumTypeTransformer() => _instance ??= const AlbumFullResponseVisibilityEnumTypeTransformer._();

  const AlbumFullResponseVisibilityEnumTypeTransformer._();

  String encode(AlbumFullResponseVisibilityEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a AlbumFullResponseVisibilityEnum.
  ///
  ...
  AlbumFullResponseVisibilityEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'PUBLIC': return AlbumFullResponseVisibilityEnum.PUBLIC;
        case r'PRIVATE': return AlbumFullResponseVisibilityEnum.PRIVATE;
        case r'FRIENDS': return AlbumFullResponseVisibilityEnum.FRIENDS;
        default:
          if (!allowNull) {
  ...
  /// Singleton [AlbumFullResponseVisibilityEnumTypeTransformer] instance.
  static AlbumFullResponseVisibilityEnumTypeTransformer? _instance;
}



class AlbumFullResponseApprovalStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const AlbumFullResponseApprovalStatusEnum._(this.value);
  ...
  static const PENDING = AlbumFullResponseApprovalStatusEnum._(r'PENDING');
  static const REJECTED = AlbumFullResponseApprovalStatusEnum._(r'REJECTED');
  static const APPROVED = AlbumFullResponseApprovalStatusEnum._(r'APPROVED');
  static const FEATURED = AlbumFullResponseApprovalStatusEnum._(r'FEATURED');

  /// List of all possible values in this [enum][AlbumFullResponseApprovalStatusEnum].
  static const values = <AlbumFullResponseApprovalStatusEnum>[
    PENDING,
    REJECTED,
    APPROVED,
    FEATURED,
  ...
  static AlbumFullResponseApprovalStatusEnum? fromJson(dynamic value) => AlbumFullResponseApprovalStatusEnumTypeTransformer().decode(value);

  static List<AlbumFullResponseApprovalStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AlbumFullResponseApprovalStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AlbumFullResponseApprovalStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [AlbumFullResponseApprovalStatusEnum] to String,
/// and [decode] dynamic data back to [AlbumFullResponseApprovalStatusEnum].
class AlbumFullResponseApprovalStatusEnumTypeTransformer {
  factory AlbumFullResponseApprovalStatusEnumTypeTransformer() => _instance ??= const AlbumFullResponseApprovalStatusEnumTypeTransformer._();

  const AlbumFullResponseApprovalStatusEnumTypeTransformer._();

  String encode(AlbumFullResponseApprovalStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a AlbumFullResponseApprovalStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  AlbumFullResponseApprovalStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'PENDING': return AlbumFullResponseApprovalStatusEnum.PENDING;
        case r'REJECTED': return AlbumFullResponseApprovalStatusEnum.REJECTED;
        case r'APPROVED': return AlbumFullResponseApprovalStatusEnum.APPROVED;
        case r'FEATURED': return AlbumFullResponseApprovalStatusEnum.FEATURED;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [AlbumFullResponseApprovalStatusEnumTypeTransformer] instance.
  static AlbumFullResponseApprovalStatusEnumTypeTransformer? _instance;
}
