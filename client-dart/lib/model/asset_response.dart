...
class AssetResponse {
  /// Returns a new [AssetResponse] instance.
  AssetResponse({
    this.valid,
    this.message,
    this.version,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AssetResponse &&
    other.valid == valid &&
    ...
    other.attachedMediaType == attachedMediaType &&
    other.attachedAssetURL == attachedAssetURL &&
  ...
  int get hashCode =>
    ...
    (attachedMediaType == null ? 0 : attachedMediaType!.hashCode) +
    (attachedAssetURL == null ? 0 : attachedAssetURL!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.attachedMediaType != null) {
      json[r'attachedMediaType'] = this.attachedMediaType;
    } else {
      json[r'attachedMediaType'] = null;
    }
    if (this.attachedAssetURL != null) {
      json[r'attachedAssetURL'] = this.attachedAssetURL;
    } else {
      json[r'attachedAssetURL'] = null;
    }
  ...
  /// Returns a new [AssetResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AssetResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AssetResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AssetResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return AssetResponse(
        ...
        uploader: AccountShortResponse.fromJson(json[r'uploader']),
        likesCount: mapValueOfType<int>(json, r'likesCount'),
        commentsCount: mapValueOfType<int>(json, r'commentsCount'),
        latitude: mapValueOfType<double>(json, r'latitude'),
        longitude: mapValueOfType<double>(json, r'longitude'),
        attachedMediaType: mapValueOfType<String>(json, r'attachedMediaType'),
        attachedAssetURL: mapValueOfType<String>(json, r'attachedAssetURL'),
  ...
  static List<AssetResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AssetResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AssetResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AssetResponse> mapFromJson(dynamic json) {
    final map = <String, AssetResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AssetResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AssetResponse-objects as value to a dart map
  static Map<String, List<AssetResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AssetResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AssetResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
