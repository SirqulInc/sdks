...
class RetailerOfferResponse {
  /// Returns a new [RetailerOfferResponse] instance.
  ...
  RetailerOfferResponseBarcodeTypeEnum? barcodeType;
  ...
  RetailerOfferResponseSpecialOfferTypeEnum? specialOfferType;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RetailerOfferResponse &&
    other.valid == valid &&
  ...
  /// Returns a new [RetailerOfferResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RetailerOfferResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RetailerOfferResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RetailerOfferResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return RetailerOfferResponse(
        ...
        barcodeType: RetailerOfferResponseBarcodeTypeEnum.fromJson(json[r'barcodeType']),
        ticketsReward: mapValueOfType<int>(json, r'ticketsReward'),
        ticketsRewardType: mapValueOfType<String>(json, r'ticketsRewardType'),
        specialOfferType: RetailerOfferResponseSpecialOfferTypeEnum.fromJson(json[r'specialOfferType']),
        ...
        locations: Map.listFromJson(json[r'locations']),
  ...
  static List<RetailerOfferResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RetailerOfferResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RetailerOfferResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RetailerOfferResponse> mapFromJson(dynamic json) {
    final map = <String, RetailerOfferResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RetailerOfferResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RetailerOfferResponse-objects as value to a dart map
  static Map<String, List<RetailerOfferResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RetailerOfferResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RetailerOfferResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class RetailerOfferResponseBarcodeTypeEnum {
  /// Instantiate a new enum with the provided [value].
  const RetailerOfferResponseBarcodeTypeEnum._(this.value);
  ...
  static const NONE = RetailerOfferResponseBarcodeTypeEnum._(r'NONE');
  static const UPC = RetailerOfferResponseBarcodeTypeEnum._(r'UPC');
  static const cODE128 = RetailerOfferResponseBarcodeTypeEnum._(r'CODE_128');
  static const QR = RetailerOfferResponseBarcodeTypeEnum._(r'QR');
  static const CUSTOM_MEDIA = RetailerOfferResponseBarcodeTypeEnum._(r'CUSTOM_MEDIA');

  /// List of all possible values in this [enum][RetailerOfferResponseBarcodeTypeEnum].
  static const values = <RetailerOfferResponseBarcodeTypeEnum>[
    NONE,
    UPC,
    cODE128,
    QR,
  ...
  static RetailerOfferResponseBarcodeTypeEnum? fromJson(dynamic value) => RetailerOfferResponseBarcodeTypeEnumTypeTransformer().decode(value);

  static List<RetailerOfferResponseBarcodeTypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RetailerOfferResponseBarcodeTypeEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RetailerOfferResponseBarcodeTypeEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [RetailerOfferResponseBarcodeTypeEnum] to String,
/// and [decode] dynamic data back to [RetailerOfferResponseBarcodeTypeEnum].
class RetailerOfferResponseBarcodeTypeEnumTypeTransformer {
  factory RetailerOfferResponseBarcodeTypeEnumTypeTransformer() => _instance ??= const RetailerOfferResponseBarcodeTypeEnumTypeTransformer._();

  const RetailerOfferResponseBarcodeTypeEnumTypeTransformer._();

  String encode(RetailerOfferResponseBarcodeTypeEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a RetailerOfferResponseBarcodeTypeEnum.
  ///
  ...
  RetailerOfferResponseBarcodeTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'NONE': return RetailerOfferResponseBarcodeTypeEnum.NONE;
        case r'UPC': return RetailerOfferResponseBarcodeTypeEnum.UPC;
        case r'CODE_128': return RetailerOfferResponseBarcodeTypeEnum.cODE128;
        case r'QR': return RetailerOfferResponseBarcodeTypeEnum.QR;
        case r'CUSTOM_MEDIA': return RetailerOfferResponseBarcodeTypeEnum.CUSTOM_MEDIA;
        default:
          if (!allowNull) {
  ...
  /// Singleton [RetailerOfferResponseBarcodeTypeEnumTypeTransformer] instance.
  static RetailerOfferResponseBarcodeTypeEnumTypeTransformer? _instance;
}



class RetailerOfferResponseSpecialOfferTypeEnum {
  /// Instantiate a new enum with the provided [value].
  const RetailerOfferResponseSpecialOfferTypeEnum._(this.value);
  ...
  static const ALL = RetailerOfferResponseSpecialOfferTypeEnum._(r'ALL');
  static const RESERVABLE = RetailerOfferResponseSpecialOfferTypeEnum._(r'RESERVABLE');
  static const REGULAR_OFFER = RetailerOfferResponseSpecialOfferTypeEnum._(r'REGULAR_OFFER');
  static const ACT_NOW = RetailerOfferResponseSpecialOfferTypeEnum._(r'ACT_NOW');
  static const GET_THERE_NOW = RetailerOfferResponseSpecialOfferTypeEnum._(r'GET_THERE_NOW');
  static const SQOOT = RetailerOfferResponseSpecialOfferTypeEnum._(r'SQOOT');
  static const TICKETS = RetailerOfferResponseSpecialOfferTypeEnum._(r'TICKETS');
  static const YIPIT = RetailerOfferResponseSpecialOfferTypeEnum._(r'YIPIT');

  /// List of all possible values in this [enum][RetailerOfferResponseSpecialOfferTypeEnum].
  static const values = <RetailerOfferResponseSpecialOfferTypeEnum>[
    ALL,
    RESERVABLE,
    REGULAR_OFFER,
    ACT_NOW,
  ...
  static RetailerOfferResponseSpecialOfferTypeEnum? fromJson(dynamic value) => RetailerOfferResponseSpecialOfferTypeEnumTypeTransformer().decode(value);

  static List<RetailerOfferResponseSpecialOfferTypeEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RetailerOfferResponseSpecialOfferTypeEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RetailerOfferResponseSpecialOfferTypeEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [RetailerOfferResponseSpecialOfferTypeEnum] to String,
/// and [decode] dynamic data back to [RetailerOfferResponseSpecialOfferTypeEnum].
class RetailerOfferResponseSpecialOfferTypeEnumTypeTransformer {
  factory RetailerOfferResponseSpecialOfferTypeEnumTypeTransformer() => _instance ??= const RetailerOfferResponseSpecialOfferTypeEnumTypeTransformer._();

  const RetailerOfferResponseSpecialOfferTypeEnumTypeTransformer._();

  String encode(RetailerOfferResponseSpecialOfferTypeEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a RetailerOfferResponseSpecialOfferTypeEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  RetailerOfferResponseSpecialOfferTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'ALL': return RetailerOfferResponseSpecialOfferTypeEnum.ALL;
        case r'RESERVABLE': return RetailerOfferResponseSpecialOfferTypeEnum.RESERVABLE;
        case r'REGULAR_OFFER': return RetailerOfferResponseSpecialOfferTypeEnum.REGULAR_OFFER;
        case r'ACT_NOW': return RetailerOfferResponseSpecialOfferTypeEnum.ACT_NOW;
        case r'GET_THERE_NOW': return RetailerOfferResponseSpecialOfferTypeEnum.GET_THERE_NOW;
        case r'SQOOT': return RetailerOfferResponseSpecialOfferTypeEnum.SQOOT;
        case r'TICKETS': return RetailerOfferResponseSpecialOfferTypeEnum.TICKETS;
        case r'YIPIT': return RetailerOfferResponseSpecialOfferTypeEnum.YIPIT;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [RetailerOfferResponseSpecialOfferTypeEnumTypeTransformer] instance.
  static RetailerOfferResponseSpecialOfferTypeEnumTypeTransformer? _instance;
}
