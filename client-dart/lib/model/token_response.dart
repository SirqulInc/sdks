...
class TokenResponse {
  ...
  @override
  String toString() => 'TokenResponse[valid=$valid, message=$message, version=$version, serializeNulls=$serializeNulls, startTimeLog=$startTimeLog, errorCode=$errorCode, request=$request, token=$token, returning=$returning]';
