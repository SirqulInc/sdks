...
class AccountLoginResponse {
  /// Returns a new [AccountLoginResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AccountLoginResponse &&
    other.valid == valid &&
  ...
  /// Returns a new [AccountLoginResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AccountLoginResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AccountLoginResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AccountLoginResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AccountLoginResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AccountLoginResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AccountLoginResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AccountLoginResponse> mapFromJson(dynamic json) {
    final map = <String, AccountLoginResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountLoginResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AccountLoginResponse-objects as value to a dart map
  static Map<String, List<AccountLoginResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AccountLoginResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AccountLoginResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
