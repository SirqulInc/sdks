...
class ApplicationMiniResponse {
  /// Returns a new [ApplicationMiniResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApplicationMiniResponse &&
    other.valid == valid &&
  ...
  /// Returns a new [ApplicationMiniResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApplicationMiniResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApplicationMiniResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApplicationMiniResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ApplicationMiniResponse(
  ...
  static List<ApplicationMiniResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApplicationMiniResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApplicationMiniResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApplicationMiniResponse> mapFromJson(dynamic json) {
    final map = <String, ApplicationMiniResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ApplicationMiniResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ApplicationMiniResponse-objects as value to a dart map
  static Map<String, List<ApplicationMiniResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApplicationMiniResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApplicationMiniResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
