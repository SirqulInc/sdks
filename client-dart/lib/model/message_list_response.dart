...
class MessageListResponse {
  ...
  @override
  String toString() => 'MessageListResponse[start=$start, limit=$limit, countTotal=$countTotal, items=$items, count=$count, hasMoreResults=$hasMoreResults]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MessageListResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MessageListResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return MessageListResponse(
        ...
        items: MessageResponse.listFromJson(json[r'items']),
