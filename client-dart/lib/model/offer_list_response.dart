...
class OfferListResponse {
  /// Returns a new [OfferListResponse] instance.
  OfferListResponse({
    this.valid,
    this.message,
    this.version,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OfferListResponse &&
    other.valid == valid &&
  ...
  @override
  String toString() => 'OfferListResponse[valid=$valid, message=$message, version=$version, serializeNulls=$serializeNulls, startTimeLog=$startTimeLog, errorCode=$errorCode, request=$request, items=$items, hasMoreResults=$hasMoreResults, count=$count, start=$start, limit=$limit, countTotal=$countTotal, returning=$returning]';
  ...
  /// Returns a new [OfferListResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OfferListResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OfferListResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OfferListResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return OfferListResponse(
        ...
        items: OfferResponse.listFromJson(json[r'items']),
  ...
  static List<OfferListResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OfferListResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OfferListResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OfferListResponse> mapFromJson(dynamic json) {
    final map = <String, OfferListResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OfferListResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OfferListResponse-objects as value to a dart map
  static Map<String, List<OfferListResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OfferListResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OfferListResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
