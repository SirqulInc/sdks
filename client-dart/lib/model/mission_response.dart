...
class MissionResponse {
  /// Returns a new [MissionResponse] instance.
  MissionResponse({
    this.action,
  ...
  MissionResponseActionEnum? action;
  ...
  MissionResponseInviteStatusEnum? inviteStatus;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MissionResponse &&
    other.action == action &&
  ...
  /// Returns a new [MissionResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MissionResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MissionResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MissionResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MissionResponse(
        action: MissionResponseActionEnum.fromJson(json[r'action']),
        ...
        inviteStatus: MissionResponseInviteStatusEnum.fromJson(json[r'inviteStatus']),
  ...
  static List<MissionResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MissionResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MissionResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MissionResponse> mapFromJson(dynamic json) {
    final map = <String, MissionResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MissionResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MissionResponse-objects as value to a dart map
  static Map<String, List<MissionResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MissionResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = MissionResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class MissionResponseActionEnum {
  /// Instantiate a new enum with the provided [value].
  const MissionResponseActionEnum._(this.value);
  ...
  static const DATA = MissionResponseActionEnum._(r'DATA');
  static const SAVE = MissionResponseActionEnum._(r'SAVE');
  static const DELETE = MissionResponseActionEnum._(r'DELETE');
  static const GET = MissionResponseActionEnum._(r'GET');

  /// List of all possible values in this [enum][MissionResponseActionEnum].
  static const values = <MissionResponseActionEnum>[
    DATA,
    SAVE,
    DELETE,
    GET,
  ...
  static MissionResponseActionEnum? fromJson(dynamic value) => MissionResponseActionEnumTypeTransformer().decode(value);

  static List<MissionResponseActionEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MissionResponseActionEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MissionResponseActionEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [MissionResponseActionEnum] to String,
/// and [decode] dynamic data back to [MissionResponseActionEnum].
class MissionResponseActionEnumTypeTransformer {
  factory MissionResponseActionEnumTypeTransformer() => _instance ??= const MissionResponseActionEnumTypeTransformer._();

  const MissionResponseActionEnumTypeTransformer._();

  String encode(MissionResponseActionEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a MissionResponseActionEnum.
  ///
  ...
  MissionResponseActionEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'DATA': return MissionResponseActionEnum.DATA;
        case r'SAVE': return MissionResponseActionEnum.SAVE;
        case r'DELETE': return MissionResponseActionEnum.DELETE;
        case r'GET': return MissionResponseActionEnum.GET;
        default:
          if (!allowNull) {
  ...
  /// Singleton [MissionResponseActionEnumTypeTransformer] instance.
  static MissionResponseActionEnumTypeTransformer? _instance;
}



class MissionResponseInviteStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const MissionResponseInviteStatusEnum._(this.value);
  ...
  static const AVAILABLE = MissionResponseInviteStatusEnum._(r'AVAILABLE');
  static const PENDING = MissionResponseInviteStatusEnum._(r'PENDING');
  static const UPDATED = MissionResponseInviteStatusEnum._(r'UPDATED');
  static const ACCEPTED = MissionResponseInviteStatusEnum._(r'ACCEPTED');
  static const ACTIVE = MissionResponseInviteStatusEnum._(r'ACTIVE');
  static const BUY_BACK = MissionResponseInviteStatusEnum._(r'BUY_BACK');
  static const FAILED = MissionResponseInviteStatusEnum._(r'FAILED');
  static const QUIT = MissionResponseInviteStatusEnum._(r'QUIT');
  static const COMPLETED = MissionResponseInviteStatusEnum._(r'COMPLETED');
  static const PENDING_REVIEW = MissionResponseInviteStatusEnum._(r'PENDING_REVIEW');
  static const REJECTED = MissionResponseInviteStatusEnum._(r'REJECTED');

  /// List of all possible values in this [enum][MissionResponseInviteStatusEnum].
  static const values = <MissionResponseInviteStatusEnum>[
    AVAILABLE,
    PENDING,
    UPDATED,
    ACCEPTED,
  ...
  static MissionResponseInviteStatusEnum? fromJson(dynamic value) => MissionResponseInviteStatusEnumTypeTransformer().decode(value);

  static List<MissionResponseInviteStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MissionResponseInviteStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MissionResponseInviteStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [MissionResponseInviteStatusEnum] to String,
/// and [decode] dynamic data back to [MissionResponseInviteStatusEnum].
class MissionResponseInviteStatusEnumTypeTransformer {
  factory MissionResponseInviteStatusEnumTypeTransformer() => _instance ??= const MissionResponseInviteStatusEnumTypeTransformer._();

  const MissionResponseInviteStatusEnumTypeTransformer._();

  String encode(MissionResponseInviteStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a MissionResponseInviteStatusEnum.
  ///
  /// If [allowNull] is true and the [dynamic value][data] cannot be decoded successfully,
  /// then null is returned. However, if [allowNull] is false and the [dynamic value][data]
  /// cannot be decoded successfully, then an [UnimplementedError] is thrown.
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  MissionResponseInviteStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'AVAILABLE': return MissionResponseInviteStatusEnum.AVAILABLE;
        case r'PENDING': return MissionResponseInviteStatusEnum.PENDING;
        case r'UPDATED': return MissionResponseInviteStatusEnum.UPDATED;
        case r'ACCEPTED': return MissionResponseInviteStatusEnum.ACCEPTED;
        case r'ACTIVE': return MissionResponseInviteStatusEnum.ACTIVE;
        case r'BUY_BACK': return MissionResponseInviteStatusEnum.BUY_BACK;
        case r'FAILED': return MissionResponseInviteStatusEnum.FAILED;
        case r'QUIT': return MissionResponseInviteStatusEnum.QUIT;
        case r'COMPLETED': return MissionResponseInviteStatusEnum.COMPLETED;
        case r'PENDING_REVIEW': return MissionResponseInviteStatusEnum.PENDING_REVIEW;
        case r'REJECTED': return MissionResponseInviteStatusEnum.REJECTED;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
  ...
  /// Singleton [MissionResponseInviteStatusEnumTypeTransformer] instance.
  static MissionResponseInviteStatusEnumTypeTransformer? _instance;
}
