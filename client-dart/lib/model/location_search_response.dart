...
class LocationSearchResponse {
  ...
  @override
  String toString() => 'LocationSearchResponse[valid=$valid, message=$message, version=$version, serializeNulls=$serializeNulls, startTimeLog=$startTimeLog, errorCode=$errorCode, request=$request, count=$count, locations=$locations, returning=$returning]';
  ...
  static LocationSearchResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return LocationSearchResponse(
        ...
        locations: LocationResponse.listFromJson(json[r'locations']),
