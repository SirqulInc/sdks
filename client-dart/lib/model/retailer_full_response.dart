...
class RetailerFullResponse {
  /// Returns a new [RetailerFullResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RetailerFullResponse &&
  ...
  /// Returns a new [RetailerFullResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RetailerFullResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RetailerFullResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RetailerFullResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<RetailerFullResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RetailerFullResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RetailerFullResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RetailerFullResponse> mapFromJson(dynamic json) {
    final map = <String, RetailerFullResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RetailerFullResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RetailerFullResponse-objects as value to a dart map
  static Map<String, List<RetailerFullResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RetailerFullResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RetailerFullResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
