...
class AccountListResponse {
  ...
  @override
  String toString() => 'AccountListResponse[valid=$valid, message=$message, version=$version, serializeNulls=$serializeNulls, startTimeLog=$startTimeLog, errorCode=$errorCode, request=$request, items=$items, count=$count, hasMoreResults=$hasMoreResults, start=$start, limit=$limit, countTotal=$countTotal, returning=$returning]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AccountListResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AccountListResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return AccountListResponse(
        ...
        items: AccountResponse.listFromJson(json[r'items']),
