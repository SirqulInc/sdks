...
class CategoryTreeResponse {
  /// Returns a new [CategoryTreeResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CategoryTreeResponse &&
  ...
  @override
  String toString() => 'CategoryTreeResponse[categoryId=$categoryId, name=$name, display=$display, subCategoryCount=$subCategoryCount, parentId=$parentId, parentName=$parentName, description=$description, active=$active, asset=$asset, favoriteId=$favoriteId, favorite=$favorite, applicationId=$applicationId, type=$type, externalId=$externalId, externalType=$externalType, children=$children]';
  ...
  /// Returns a new [CategoryTreeResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CategoryTreeResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CategoryTreeResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CategoryTreeResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CategoryTreeResponse(
        ...
        children: CategoryTreeResponse.listFromJson(json[r'children']),
      );
    }
    return null;
  }

  static List<CategoryTreeResponse> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CategoryTreeResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CategoryTreeResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CategoryTreeResponse> mapFromJson(dynamic json) {
    final map = <String, CategoryTreeResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CategoryTreeResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CategoryTreeResponse-objects as value to a dart map
  static Map<String, List<CategoryTreeResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CategoryTreeResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CategoryTreeResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
