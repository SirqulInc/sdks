...
class SimulationApi {
  ...
  Future<Response> simulationWithHttpInfo(String data, bool realTime,) async {
    // ignore: prefer_const_declarations
    final path = r'/simulation/routing';
  ...
  /// * [bool] realTime (required):
  ///   determines whether to run the simulation and return the results in the same request
  Future<SirqulResponse?> simulation(String data, bool realTime,) async {
    final response = await simulationWithHttpInfo(data, realTime,);
