...
import org.openapitools.client.models.WrappedProxyItemResponse
...
open class OpenAIApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun imageGenerationRequestConfig(accountId: kotlin.Long, postBody: kotlin.String, returnRawResponse: kotlin.Boolean?) : RequestConfig<Unit> {
        ...
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                ...
                put("postBody", listOf(postBody.toString()))
