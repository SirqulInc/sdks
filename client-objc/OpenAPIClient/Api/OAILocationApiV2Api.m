...
@interface OAILocationApiV2Api ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAILocationApiV2Api

NSString* kOAILocationApiV2ApiErrorDomain = @"OAILocationApiV2ApiErrorDomain";
NSInteger kOAILocationApiV2ApiMissingParamErrorCode = 234513;
