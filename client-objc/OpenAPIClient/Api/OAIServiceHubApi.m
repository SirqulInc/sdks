#import "OAIServiceHubApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"
#import "OAIServiceHub.h"


@interface OAIServiceHubApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIServiceHubApi

NSString* kOAIServiceHubApiErrorDomain = @"OAIServiceHubApiErrorDomain";
NSInteger kOAIServiceHubApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createServiceHubWithBody: (OAIServiceHub*) body
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIServiceHub*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIServiceHub*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) searchServiceHubsWithSortField: (NSString*) sortField
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<OAIServiceHub>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<OAIServiceHub>*)data, error);
                                }
                            }];
}
