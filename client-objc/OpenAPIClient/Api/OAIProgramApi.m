#import "OAIProgramApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"
#import "OAIProgram.h"


@interface OAIProgramApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIProgramApi

NSString* kOAIProgramApiErrorDomain = @"OAIProgramApiErrorDomain";
NSInteger kOAIProgramApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) searchProgramsWithVersion: (NSNumber*) version
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<OAIProgram>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<OAIProgram>*)data, error);
                                }
                            }];
}
