#import "OAIVehicleApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"
#import "OAIVehicle.h"


@interface OAIVehicleApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIVehicleApi

NSString* kOAIVehicleApiErrorDomain = @"OAIVehicleApiErrorDomain";
NSInteger kOAIVehicleApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createVehicleWithVehicle: (NSString*) vehicle
    ...
    if (vehicle == nil) {
        ...
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"vehicle"] };
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIVehicle*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIVehicle*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) searchVehicleWithHubId: (NSNumber*) hubId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<OAIVehicle>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<OAIVehicle>*)data, error);
                                }
                            }];
}
