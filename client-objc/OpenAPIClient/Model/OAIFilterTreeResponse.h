...
@protocol OAIFilterTreeResponse;
@class OAIFilterTreeResponse;
...
@interface OAIFilterTreeResponse : OAIObject
...
@property(nonatomic) NSNumber* subFilterCount;
...
@property(nonatomic) NSArray<OAIFilterTreeResponse>* children;
