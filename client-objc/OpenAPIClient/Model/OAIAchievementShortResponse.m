...
@implementation OAIAchievementShortResponse
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"valid", @"message", @"version", @"serializeNulls", @"startTimeLog", @"errorCode", @"request", @"achievementId", @"title", @"_description", @"analyticsTag", @"rankType", @"rankIncrement", @"validate", @"appName", @"active", @"updated", @"created", @"tierCount", @"minIncrement", @"maxIncrement", @"returning"];
