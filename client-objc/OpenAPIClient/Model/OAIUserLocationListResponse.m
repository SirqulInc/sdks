#import "OAIUserLocationListResponse.h"

@implementation OAIUserLocationListResponse
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"valid", @"message", @"version", @"serializeNulls", @"startTimeLog", @"errorCode", @"request", @"items", @"userLocationType", @"latitude", @"longitude", @"postalCode", @"count", @"returning"];
