...
@implementation OAIApplicationConfigResponse
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"valid", @"message", @"version", @"serializeNulls", @"startTimeLog", @"errorCode", @"request", @"configId", @"created", @"updated", @"configVersion", @"configJson", @"configJsonURL", @"assetId", @"returning"];
