...
@implementation OAIProfileShortResponse
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"valid", @"message", @"version", @"serializeNulls", @"startTimeLog", @"errorCode", @"request", @"accountId", @"locationDisplay", @"display", @"username", @"profileImage", @"profileAvatar", @"returning"];
