...
@implementation OAINoteResponse
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"valid", @"message", @"version", @"serializeNulls", @"startTimeLog", @"errorCode", @"request", @"noteId", @"comment", @"tags", @"likesCount", @"dislikesCount", @"dateCreated", @"createdDate", @"updatedDate", @"owner", @"latitude", @"longitude", @"locationDescription", @"returning"];
