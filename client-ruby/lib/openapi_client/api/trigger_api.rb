...
module OpenapiClient
  class TriggerApi
    ...
    # @option opts [String] :grouping_id Client defined identifier for grouping triggers
    ...
    # @option opts [Integer] :scheduled_date The date and time of the next trigger
    # @option opts [Integer] :start_date The starting date of the trigger
    # @option opts [Integer] :end_date The ending date of the trigger
    # @option opts [String] :cron_expression The cron expression that represents the trigger&#39;s schedule
    # @option opts [String] :conditional_input Json input representing conditional logic that has to be met before running the trigger
    ...
    def create_trigger_with_http_info(account_id, name, opts = {})
      ...
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling TriggerApi.create_trigger"
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        fail ArgumentError, "Missing the required parameter 'name' when calling TriggerApi.create_trigger"
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'TriggerResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TriggerApi.create_trigger",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TriggerApi#create_trigger\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_trigger_with_http_info(account_id, trigger_id, opts = {})
      ...
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling TriggerApi.delete_trigger"
      end
      ...
      new_options = opts.merge(
        :operation => :"TriggerApi.delete_trigger",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TriggerApi#delete_trigger\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_trigger_with_http_info(account_id, trigger_id, opts = {})
      ...
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling TriggerApi.get_trigger"
      end
      # verify the required parameter 'trigger_id' is set
      if @api_client.config.client_side_validation && trigger_id.nil?
      ...
      new_options = opts.merge(
        :operation => :"TriggerApi.get_trigger",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TriggerApi#get_trigger\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :filter A comma separated list of filters. * MINE - Return triggers that the user has created * SHARED - Return triggers that have been shared to the user * FOLLOWER - Return triggers that have been created by the user&#39;&#39;s followers (the content needs to have been APPROVED or FEATURED) * FOLLOWING - Return triggers that have been created by people who the user is following (the content needs to have been APPROVED or FEATURED) * PUBLIC - Return all PUBLIC triggers that have been APPROVED or FEATURED * ALL_PUBLIC - Return all PUBLIC triggers regardless of whether they are approved or not (ignores the approval status) * LIKED - Return all triggers that the user has liked * FEATURED - Return all triggers that have been featured * PENDING - Return all pending triggers  (default to 'MINE')
    ...
    # @option opts [String] :keyword Keyword search on the trigger names.
    ...
    def search_triggers_with_http_info(account_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<TriggerResponse>'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TriggerApi.search_triggers",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TriggerApi#search_triggers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param account_id [Integer] The logged in user
    # @param [Hash] opts the optional parameters
    # @option opts [String] :name The name of the trigger
    # @option opts [String] :app_key The application to target
    # @option opts [String] :grouping_id Client defined identifier for grouping triggers
    # @option opts [String] :endpoint_url The URL for making an HTTP call
    # @option opts [String] :payload The parameters for making an HTTP call
    ...
    def update_trigger_with_http_info(trigger_id, account_id, opts = {})
      ...
      # verify the required parameter 'trigger_id' is set
      if @api_client.config.client_side_validation && trigger_id.nil?
        fail ArgumentError, "Missing the required parameter 'trigger_id' when calling TriggerApi.update_trigger"
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling TriggerApi.update_trigger"
      end
      allowable_values = ["PUBLIC", "PRIVATE", "FRIENDS"]
      if @api_client.config.client_side_validation && opts[:'visibility'] && !allowable_values.include?(opts[:'visibility'])
        fail ArgumentError, "invalid value for \"visibility\", must be one of #{allowable_values}"
      ...
      new_options = opts.merge(
        :operation => :"TriggerApi.update_trigger",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TriggerApi#update_trigger\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
