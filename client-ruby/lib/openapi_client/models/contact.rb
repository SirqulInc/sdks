...
module OpenapiClient
  class Contact < ApiModelBase
    ...
    def hash
      [first_name, middle_name, last_name, prefix, suffix, title, home_phone, cell_phone, cell_carrier, business_phone, business_phone_ext, fax_number, time_zone, utc_offset, code501c3, email_address, address, web, display].hash
    end
