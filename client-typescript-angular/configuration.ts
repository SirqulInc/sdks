...
constructor({ accessToken, apiKeys, basePath, credentials, encodeParam, encoder, password, username, withCredentials }: ConfigurationParameters = {}) {
        ...
        // init default appKey credential
        if (!this.credentials['appKey']) {
            this.credentials['appKey'] = () => {
                if (this.apiKeys === null || this.apiKeys === undefined) {
                    return undefined;
                } else {
                    return this.apiKeys['appKey'] || this.apiKeys['Application-Key'];
                }
            };
        }

        // init default restKey credential
        if (!this.credentials['restKey']) {
            this.credentials['restKey'] = () => {
                if (this.apiKeys === null || this.apiKeys === undefined) {
                    return undefined;
                } else {
                    return this.apiKeys['restKey'] || this.apiKeys['Application-Rest-Key'];
                }
            };
        }
    }
