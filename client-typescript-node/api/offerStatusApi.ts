...
export class OfferStatusApi {
    ...
    public async createOfferTransactionStatus (version: number, name: string, code: number, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, description?: string, role?: string, active?: boolean, applicationIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OfferTransactionStatusResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/offer/status/create'
     ...
     * @param longitude Used to update the user\&#39;s current location
     */
    public async deleteOfferTransactionStatus (version: number, statusId: number, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/offer/status/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param longitude Used to update the user\&#39;s current location
     */
    public async getOfferTransactionStatus (version: number, statusId: number, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OfferTransactionStatusResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/offer/status/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param applicationIds The applications to associate the status with, if null then for all.
     */
    public async updateOfferTransactionStatus (version: number, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, statusId?: number, name?: string, description?: string, code?: number, role?: string, active?: boolean, applicationIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OfferTransactionStatusResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/offer/status/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
