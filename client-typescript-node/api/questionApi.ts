...
export class QuestionApi {
     ...
     */
    public async deleteQuestion (version: number, questionId: number, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/game/question/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getQuestion (version: number, questionId: number, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QuestionResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/game/question/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async searchQuestions (version: number, accountId: number, sortField: string, descending: boolean, activeOnly: boolean, start: number, limit: number, keyword?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<QuestionResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/game/question/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param points The number of points to award for completing a mission
     */
    public async updateQuestion (version: number, questionId: number, accountId: number, ticketCount: number, question?: string, answers?: string, tags?: string, videoURL?: string, assetId?: number, active?: boolean, allocateTickets?: boolean, ticketType?: string, points?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QuestionResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/game/question/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
