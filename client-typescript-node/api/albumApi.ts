...
export class AlbumApi {
     ...
     */
    public async addAlbumUsers (version: number, albumId: number, includeFriendGroup: boolean, deviceId?: string, accountId?: number, read?: boolean, write?: boolean, _delete?: boolean, add?: boolean, connections?: string, connectionGroups?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/album/user/add'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async approveAlbum (version: number, albumId: number, deviceId?: string, accountId?: number, approvalStatus?: 'PENDING' | 'REJECTED' | 'APPROVED' | 'FEATURED', verified?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/album/approve'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getAlbumCollection (version: number, returnNulls: boolean, albumId: number, deviceId?: string, accountId?: number, likePreviewSize?: number, assetPreviewSize?: number, notePreviewSize?: number, connectionPreviewSize?: number, audiencePreviewSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AlbumFullResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/album/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param accountId the account ID of the user (deviceId or accountId required)
     */
    public async leaveAlbum (version: number, albumId: number, deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/album/user/leave'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param accountId the account ID of the user (deviceId or accountId required)
     */
    public async removeAlbum (version: number, albumId: number, deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/album/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param connectionGroups comma separated list of connection group IDs
     */
    public async removeAlbumUsers (version: number, albumId: number, removeFriendGroup: boolean, deviceId?: string, accountId?: number, connections?: string, connectionGroups?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/album/user/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
