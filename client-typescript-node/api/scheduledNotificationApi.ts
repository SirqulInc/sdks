...
export class ScheduledNotificationApi {
     ...
     */
    public async deleteScheduledNotification (accountId: number, scheduledNotificationId: number, deleteByGroupingId?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ScheduledNotificationFullResponse;  }> {
        const localVarPath = this.basePath + '/notification/schedule/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getScheduledNotification (accountId: number, scheduledNotificationId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ScheduledNotificationFullResponse;  }> {
        const localVarPath = this.basePath + '/notification/schedule/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async scheduleNotificationListings (accountId: number, appKey: string, reportName: string, message: string, offset: number, recipientReportId: number, reportParams?: string, type?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/notification/schedule/generate';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
