...
export class TrackingApi {
     ...
     * @param slaveUID 
     */
    public async batchSaveTracking (data: string, deviceId?: string, accountId?: number, generateAccounts?: boolean, updateAccountLocations?: boolean, defaultTag?: string, slaveUID?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<Leg>;  }> {
        const localVarPath = this.basePath + '/tracking/batch/create';
     ...
     */
    public async getPredictedLocations (accountId: number, latitude?: number, longitude?: number, dateCheck?: number, hourCheck?: string, threshold?: number, distanceUnit?: 'MILES' | 'KILOMETERS', searchRange?: number, sortOrder?: 'MATCHES' | 'DISTANCE' | 'WEIGHTED', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PredictedLocationResponse;  }> {
        const localVarPath = this.basePath + '/tracking/predicted/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getPredictedPath (accountId: number, startStepId: number, endStepId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<StepResponse>;  }> {
        const localVarPath = this.basePath + '/tracking/path/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param distanceUnit Determines which unit of measurement gets returned for distances: {MILES, KILOMETERS}
     */
    public async getPreferredLocations (accountId: number, latitude?: number, longitude?: number, dateCheck?: number, hourCheck?: string, sortField?: string, descending?: boolean, start?: number, limit?: number, searchRange?: number, distanceUnit?: 'MILES' | 'KILOMETERS', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<PreferredLocationResponse>;  }> {
        const localVarPath = this.basePath + '/tracking/preferred/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getTrackingLegs (deviceId?: string, accountId?: number, ownerId?: number, trackingDeviceId?: string, startDate?: number, endDate?: number, tags?: string, getLastPoint?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<LegResponse>;  }> {
        const localVarPath = this.basePath + '/tracking/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async saveTrackingLeg (startLat: number, startLng: number, startDate: number, endLat: number, endLng: number, endDate: number, deviceId?: string, accountId?: number, distance?: number, duration?: number, steps?: string, tags?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/tracking/leg/create';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param duration the total duration
     */
    public async saveTrackingStep (legId: number, startLat: number, startLng: number, startDate: number, endLat: number, endLng: number, endDate: number, deviceId?: string, accountId?: number, distance?: number, duration?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/tracking/step/create';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param limit The limit for pagination
     */
    public async searchTrackingLegs (accountId: number, appKey: string, trackingDeviceId?: string, startDate?: number, endDate?: number, tags?: string, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<LegResponse>;  }> {
        const localVarPath = this.basePath + '/tracking/searchByBillable';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
