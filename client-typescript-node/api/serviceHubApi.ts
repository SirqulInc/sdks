...
export enum ServiceHubApiApiKeys {
    appKey,
    restKey,
}
...
export class ServiceHubApi {
    ...
    public setApiKey(key: ServiceHubApiApiKeys, value: string) {
        (this.authentications as any)[ServiceHubApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param body 
     */
    public async createServiceHub (version: number, body?: ServiceHub, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ServiceHub;  }> {
        const localVarPath = this.basePath + '/api/{version}/hub'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(body, "ServiceHub")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ServiceHub;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ServiceHub");
     ...
     */
    public async deleteServiceHub (version: number, id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/{version}/hub/{id}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
     ...
     */
    public async getServiceHub (version: number, id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/api/{version}/hub/{id}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
     ...
     * @param body 
     */
    public async postServiceHub (version: number, id: number, body?: ServiceHub, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ServiceHub;  }> {
        const localVarPath = this.basePath + '/api/{version}/hub/{id}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
     ...
     * @param body 
     */
    public async putServiceHub (version: number, id: number, body?: ServiceHub, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ServiceHub;  }> {
        const localVarPath = this.basePath + '/api/{version}/hub/{id}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async searchServiceHubs (version: number, sortField: string, descending: boolean, start: number, limit: number, activeOnly: boolean, keyword?: string, retailerId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<ServiceHub>;  }> {
        const localVarPath = this.basePath + '/api/{version}/hub'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<ServiceHub>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<ServiceHub>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
