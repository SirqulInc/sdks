...
export class AMQPApi {
     ...
     * @param useSSL Use SSL
     */
    public async consumerUpdate (version: number, appKey: string, queueId: number, dataMapping: string, deviceId?: string, accountId?: number, useSSL?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QueueResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/queue/consumer/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param useSSL Use SSL
     */
    public async queueCreate (version: number, appKey: string, name: string, deviceId?: string, accountId?: number, workers?: number, analyticTags?: string, hostname?: string, port?: number, username?: string, password?: string, virtualHost?: string, useSSL?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QueueResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/queue/create'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param accountId The logged in user ID
     */
    public async queueDelete (version: number, queueId: number, deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/queue/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async queueGet (version: number, deviceId?: string, accountId?: number, queueId?: number, appKey?: string, name?: string, hostname?: string, virtualHost?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QueueResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/queue/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param virtualHost The virtual host defined on the server to queue
     */
    public async queuePublish (version: number, message: string, queueId?: number, appKey?: string, name?: string, hostname?: string, virtualHost?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/queue/publish'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async queueSearch (version: number, queueId?: number, deviceId?: string, accountId?: number, name?: string, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QueueResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/queue/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async queueUpdate (version: number, queueId: number, deviceId?: string, accountId?: number, appKey?: string, workers?: number, analyticTags?: string, hostname?: string, port?: number, username?: string, password?: string, virtualHost?: string, useSSL?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QueueResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/queue/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
