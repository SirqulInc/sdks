...
export class InviteApi {
     ...
     */
    public async albumContestInvite (deviceId?: string, accountId?: number, appId?: number, appKey?: string, albumContestId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InviteResponse;  }> {
        const localVarPath = this.basePath + '/invite/albumContest';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param longitude the current longitude of the user
     */
    public async albumInvite (deviceId?: string, accountId?: number, appId?: number, appKey?: string, albumId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InviteResponse;  }> {
        const localVarPath = this.basePath + '/invite/album';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async eventInvite (accountId: number, appKey: string, listingId: number, receiverAccountIds?: string, retailerLocationId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InviteResponse;  }> {
        const localVarPath = this.basePath + '/invite/event';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param longitude the current longitude of the user
     */
    public async gameInvite (deviceId?: string, accountId?: number, appId?: number, appKey?: string, gameLevelId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InviteResponse;  }> {
        const localVarPath = this.basePath + '/invite/gameLevel';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param appKey the application key
     */
    public async getInvite (accountId?: number, token?: string, albumId?: number, missionId?: number, albumContestId?: number, offerId?: number, offerLocationId?: number, retailerLocationId?: number, appKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/invite/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param longitude the current longitude of the user
     */
    public async missionInvite (deviceId?: string, accountId?: number, appId?: number, appKey?: string, missionId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InviteResponse;  }> {
        const localVarPath = this.basePath + '/invite/mission';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async offerInvite (accountId: number, appKey: string, offerId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InviteResponse;  }> {
        const localVarPath = this.basePath + '/invite/offer';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async offerLocationInvite (accountId: number, appKey: string, offerLocationId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InviteResponse;  }> {
        const localVarPath = this.basePath + '/invite/offerLocation';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async retailerLocationInvite (accountId: number, appKey: string, retailerLocationId: number, albumId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InviteResponse;  }> {
        const localVarPath = this.basePath + '/invite/retailerLocation';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
