...
export class AssetApi {
     ...
     */
    public async assetDownload (version: number, filename: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/asset/download/{filename}'
     ...
     */
    public async assetMorph (version: number, offerId: number, adSize: 'CONFIG' | 'BANNER' | 'LEADERBOARD' | 'SKYSCRAPER' | 'VIDEO' | 'ZIP' | 'INTERSTITIAL' | 'CUSTOM1' | 'CUSTOM2' | 'CUSTOM3' | 'CUSTOM4' | 'CUSTOM5' | 'CUSTOM6' | 'CUSTOM7' | 'CUSTOM8' | 'CUSTOM9' | 'CUSTOM10', creativeId?: number, width?: number, height?: number, backgroundSize?: string, template?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AssetShortResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/asset/morph'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
    ...
    public async createAsset (version: number, returnNulls?: boolean, deviceId?: string, accountId?: number, albumId?: number, collectionId?: number, addToDefaultAlbum?: string, addToMediaLibrary?: boolean, versionCode?: number, versionName?: string, metaData?: string, caption?: string, assetType?: string, approvalStatus?: string, assignedAccountId?: number, media?: RequestFile, mediaUrl?: string, mediaString?: string, mediaStringFileName?: string, mediaStringContentType?: string, mediaHeight?: number, mediaWidth?: number, attachedMedia?: RequestFile, attachedMediaUrl?: string, attachedMediaString?: string, attachedMediaStringFileName?: string, attachedMediaStringContentType?: string, attachedMediaHeight?: number, attachedMediaWidth?: number, locationDescription?: string, app?: string, appKey?: string, searchTags?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AssetResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/asset/create'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async deleteAsset (version: number, assetId: string, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/asset/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getAsset (version: number, assetId: number, deviceId?: string, accountId?: number, noteDescending?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AssetFullResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/asset/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param longitude longitude used to update the user\&#39;s current location
     */
    public async removeAsset (version: number, assetId: string, deviceId?: string, accountId?: number, albumId?: number, collectionId?: number, removeFromDefaultAlbums?: boolean, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/asset/remove'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async searchAssets (version: number, deviceId?: string, accountId?: number, albumIds?: string, assetIds?: string, appKey?: string, mediaType?: string, mimeType?: string, keyword?: string, versionCode?: number, versionName?: string, updatedSince?: number, updatedBefore?: number, sortField?: string, descending?: boolean, searchMediaLibrary?: boolean, filterByBillable?: boolean, activeOnly?: boolean, returnApp?: boolean, start?: number, limit?: number, searchMode?: string, assetType?: string, approvalStatus?: string, assignedAccountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<AssetResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/asset/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
