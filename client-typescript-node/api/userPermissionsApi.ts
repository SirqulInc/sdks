...
export class UserPermissionsApi {
     ...
     */
    public async addUsersToPermissionable (version: number, permissionableType: 'ACCOUNT' | 'GAMELEVEL' | 'ALBUM_CONTEST' | 'THEME_DESCRIPTOR' | 'SCHEDULED_NOTIFICATION' | 'TASK' | 'TRIGGER', permissionableId: number, deviceId?: string, accountId?: number, read?: boolean, write?: boolean, _delete?: boolean, add?: boolean, connectionIds?: string, connectionAccountIds?: string, connectionGroupIds?: string, pending?: boolean, admin?: boolean, includeFriendGroup?: boolean, latitude?: number, longitude?: number, audienceIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/consumer/permissions/add'
     ...
     */
    public async approvePermissionable (version: number, permissionableType: 'ACCOUNT' | 'GAMELEVEL' | 'ALBUM_CONTEST' | 'THEME_DESCRIPTOR' | 'SCHEDULED_NOTIFICATION' | 'TASK' | 'TRIGGER', permissionableId: number, deviceId?: string, accountId?: number, approvalStatus?: 'PENDING' | 'REJECTED' | 'APPROVED' | 'FEATURED', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/permissionable/approve'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param longitude the current longitude of the user
     */
    public async leaveFromPermissionable (version: number, permissionableType: string, permissionableId: number, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/consumer/permissions/leave'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async removeUsersFromPermissionable (version: number, permissionableType: 'ACCOUNT' | 'GAMELEVEL' | 'ALBUM_CONTEST' | 'THEME_DESCRIPTOR' | 'SCHEDULED_NOTIFICATION' | 'TASK' | 'TRIGGER', permissionableId: number, deviceId?: string, accountId?: number, connectionIds?: string, connectionAccountIds?: string, connectionGroupIds?: string, removeFriendGroup?: boolean, latitude?: number, longitude?: number, audienceIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/consumer/permissions/remove'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
    ...
    public async searchPermissionablesFollowingDistance (version: number, latitude: number, longitude: number, deviceId?: string, accountId?: number, connectionAccountId?: number, connectionAccountIds?: string, permissionableType?: 'ACCOUNT' | 'GAMELEVEL' | 'ALBUM_CONTEST' | 'THEME_DESCRIPTOR' | 'SCHEDULED_NOTIFICATION' | 'TASK' | 'TRIGGER', permissionableId?: number, searchRange?: number, keyword?: string, pending?: boolean, admin?: boolean, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<UserPermissionsResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/permissions/distancesearch'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
