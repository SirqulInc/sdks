...
export class LikeApi {
     ...
     */
    public async registerLike (version: number, likableType: string, likableId: number, deviceId?: string, accountId?: number, permissionableType?: string, permissionableId?: number, like?: boolean, app?: string, gameType?: string, appKey?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LikableResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/like'
     ...
     * @param longitude The current location of the user
     */
    public async removeLike (version: number, likableType: string, likableId: number, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LikableResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/like/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
