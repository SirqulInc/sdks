...
export class FilterApi {
     ...
     */
    public async createFilter (version: number, accountId: number, name: string, appKey?: string, parentFilterId?: number, description?: string, externalId?: string, externalType?: string, active?: boolean, metaData?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FilterTreeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/filter/create'
     ...
     */
    public async deleteFilter (version: number, accountId: number, filterId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/filter/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getFilter (version: number, filterId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FilterTreeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/filter/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param metaData external custom client defined data
     */
    public async updateFilter (version: number, accountId: number, filterId: number, parentFilterId?: number, name?: string, description?: string, externalId?: string, externalType?: string, active?: boolean, metaData?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FilterTreeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/filter/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
