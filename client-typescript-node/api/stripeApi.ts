...
export class StripeApi {
     ...
     */
    public async createStripeCheckoutSession (appKey: string, stripeParameters: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/stripe/checkout/session/create';
