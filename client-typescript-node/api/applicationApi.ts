...
export class ApplicationApi {
     ...
     * @param active Active
     */
    public async createApplicationPlacement (version: number, appKey: string, size: 'CONFIG' | 'BANNER' | 'LEADERBOARD' | 'SKYSCRAPER' | 'VIDEO' | 'ZIP' | 'INTERSTITIAL' | 'CUSTOM1' | 'CUSTOM2' | 'CUSTOM3' | 'CUSTOM4' | 'CUSTOM5' | 'CUSTOM6' | 'CUSTOM7' | 'CUSTOM8' | 'CUSTOM9' | 'CUSTOM10', deviceId?: string, accountId?: number, name?: string, description?: string, height?: number, width?: number, refreshInterval?: number, defaultImageId?: number, active?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PlacementResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/placement/create'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async deleteApplication (version: number, accountId?: number, appKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param accountId The account id of the user (deviceId or accountId required)
     */
    public async deleteApplicationPlacement (version: number, placementId: number, deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PlacementResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/placement/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getApplication (version: number, appKey?: string, applicationId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ApplicationResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param accountId The account id of the user (deviceId or accountId required)
     */
    public async getApplicationPlacement (version: number, placementId: number, deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PlacementResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/placement/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param version 
     */
    public async getApplicationVersions (version: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/versions'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getUniqueUsersByApp (version: number, appKey: string, q?: string, keyword?: string, since?: number, i?: number, start?: number, l?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountListResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/users'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async listApplications (version: number, accountId?: number, q?: string, keyword?: string, platforms?: string, deviceIds?: string, deviceVersions?: string, categoryIds?: string, sortField?: 'CREATED' | 'UPDATED' | 'DELETED' | 'SEARCH_TAGS' | 'ACTIVE' | 'HAS_ADVERTISEMENTS' | 'PUBLIC_NOTIFICATIONS' | 'PLACEMENTS' | 'BILLABLE_ENTITY_ID' | 'BILLABLE_ENTITY_NAME' | 'RESPONSIBLE_DISPLAY' | 'TITLE' | 'NAME' | 'ABOUT' | 'DESCRIPTION' | 'APPLICATION_ID' | 'APP_TYPE' | 'GAME_TYPE' | 'BUNDLE_ID' | 'SCORING_TYPE' | 'LANDING_PAGE_URL' | 'EULA_VERSION' | 'BUILD_VERSION' | 'API_VERSION', hasAds?: boolean, publicNotifications?: boolean, filterBillable?: boolean, filterContentAdmin?: boolean, descending?: boolean, i?: number, start?: number, l?: number, limit?: number, applicationIds?: string, hasObjectStore?: boolean, activeOnly?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<ApplicationShortResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/list'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param limit The limit of the pagination
     */
    public async searchApplicationPlacement (version: number, appKey: string, deviceId?: string, accountId?: number, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<PlacementResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/placement/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async searchApplicationSettings (version: number, deviceId?: string, accountId?: number, connectionAccountId?: number, keyword?: string, sortField?: string, descending?: boolean, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ApplicationSettingsResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/settings/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param openAISecretKey OpenAI Secret API Key
     */
    public async updateApplication (version: number, appKey: string, appName: string, deviceId?: string, accountId?: number, about?: string, bundleId?: string, appIconAssetId?: number, appLogoAssetId?: number, facebookAppId?: string, facebookAppSecret?: string, googleApiKey?: string, updateEULADate?: boolean, eulaVersion?: string, landingPageUrl?: string, showInActivities?: boolean, activityDescription?: string, inviteWelcomeText?: string, invitePageUrl?: string, urlScheme?: string, platforms?: string, downloadUrls?: string, categoryIds?: string, scoringType?: 'GAME_LEVEL' | 'GAME_OBJECT', hintCost?: number, maxScore?: number, ticketsPerPoint?: number, hasGameData?: boolean, publicNotifications?: boolean, useMatchingAlgorithm?: boolean, globalTickets?: boolean, buildVersion?: number, apiVersion?: number, placementName?: string, placementDescription?: string, placementSize?: 'CONFIG' | 'BANNER' | 'LEADERBOARD' | 'SKYSCRAPER' | 'VIDEO' | 'ZIP' | 'INTERSTITIAL' | 'CUSTOM1' | 'CUSTOM2' | 'CUSTOM3' | 'CUSTOM4' | 'CUSTOM5' | 'CUSTOM6' | 'CUSTOM7' | 'CUSTOM8' | 'CUSTOM9' | 'CUSTOM10', placementHeight?: number, placementWidth?: number, placementRefreshInterval?: number, createObjectStore?: boolean, publicContentApproval?: boolean, productionMode?: boolean, minimumSessionLength?: number, sessionGapLength?: number, localAdsEnabled?: boolean, sqootApiKey?: string, trilatProcessingType?: 'DEFAULT' | 'FINGERPRINT' | 'FINGERPRINT_V2', maxSampleSize?: number, minRSSI?: number, modules?: string, authorizedCount?: number, authorizedServers?: string, defaultTimezone?: string, smtpPass?: string, metaData?: string, placementMetaData?: string, ipsFloor?: boolean, enableAPNSBadge?: boolean, includeInReport?: boolean, defaultAppFilterId?: number, enableWelcomeEmail?: boolean, appleAppId?: string, appleTeamId?: string, appleAuthKeyId?: string, appleAuthKey?: RequestFile, appleIssuerId?: string, appStoreKeyId?: string, appStoreKey?: RequestFile, googlePrivateKeyFile?: RequestFile, authorizeNetApiKey?: string, authorizeNetTransactionKey?: string, emailSender?: string, smtpUser?: string, smtpHost?: string, vatomBusinessId?: string, vatomRestClientId?: string, vatomRestSecretKey?: string, twilioAccountSID?: string, twilioAuthToken?: string, twilioSenderPhoneNumber?: string, openAISecretKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ApplicationResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async updateApplicationActive (version: number, accountId: number, appKey: string, active: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/active'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param active Active
     */
    public async updateApplicationPlacement (version: number, placementId: number, deviceId?: string, accountId?: number, name?: string, description?: string, size?: 'CONFIG' | 'BANNER' | 'LEADERBOARD' | 'SKYSCRAPER' | 'VIDEO' | 'ZIP' | 'INTERSTITIAL' | 'CUSTOM1' | 'CUSTOM2' | 'CUSTOM3' | 'CUSTOM4' | 'CUSTOM5' | 'CUSTOM6' | 'CUSTOM7' | 'CUSTOM8' | 'CUSTOM9' | 'CUSTOM10', height?: number, width?: number, refreshInterval?: number, defaultImageId?: number, active?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PlacementResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/placement/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async uploadApplicationCertificate (version: number, appKey: string, deviceId?: string, accountId?: number, certificate?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/application/certificate/create'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
