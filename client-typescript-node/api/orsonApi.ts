...
export class OrsonApi {
     ...
     */
    public async addMovie (version: number, accountId: number, movieName: string, thirdPartyAccountId?: string, tags?: string, file?: RequestFile, url?: string, callback?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiAddMovieResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/addMovie'
     ...
     * @param offset Offset
     */
    public async aiDocs (version: number, accountId: number, doc: string, returnTopics?: boolean, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiProtoResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/docs'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param size Size
     */
    public async aiFindImages (version: number, accountId: number, text: string, parseFlag?: string, fetchFlag?: string, size?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiProtoResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/img'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param offset Offset
     */
    public async aiTags (version: number, accountId: number, tags: string, conditional?: string, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiProtoResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/tags'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param offset Offset
     */
    public async aiText (version: number, accountId: number, terms: string, conditional?: string, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiProtoResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/text'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param callback When provided, Orson will return a 202 and POST the results to this URL when complete instead of holding the Request open
     */
    public async batch (version: number, accountId: number, thirdPartyAccountId?: string, limit?: number, operations?: string, file?: RequestFile, url?: string, callback?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiBatchResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/batch'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async createInstantEpisode (version: number, accountId: number, data: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonEpisodeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/stories/episodes/instant'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param callback When provided, Orson will return a 202 and POST the results to this URL when complete instead of holding the Request open
     */
    public async createVoiceCanvas (version: number, accountId: number, dimensions: string, thirdPartyAccountId?: string, text?: string, file?: RequestFile, url?: string, parseFlag?: boolean, fetchFlag?: boolean, callback?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiVoiceCanvasResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/voiceCanvas'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param callback When provided, Orson will return a 202 and POST the results to this URL when complete instead of holding the Request open
     */
    public async emotion (version: number, accountId: number, thirdPartyAccountId?: string, file?: RequestFile, url?: string, callback?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiEmotionsResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/emotion'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param accountId Sirqul Account Id
     */
    public async getAddMovieResult (version: number, requestId: string, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiAddMovieResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/addMovie/{requestId}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
     ...
     * @param accountId Sirqul Account Id
     */
    public async getBatch (version: number, requestId: string, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiBatchResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/batch/{requestId}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'requestId' + '}', encodeURIComponent(String(requestId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param accountId Sirqul Account Id
     */
    public async getEmotion (version: number, requestId: string, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiEmotionsResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/emotion/{requestId}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'requestId' + '}', encodeURIComponent(String(requestId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param accountId Sirqul Account Id
     */
    public async getEpisodeStatus (version: number, episodeId: number, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonEpisodeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/stories/episodes/{episodeId}/status'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
     ...
     * @param accountId Sirqul Account Id
     */
    public async getRenderStatus (version: number, renderId: string, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonRenderResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/stories/renders/{renderId}/status'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
     ...
     * @param accountId Sirqul Account Id
     */
    public async getSTT (version: number, requestId: string, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiSTTResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/stt/{requestId}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'requestId' + '}', encodeURIComponent(String(requestId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param accountId Sirqul Account Id
     */
    public async getTTS (version: number, requestId: string, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiTTSResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/tts/{requestId}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'requestId' + '}', encodeURIComponent(String(requestId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param accountId Sirqul Account Id
     */
    public async getTechTune (version: number, requestId: string, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiTechTuneResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/techTune/{requestId}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'requestId' + '}', encodeURIComponent(String(requestId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param accountId Sirqul Account Id
     */
    public async getTopics (version: number, requestId: string, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiTopicsResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/topics/{requestId}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'requestId' + '}', encodeURIComponent(String(requestId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param accountId Sirqul Account Id
     */
    public async getVoiceCanvas (version: number, requestId: string, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiVoiceCanvasResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/voiceCanvas/{requestId}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'requestId' + '}', encodeURIComponent(String(requestId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param data Request Data String
     */
    public async startVideoRender (version: number, accountId: number, data: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonRenderResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/stories/renders'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param callback When provided, Orson will return a 202 and POST the results to this URL when complete instead of holding the Request open
     */
    public async stt (version: number, accountId: number, thirdPartyAccountId?: string, sourceLanguage?: string, targetLanguage?: string, file?: RequestFile, url?: string, callback?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiSTTResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/stt'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param callback When provided, Orson will return a 202 and POST the results to this URL when complete instead of holding the Request open
     */
    public async summarizeTopics (version: number, accountId: number, thirdPartyAccountId?: string, doc?: string, file?: RequestFile, url?: string, limit?: number, offset?: number, callback?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiTopicsResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/topics'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param callback When provided, Orson will return a 202 and POST the results to this URL when complete instead of holding the Request open
     */
    public async techTune (version: number, accountId: number, numFacesExpected: number, thirdPartyAccountId?: string, file?: RequestFile, url?: string, callback?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiTechTuneResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/techTune'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param callback When provided, Orson will return a 202 and POST the results to this URL when complete instead of holding the Request open
     */
    public async tts (version: number, accountId: number, text: string, thirdPartyAccountId?: string, language?: string, voice?: string, callback?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrsonAiTTSResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/orson/ai/tts'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
