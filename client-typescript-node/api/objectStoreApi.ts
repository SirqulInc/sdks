...
export class ObjectStoreApi {
     ...
     */
    public async addField (version: number, accountId: number, appKey: string, objectName: string, fieldName: string, fieldType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectStoreResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/object/field/add'
     ...
     * @param body 
     */
    public async createData (version: number, objectName: string, accountId?: number, body?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectStoreResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/object/data/{objectName}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
     ...
     */
    public async createObject (version: number, accountId: number, appKey: string, objectName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectStoreResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/object/create'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param accountId The account id of the logged in user
     */
    public async deleteData (version: number, objectName: string, objectId: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectStoreResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/object/data/{objectName}/{objectId}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'objectName' + '}', encodeURIComponent(String(objectName)))
     ...
     */
    public async deleteField (version: number, accountId: number, appKey: string, objectName: string, fieldName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectStoreResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/object/field/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async deleteObject (version: number, accountId: number, appKey: string, objectName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectStoreResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/object/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param include 
     */
    public async getData (version: number, objectName: string, objectId: string, accountId?: number, include?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectStoreResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/object/data/{objectName}/{objectId}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'objectName' + '}', encodeURIComponent(String(objectName)))
            .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
     ...
     */
    public async getObject (version: number, accountId: number, appKey: string, objectName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectStoreResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/object/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param include 
     */
    public async searchData (version: number, objectName: string, count: boolean, start: number, limit: number, accountId?: number, criteria?: string, order?: string, include?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectStoreResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/object/data/{objectName}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'objectName' + '}', encodeURIComponent(String(objectName)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async searchObject (version: number, accountId: number, appKey: string, start: number, limit: number, keyword?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectStoreResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/object/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param body 
     */
    public async updateData (version: number, objectName: string, objectId: string, accountId?: number, body?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ObjectStoreResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/object/data/{objectName}/{objectId}'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)))
            .replace('{' + 'objectName' + '}', encodeURIComponent(String(objectName)))
            .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
