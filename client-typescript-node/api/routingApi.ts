...
export class RoutingApi {
     ...
     */
    public async computeRouting (data: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RoutingListResponse;  }> {
        const localVarPath = this.basePath + '/routing/compute';
