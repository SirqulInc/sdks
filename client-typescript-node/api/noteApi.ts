...
export class NoteApi {
     ...
     */
    public async batchOperation (notableId: number, notableType: string, deviceId?: string, accountId?: number, batchOperation?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/note/batch';
     ...
     */
    public async createNote (comment: string, deviceId?: string, accountId?: number, notableType?: string, notableId?: number, noteType?: string, assetIds?: string, tags?: string, permissionableType?: string, permissionableId?: number, appKey?: string, locationDescription?: string, latitude?: number, longitude?: number, metaData?: string, receiverAccountIds?: string, returnFullResponse?: boolean, initializeAsset?: boolean, assetReturnNulls?: boolean, assetAlbumId?: number, assetCollectionId?: number, assetAddToDefaultAlbum?: string, assetAddToMediaLibrary?: boolean, assetVersionCode?: number, assetVersionName?: string, assetMetaData?: string, assetCaption?: string, assetMedia?: RequestFile, assetMediaUrl?: string, assetMediaString?: string, assetMediaStringFileName?: string, assetMediaStringContentType?: string, assetAttachedMedia?: RequestFile, assetAttachedMediaUrl?: string, assetAttachedMediaString?: string, assetAttachedMediaStringFileName?: string, assetAttachedMediaStringContentType?: string, assetLocationDescription?: string, assetApp?: string, assetSearchTags?: string, assetLatitude?: number, assetLongitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NoteResponse;  }> {
        const localVarPath = this.basePath + '/note/create';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param appKey The application key used to identify the application
     */
    public async deleteNote (noteId: number, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, appKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/note/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getNote (noteId: number, deviceId?: string, accountId?: number, returnFullResponse?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/note/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param assetLongitude the longitude of the asset
     */
    public async updateNote (noteId: number, deviceId?: string, accountId?: number, comment?: string, noteType?: string, assetIds?: string, tags?: string, permissionableType?: string, permissionableId?: number, appKey?: string, locationDescription?: string, latitude?: number, longitude?: number, metaData?: string, returnFullResponse?: boolean, active?: boolean, updateAsset?: boolean, assetReturnNulls?: boolean, assetAlbumId?: number, assetCollectionId?: number, assetAddToDefaultAlbum?: string, assetAddToMediaLibrary?: boolean, assetVersionCode?: number, assetVersionName?: string, assetMetaData?: string, assetCaption?: string, assetMedia?: RequestFile, assetMediaUrl?: string, assetMediaString?: string, assetMediaStringFileName?: string, assetMediaStringContentType?: string, assetAttachedMedia?: RequestFile, assetAttachedMediaUrl?: string, assetAttachedMediaString?: string, assetAttachedMediaStringFileName?: string, assetAttachedMediaStringContentType?: string, assetLocationDescription?: string, assetApp?: string, assetSearchTags?: string, assetLatitude?: number, assetLongitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NoteResponse;  }> {
        const localVarPath = this.basePath + '/note/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
