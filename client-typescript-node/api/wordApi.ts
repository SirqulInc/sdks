...
export class WordApi {
     ...
     */
    public async createWord (version: number, accountId: number, word: string, definition: string, active: boolean, allocateTickets: boolean, ticketCount: number, assetId?: number, ticketType?: string, points?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WordzWordResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/game/word/create'
     ...
     */
    public async deleteWord (version: number, wordId: number, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/game/word/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param accountId The logged in user.
     */
    public async getWord (version: number, wordId: number, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WordzWordResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/game/word/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getWords (version: number, accountId: number, sortField: string, descending: boolean, activeOnly: boolean, start: number, limit: number, keyword?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<WordzWordResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/game/word/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
