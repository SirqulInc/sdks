...
export class RetailerV2Api {
     ...
     */
    public async getRetaokiler (version: number, retailerId: number, activeOnly: boolean, keyword?: string, sortField?: string, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/retailer'
