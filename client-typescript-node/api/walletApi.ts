...
export class WalletApi {
     ...
     */
    public async createOfferTransaction (version: number, deviceId?: string, accountId?: number, offerId?: number, offerLocationId?: number, offerCart?: string, promoCode?: string, currencyType?: string, usePoints?: boolean, metaData?: string, appKey?: string, status?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<OfferTransactionResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/wallet/create'
     ...
     * @param accountId The account id of the user (deviceId or accountId required)
     */
    public async deleteOfferTransaction (version: number, transactionId: number, deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/wallet/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getOfferTransaction (version: number, transactionId: number, deviceId?: string, accountId?: number, includeMission?: boolean, latitude?: number, longitude?: number, returnFullResponse?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OfferTransactionResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/wallet/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param appKey The application requesting the purchase, required when currencyType is TICKETS
     */
    public async previewOfferTransaction (version: number, deviceId?: string, accountId?: number, offerId?: number, offerLocationId?: number, offerCart?: string, promoCode?: string, currencyType?: string, usePoints?: boolean, metaData?: string, appKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<OfferTransactionResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/wallet/preview'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async updateOfferTransaction (version: number, transactionId: number, status: number, deviceId?: string, accountId?: number, offerLocationId?: number, currencyType?: string, usePoints?: boolean, appKey?: string, latitude?: number, longitude?: number, metaData?: string, returnFullResponse?: boolean, exceptionMembershipOfferIds?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OfferTransactionResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/wallet/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
