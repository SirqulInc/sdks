...
export class PurchaseItemApi {
     ...
     * @param accountId The account id of the user (deviceId or accountId required)
     */
    public async deletePurchaseItem (version: number, purchaseItemId: number, deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/purchase/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param accountId The account id of the user (deviceId or accountId required)
     */
    public async getPurchaseItem (version: number, purchaseItemId: number, deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PurchaseItemFullResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/purchase/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async searchPurchaseItems (version: number, deviceId?: string, accountId?: number, appKey?: string, filterByBillable?: boolean, purchaseType?: string, serviceAction?: string, keyword?: string, sortField?: 'ID' | 'CREATED' | 'UPDATED' | 'DELETED' | 'SEARCH_TAGS' | 'ACTIVE' | 'NAME' | 'DESCRIPTION' | 'TICKETS' | 'PRICE' | 'PURCHASE_TYPE' | 'PURCHASE_CODE' | 'PURCHASE_LIMIT' | 'SERIVCE_ACTION' | 'GIFTABLE' | 'ASSETABLE' | 'APPLICATION_ID' | 'APPLICATION_NAME', descending?: boolean, start?: number, limit?: number, activeOnly?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<PurchaseItemResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/purchase/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param offerLocationId The offer location that will get added to the user\&#39;s wallet after purchase.
     */
    public async updatePurchaseItem (version: number, purchaseItemId: number, deviceId?: string, accountId?: number, name?: string, description?: string, tickets?: number, price?: number, purchaseType?: 'SIRQUL' | 'IOS' | 'GOOGLE' | 'AMAZON' | 'MAC' | 'WP8' | 'FREE', purchaseCode?: string, secretKey?: string, purchaseLimit?: number, serviceAction?: 'DAY_PREMIUM' | 'WEEK_PREMIUM' | 'MONTH_PREMIUM' | 'YEAR_PREMIUM' | 'LIFETIME_PREMIUM' | 'ADD_TICKET' | 'ADD_GIFT' | 'ADD_POINTS', coverAssetId?: number, promoAssetId?: number, giftable?: boolean, assetable?: boolean, active?: boolean, allocateTickets?: boolean, ticketType?: string, points?: number, offerLocationId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PurchaseItemFullResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/purchase/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
