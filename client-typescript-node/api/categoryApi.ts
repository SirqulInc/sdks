...
export class CategoryApi {
     ...
     */
    public async createCategory (version: number, accountId: number, name: string, appKey?: string, parentCategoryId?: number, description?: string, type?: string, assetId?: number, externalId?: string, externalType?: string, externalCategorySlug?: string, sqootSlug?: string, active?: boolean, metaData?: string, searchTags?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CategoryTreeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/category/create'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async deleteCategory (version: number, accountId: number, categoryId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/category/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async duplicateCategory (version: number, accountId: number, categoryId: number, appKey?: string, parentCategoryId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CategoryTreeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/category/duplicate'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param returnExternal Determines whether to return extra info about the category\&#39;s \&quot;Participant\&quot; reference
     */
    public async getCategory (version: number, categoryId: number, returnExternal?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CategoryTreeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/category/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async searchCategories (version: number, accountId?: number, keyword?: string, appKey?: string, categoryId?: string, categoryIds?: string, parentCategoryIds?: string, rootOnly?: boolean, sortField?: 'ID' | 'CREATED' | 'UPDATED' | 'DELETED' | 'SEARCH_TAGS' | 'ACTIVE' | 'NAME' | 'DISPLAY', responseGroup?: 'ALL' | 'GLOBAL' | 'MINE', descending?: boolean, start?: number, limit?: number, activeOnly?: boolean, returnExternal?: boolean, exactMatch?: boolean, type?: string, externalType?: string, excludeExternalType?: boolean, minOfferCount?: number, searchDepth?: number, searchMode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<CategoryResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/category/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param searchTags user defined strings for searching
     */
    public async updateCategory (version: number, accountId: number, categoryId: number, parentCategoryId?: number, name?: string, description?: string, type?: string, assetId?: number, externalId?: string, externalType?: string, externalCategorySlug?: string, sqootSlug?: string, active?: boolean, metaData?: string, searchTags?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CategoryTreeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/category/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
