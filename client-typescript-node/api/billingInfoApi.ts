...
export class BillingInfoApi {
     ...
     */
    public async addPaymentMethod (accountId: number, paymentMethodId?: number, accountName?: string, firstName?: string, lastName?: string, address?: string, city?: string, state?: string, postalCode?: string, country?: string, phone?: string, creditCardNumber?: string, expirationDate?: string, ccv?: string, accountNumber?: string, bankName?: string, routingNumber?: string, defaultPaymentMethod?: boolean, paymentMethodNickname?: string, taxId?: string, providerCustomerProfileId?: string, providerPaymentProfileId?: string, metaData?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentTypesResponse;  }> {
        const localVarPath = this.basePath + '/billing/update';
     ...
     */
    public async createPaymentMethod (accountId: number, accountName?: string, firstName?: string, lastName?: string, address?: string, city?: string, state?: string, postalCode?: string, country?: string, phone?: string, creditCardNumber?: string, expirationDate?: string, ccv?: string, accountNumber?: string, bankName?: string, routingNumber?: string, paymentMethodNickname?: string, taxId?: string, defaultPaymentMethod?: boolean, authToken?: string, provider?: string, providerCustomerProfileId?: string, providerPaymentProfileId?: string, metaData?: string, appKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentTypesResponse;  }> {
        const localVarPath = this.basePath + '/billing/create';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async createSmartContract (accountId: number, tokenName: string, tokenSymbol: string, paymentMethodId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentTypesResponse;  }> {
        const localVarPath = this.basePath + '/billing/crypto/transfer';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param paymentMethodId The payment method to return details on. If this is not set, then the user\&#39;s default payment method will be returned.
     */
    public async getCryptoBalance (accountId: number, ownerAccountId?: number, paymentMethodId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentTypesResponse;  }> {
        const localVarPath = this.basePath + '/billing/crypto/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getPaymentMethod (accountId: number, paymentMethodId?: number, getCurrentBalance?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentTypesResponse;  }> {
        const localVarPath = this.basePath + '/billing/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async searchPaymentMethod (accountId: number, provider?: string, type?: string, keyword?: string, sortField?: string, descending?: boolean, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentTypesResponse;  }> {
        const localVarPath = this.basePath + '/billing/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
