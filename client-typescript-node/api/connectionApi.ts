...
export class ConnectionApi {
     ...
     */
    public async addConnectionToGroup (returnNulls: boolean, groupId: number, deviceId?: string, accountId?: number, connectionId?: number, connectionAccountId?: number, pendingId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/connection/group/addConnection';
     ...
     * @param longitude the current longitude of the user
     */
    public async addConnectionsToGroup (connectionGroupId: number, deviceId?: string, accountId?: number, connectionIds?: string, connectionAccountIds?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/connection/group/addConnections';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param longitude the current longitude of the user
     */
    public async addSubGroups (returnNulls: boolean, groupId: number, subGroupIds: string, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConnectionGroupResponse;  }> {
        const localVarPath = this.basePath + '/consumer/connection/group/addSubGroup';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async createOrUpdateConnection (deviceId?: string, accountId?: number, connectionId?: number, connectionAccountId?: number, pendingId?: number, groupId?: number, gameType?: string, appKey?: string, isTrusted?: boolean, ignoreFriendRequest?: boolean, isContact?: boolean, isBlocked?: boolean, isFollowing?: boolean, connectionResponse?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConnectionResponse;  }> {
        const localVarPath = this.basePath + '/consumer/connection/add';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async createOrUpdateGroup (returnNulls: boolean, deviceId?: string, accountId?: number, name?: string, groupId?: number, assetId?: number, connections?: string, description?: string, canViewProfileInfo?: boolean, canViewGameInfo?: boolean, canViewFriendInfo?: boolean, active?: boolean, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/connection/group';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async followAccept (accountId: number, connectionAccountId: number, appKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/follow/accept';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param appKey the application key for sending notifications
     */
    public async followReject (accountId: number, connectionAccountId: number, appKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/follow/reject';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param appKey the application key for sending notifications
     */
    public async followRemove (accountId: number, connectionAccountId: number, appKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/follow/remove';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async followRequest (accountId: number, connectionAccountId: number, appKey: string, approvalNeeded?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/follow/request';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async friendAccept (friendAccountId: number, notifyFriend: boolean, deviceId?: string, accountId?: number, gameType?: string, appKey?: string, notificationMessage?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/friend/accept';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param notificationMessage optional message to send in a notification
     */
    public async friendReject (friendAccountId: number, deviceId?: string, accountId?: number, gameType?: string, appKey?: string, notifyFriend?: boolean, notificationMessage?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/friend/reject';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async friendRemove (friendAccountId: number, deviceId?: string, accountId?: number, notifyFriend?: boolean, removeFromGroups?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/friend/remove';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param notificationMessage optional message to send in a notification
     */
    public async friendRequest (friendAccountId: number, deviceId?: string, accountId?: number, gameType?: string, appKey?: string, notificationMessage?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/friend/request';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getConnectionSentFriendRequests (deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConnectionListResponse;  }> {
        const localVarPath = this.basePath + '/consumer/connection/getRequested';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
    ...
    public async getConnections (returnNulls: boolean, filter: string, sortField: string, descending: boolean, start: number, limit: number, deviceId?: string, accountId?: number, connectionAccountId?: number, q?: string, keyword?: string, i?: number, l?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConnectionListResponse;  }> {
        const localVarPath = this.basePath + '/consumer/connection/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param longitude the current longitude of the user
     */
    public async getGroupDetails (combineConnections: boolean, deviceId?: string, accountId?: number, groupId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConnectionGroupResponse;  }> {
        const localVarPath = this.basePath + '/consumer/connection/group/details/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param longitude the current longitude of the user
     */
    public async removeConnectionFromGroup (returnNulls: boolean, groupId: number, deviceId?: string, accountId?: number, connectionId?: number, connectionAccountId?: number, pendingId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/connection/group/removeConnection';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param longitude the current longitude of the user
     */
    public async removeConnectionsFromGroup (connectionGroupId: number, deviceId?: string, accountId?: number, connectionIds?: string, connectionAccountIds?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/connection/group/removeConnections';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param longitude the current longitude of the user
     */
    public async removeGroup (returnNulls: boolean, groupId: number, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/connection/group/remove';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param longitude the current longitude of the user
     */
    public async removeSubGroups (returnNulls: boolean, groupId: number, subGroupIds: string, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/consumer/connection/group/removeSubGroup';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async searchConnections (returnNulls: boolean, start: number, limit: number, deviceId?: string, accountId?: number, q?: string, keyword?: string, latitude?: number, longitude?: number, gameType?: string, appKey?: string, i?: number, l?: number, sortField?: string, hasLocation?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConnectionListResponse;  }> {
        const localVarPath = this.basePath + '/connection/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
