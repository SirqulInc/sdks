...
export class LeaderboardApi {
     ...
     */
    public async createLeaderboard (accountId?: number, appKey?: string, rankType?: string, leaderboardMode?: string, iconMedia?: RequestFile, iconAssetId?: number, bannerMedia?: RequestFile, bannerAssetId?: number, limitation?: number, sortField?: string, title?: string, description?: string, metaData?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeaderboardResponse;  }> {
        const localVarPath = this.basePath + '/leaderboard/create';
     ...
     */
    public async deleteLeaderboard (leaderboardId: number, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/leaderboard/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getLeaderboard (leaderboardId: number, accountId?: number, includeFullRankingList?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeaderboardResponse;  }> {
        const localVarPath = this.basePath + '/leaderboard/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param metaData custom meta data for the leaderboard
     */
    public async updateLeaderboard (leaderboardId: number, accountId?: number, appKey?: string, rankType?: string, leaderboardMode?: string, sortField?: string, iconMedia?: RequestFile, iconAssetId?: number, bannerMedia?: RequestFile, bannerAssetId?: number, limitation?: number, active?: boolean, title?: string, description?: string, metaData?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeaderboardResponse;  }> {
        const localVarPath = this.basePath + '/leaderboard/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
