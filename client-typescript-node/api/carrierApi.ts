...
export class CarrierApi {
     ...
     */
    public async searchCarriers (keyword?: string, descending?: boolean, start?: number, limit?: number, activeOnly?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<CellCarrierResponse>;  }> {
        const localVarPath = this.basePath + '/carrier/search';
