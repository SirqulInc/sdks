...
export class DisbursementApi {
     ...
     */
    public async checkDisbursements (disbursementId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DisbursementResponse;  }> {
        const localVarPath = this.basePath + '/disbursement/check';
     ...
     */
    public async getDisbursement (accountId: number, disbursementId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DisbursementResponse;  }> {
        const localVarPath = this.basePath + '/disbursement/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async searchDisbursements (accountId: number, receiverAccountId?: number, statuses?: string, providers?: string, beforeDate?: number, afterDate?: number, start?: number, limit?: number, activeOnly?: boolean, externalId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<DisbursementResponse>;  }> {
        const localVarPath = this.basePath + '/disbursement/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
