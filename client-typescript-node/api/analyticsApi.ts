...
export class AnalyticsApi {
     ...
     */
    public async activities (version: number, start: number, limit: number, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<UserActivityResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/analytics/useractivity'
    ...
    public async usage (version: number, tag: string, deviceId?: string, accountId?: number, applicationId?: number, appKey?: string, appVersion?: string, device?: string, deviceType?: string, deviceOS?: string, model?: string, latitude?: number, longitude?: number, customId?: number, customType?: string, achievementIncrement?: number, city?: string, state?: string, country?: string, zip?: string, locationDescription?: string, clientTime?: number, errorMessage?: string, ip?: string, userAgent?: string, backgroundEvent?: boolean, customMessage?: string, customMessage2?: string, customValue?: number, customValue2?: number, customLong?: number, customLong2?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/analytics/usage'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
