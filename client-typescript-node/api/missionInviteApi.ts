...
export class MissionInviteApi {
     ...
     */
    public async createMissionInvite (deviceId?: string, accountId?: number, missionId?: number, joinCode?: string, includeGameData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MissionResponse;  }> {
        const localVarPath = this.basePath + '/mission/invite/create';
     ...
     * @param includeGameData Include the game level data with the mission.
     */
    public async deleteMissionInvite (deviceId?: string, accountId?: number, missionId?: number, missionInviteId?: number, includeGameData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/mission/invite/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getMissionInvite (deviceId?: string, accountId?: number, missionId?: number, missionInviteId?: number, includeGameData?: boolean, includeScores?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MissionResponse;  }> {
        const localVarPath = this.basePath + '/mission/invite/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
