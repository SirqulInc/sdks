...
export class FacebookApi {
     ...
     */
    public async getToken (deviceId?: string, accountId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TokenResponse;  }> {
        const localVarPath = this.basePath + '/facebook/getfbtoken';
     ...
     * @param longitude used to update the user\&#39;s current location
     */
    public async graphInterface (event: string, deviceId?: string, accountId?: number, permissionableType?: string, permissionableId?: number, assetId?: number, gameType?: string, appKey?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/facebook/graph';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
