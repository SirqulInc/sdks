...
export class RetailerApi {
     ...
     */
    public async deleteRetailer (deviceId?: string, accountId?: number, retailerId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/retailer/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getRetailer (retailerId: number, deviceId?: string, accountId?: number, includeCounts?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RetailerFullResponse;  }> {
        const localVarPath = this.basePath + '/retailer/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getRetailers (visibility: 'PUBLIC' | 'PRIVATE' | 'FRIENDS', sortField: 'ID' | 'CREATED' | 'UPDATED' | 'DELETED' | 'SEARCH_TAGS' | 'ACTIVE' | 'BILLABLE_ENTITY_ID' | 'BILLABLE_ENTITY_NAME' | 'RESPONSIBLE_DISPLAY' | 'ADDRESS_STREET' | 'ADDRESS_CITY' | 'ADDRESS_STATE' | 'ADDRESS_POSTAL_CODE' | 'ADDRESS_COUNTRY' | 'FILTERS' | 'CATEGORIES' | 'VISIBILITY' | 'NAME', descending: boolean, start: number, limit: number, activeOnly: boolean, deviceId?: string, accountId?: number, q?: string, keyword?: string, categoryIds?: string, filterIds?: string, i?: number, l?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<RetailerResponse>;  }> {
        const localVarPath = this.basePath + '/retailer/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async retailerLoginCheck (username: string, password: string, deviceId?: string, latitude?: number, longitude?: number, appKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountLoginResponse;  }> {
        const localVarPath = this.basePath + '/retailer/login';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
