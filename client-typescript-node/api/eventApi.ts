...
export class EventApi {
     ...
     */
    public async deleteEvent (version: number, accountId: number, eventId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/event/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getEvent (version: number, accountId: number, eventId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OfferResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/event/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param redeemableEnd The event end date/time
     */
    public async updateEvent (version: number, accountId: number, eventId: number, retailerLocationIds?: string, title?: string, subTitle?: string, details?: string, categoryIds?: string, filterIds?: string, active?: boolean, imageAssetId?: number, redeemableStart?: number, redeemableEnd?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OfferResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/event/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
