...
export class ParticipantsApi {
     ...
     */
    public async processAllParticipants (accountId: number, appKey?: string, useShortNameAsID?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/participant/process/all';
     ...
     */
    public async processParticipants (accountId: number, league: string, appKey?: string, useShortNameAsID?: boolean, file?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/participant/process';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
