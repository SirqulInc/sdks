...
export class SimulationApi {
     ...
     */
    public async simulation (data: string, realTime: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/simulation/routing';
