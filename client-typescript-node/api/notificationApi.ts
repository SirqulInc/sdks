...
export class NotificationApi {
     ...
     */
    public async createNotificationTemplate (accountId: number, conduit: string, title: string, body: string, appKey?: string, event?: string, tags?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NotificationTemplateResponse;  }> {
        const localVarPath = this.basePath + '/notification/template/create';
     ...
     * @param accountId the account id of the user
     */
    public async createOrUpdateBlockedNotifications (appKey: string, data: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BlockedNotificationResponse;  }> {
        const localVarPath = this.basePath + '/notification/blocked/batch';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async deleteNotificationTemplate (accountId: number, notificationTemplateId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NotificationTemplateResponse;  }> {
        const localVarPath = this.basePath + '/notification/template/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getNotificationTemplate (accountId: number, notificationTemplateId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NotificationTemplateResponse;  }> {
        const localVarPath = this.basePath + '/notification/template/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param longitude Longitude used to update the user\&#39;s current location
     */
    public async registerNotificationToken (token: string, pushType: 'APNS' | 'GCM' | 'BAIDU' | 'XGPUSH' | 'JPUSH', deviceId?: string, accountId?: number, environment?: string, appKey?: string, gameType?: string, active?: boolean, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/notification/token';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param limit limit of the pagination
     */
    public async searchBlockedNotifications (appKey: string, accountId?: number, searchTags?: string, events?: string, conduits?: string, customTypes?: string, contentTypes?: string, contentIds?: string, sortField?: string, descending?: boolean, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BlockedNotificationResponse;  }> {
        const localVarPath = this.basePath + '/notification/blocked/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param limit limit of the pagination
     */
    public async searchRecipientsCount (deviceId?: string, accountId?: number, appKey?: string, conduit?: string, keyword?: string, audienceId?: number, audienceIds?: string, connectionGroupIds?: string, sortField?: string, descending?: boolean, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NotificationRecipientResponseListResponse;  }> {
        const localVarPath = this.basePath + '/notification/recipient/search/count';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async sendBatchNotifications (accountId: number, appKey: string, customMessage: string, conduit?: string, contentId?: number, contentName?: string, contentType?: string, parentId?: number, parentType?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/notification/batch';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async updateNotificationTemplate (accountId: number, notificationTemplateId: number, title?: string, body?: string, tags?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NotificationTemplateResponse;  }> {
        const localVarPath = this.basePath + '/notification/template/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
