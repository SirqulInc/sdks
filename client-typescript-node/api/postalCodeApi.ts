...
export class PostalCodeApi {
     ...
     */
    public async createPostalCode (accountId: number, code: string, latitude: number, longitude: number, stateCode?: string, city?: string, active?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostalCodeResponse;  }> {
        const localVarPath = this.basePath + '/postalCode/create';
     ...
     */
    public async deletePostalCode (accountId: number, postalCodeId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/postalCode/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getPostalCode (postalCodeId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostalCodeResponse;  }> {
        const localVarPath = this.basePath + '/postalCode/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getPostalCodes (sortField: string, descending: boolean, latitude?: number, longitude?: number, keyword?: string, miles?: number, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<PostalCodeResponse>;  }> {
        const localVarPath = this.basePath + '/postalCode/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async updatePostalCode (accountId: number, postalCodeId: number, code?: string, latitude?: number, longitude?: number, stateCode?: string, city?: string, active?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostalCodeResponse;  }> {
        const localVarPath = this.basePath + '/postalCode/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
