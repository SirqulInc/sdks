...
export class FavoriteApi {
     ...
     */
    public async addFavorite (favoritableId: number, favoritableType: string, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WrappedResponse;  }> {
        const localVarPath = this.basePath + '/favorite/create';
     ...
     */
    public async deleteFavorite (deviceId?: string, accountId?: number, favoriteId?: number, favoritableId?: number, favoritableType?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/favorite/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param longitude The current longitude of the user
     */
    public async getFavorite (favoriteId: number, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WrappedResponse;  }> {
        const localVarPath = this.basePath + '/favorite/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async whoHasFavorited (favoritableId: number, favoritableType: string, start: number, limit: number, deviceId?: string, accountId?: number, latitude?: number, longitude?: number, keyword?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<AccountResponse>;  }> {
        const localVarPath = this.basePath + '/favorite/whois';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
