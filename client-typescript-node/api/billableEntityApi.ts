...
export class BillableEntityApi {
     ...
     */
    public async createBillableEntity (version: number, deviceId?: string, accountId?: number, name?: string, streetAddress?: string, streetAddress2?: string, city?: string, state?: string, postalCode?: string, businessPhone?: string, businessPhoneExt?: string, authorizeNetApiKey?: string, authorizeNetTransactionKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BillableEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/billable/create'
     ...
     */
    public async deleteBillableEntity (version: number, deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/billable/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getBillableEntity (version: number, deviceId?: string, accountId?: number, includeCounts?: boolean, includePayments?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BillableEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/billable/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async updateBillableEntity (version: number, deviceId?: string, accountId?: number, name?: string, streetAddress?: string, streetAddress2?: string, city?: string, state?: string, postalCode?: string, businessPhone?: string, businessPhoneExt?: string, authorizeNetApiKey?: string, authorizeNetTransactionKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BillableEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/billable/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
