...
export class AppDataApi {
     ...
     * @param purchaseType the will return the correct in app purchases for the device, possible values are: * SIRQUL (default) - purchasing from the sirqul store using tickets * IOS - purchasing from the itunes store for iPhone, iPod, iPod Touch * GOOGLE - purchasing from the google android store * AMAZON - purchasing from the amazon android store * MAC - purchasing from the itunes store for OSX * FREE - the item is free to purchase 
     */
    public async postAppData (version: number, gameType: string, start: number, limit: number, data: string, deviceId?: string, accountId?: number, includeGameData?: boolean, q?: string, keyword?: string, sortField?: string, descending?: boolean, i?: number, l?: number, gameObjectCount?: boolean, filter?: string, dateCreated?: number, ownerId?: number, missionIds?: string, gameIds?: string, packIds?: string, gameLevelIds?: string, appVersion?: string, includeHigherVersionPacks?: boolean, includeHigherVersionLevels?: boolean, responseGroups?: string, purchaseType?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AppResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/app/post'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async regenAppData (version: number, accountId?: number, appKey?: string, buildVersion?: string, apiVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/app/regen'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
