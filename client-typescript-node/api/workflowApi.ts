...
export class WorkflowApi {
     ...
     */
    public async runWorkflow (accountId: number, workflowId: number, skuId?: number, versionCode?: number, parameters?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/workflow/run';
