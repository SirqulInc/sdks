...
export class ListingApi {
     ...
     */
    public async deleteListing (accountId: number, listingId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/listing/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getListing (listingId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListingFullResponse;  }> {
        const localVarPath = this.basePath + '/listing/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param externalGroupId external group identifier used by a third party
     */
    public async searchListing (accountId?: number, keyword?: string, start?: number, limit?: number, activeOnly?: boolean, latitude?: number, longitude?: number, startDate?: number, endDate?: number, categoryIds?: string, filterIds?: string, useListingOrderIds?: boolean, externalId?: string, externalId2?: string, externalGroupId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<ListingResponse>;  }> {
        const localVarPath = this.basePath + '/listing/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param useListingOrderIds determines whether to use configured listing order ids
     */
    public async summaryListing (accountId?: number, startDate?: number, categoryIds?: string, daysToInclude?: number, useListingOrderIds?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<ListingGroupResponse>;  }> {
        const localVarPath = this.basePath + '/listing/summary';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param metaData external custom client defined data
     */
    public async updateListing (accountId: number, listingId: number, filterIds?: string, name?: string, description?: string, start?: number, end?: number, locationName?: string, locationDescription?: string, isPrivate?: boolean, externalId?: string, externalId2?: string, externalGroupId?: string, active?: boolean, metaData?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListingFullResponse;  }> {
        const localVarPath = this.basePath + '/listing/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
