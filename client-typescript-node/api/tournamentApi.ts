...
export class TournamentApi {
     ...
     */
    public async deleteTournament (version: number, accountId: number, missionId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/tournament/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getTournament (version: number, accountId: number, missionId?: number, joinCode?: string, includeScores?: 'ALL' | 'MINE', objectPreviewSize?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TournamentResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/tournament/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async searchObjects (version: number, accountId: number, gameLevelId: number, sortField?: 'ID' | 'PLAYER_SCORE_COUNT', descending?: boolean, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/tournament/object/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param limit the limit for pagination
     */
    public async searchRounds (version: number, accountId: number, appKey: string, status?: string, missionType?: 'TOURNAMENT' | 'POOLPLAY', currentOnly?: boolean, visibilities?: string, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/tournament/round/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async searchTournaments (version: number, accountId: number, appKey: string, keyword?: string, subType?: string, includeInactive?: boolean, missionTypes?: string, filter?: 'ALL' | 'UPCOMING' | 'PAST' | 'PRESENT' | 'ACTIVE', sortField?: 'ACTIVE' | 'TITLE' | 'DESCRIPTION' | 'CREATED' | 'UPDATED' | 'MISSION_TYPE' | 'OWNER_DISPLAY' | 'START_DATE' | 'END_DATE' | 'STARTING_LIMIT' | 'AVAILABLE_LIMIT' | 'INVITE_COUNT' | 'ACCEPTED_COUNT', descending?: boolean, visibility?: string, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MissionShortResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/tournament/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async submitTournamentScore (version: number, accountId: number, appKey: string, missionId: number, gameId: number, packId: number, scores: string, gameLevelId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/tournament/score'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async submitTournamentVote (version: number, accountId: number, appKey: string, missionId: number, gameObjectId: number, deviceId?: string, checkIfDeviceAlreadyVoted?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/tournament/vote'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async substituteTournamentPlayer (version: number, accountId: number, missionId: number, packId: number, gameLevelId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/tournament/substitute'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
