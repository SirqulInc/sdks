...
export class ThirdPartyCredentialsApi {
     ...
     */
    public async createCredential (thirdPartyId: string, thirdPartyToken: string, networkUID: string, appKey: string, accountId?: number, deviceId?: string, sessionId?: string, thirdPartyName?: string, emailAddress?: string, signinOnlyMode?: boolean, responseFilters?: string, latitude?: number, longitude?: number, metaData?: string, thirdPartyRefreshToken?: string, audienceIdsToAdd?: string, audienceIdsToRemove?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ProfileResponse;  }> {
        const localVarPath = this.basePath + '/thirdparty/credential/create';
     ...
     * @param appKey the application key
     */
    public async deleteCredential (accountId: number, networkUID: string, thirdPartyId: string, appKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/thirdparty/credential/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async deleteNetwork (accountId: number, networkUID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/thirdparty/network/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param networkUID The unique identifier for the third party network defined by Sirqul
     */
    public async getNetwork (accountId: number, networkUID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ThirdPartyNetworkResponse;  }> {
        const localVarPath = this.basePath + '/thirdparty/network/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async searchCredentials (accountId: number, keyword?: string, networkUID?: string, descending?: boolean, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<ThirdPartyCredentialResponse>;  }> {
        const localVarPath = this.basePath + '/thirdparty/credential/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async searchNetworks (accountId: number, sortField: 'ID' | 'CREATED' | 'UPDATED' | 'DELETED' | 'SEARCH_TAGS' | 'ACTIVE' | 'BILLABLE_ENTITY_ID' | 'BILLABLE_ENTITY_NAME' | 'RESPONSIBLE_DISPLAY' | 'NAME' | 'DESCRIPTION', descending: boolean, start: number, limit: number, activeOnly: boolean, keyword?: string, filterBillable?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<ThirdPartyNetworkShortResponse>;  }> {
        const localVarPath = this.basePath + '/thirdparty/network/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param deviceId the unique id of the device making the request
     */
    public async sendMFAChallenge (networkUID: string, appKey: string, thirdPartyToken?: string, thirdPartyCredentialId?: number, deviceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/thirdparty/credential/mfa/send';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param thirdPartyRefreshToken optional refresh token for the third party
     */
    public async updateCredential (networkUID: string, thirdPartyId: string, appKey: string, deviceId?: string, thirdPartyName?: string, thirdPartyToken?: string, responseFilters?: string, metaData?: string, thirdPartyRefreshToken?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ProfileResponse;  }> {
        const localVarPath = this.basePath + '/thirdparty/credential/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param body 
     */
    public async updateNetwork (accountId: number, networkUID: string, name?: string, description?: string, enableIntrospection?: boolean, introspectionMethod?: string, introspectionURL?: string, introspectionParams?: string, requiredRootField?: string, enableMFA?: boolean, sizeMFA?: number, shelfLifeMFA?: number, oauthTokenURL?: string, oauthPrivateKey?: RequestFile, oauthPublicKey?: RequestFile, oauthClientId?: string, oauthSecretKey?: string, body?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ThirdPartyNetworkResponse;  }> {
        const localVarPath = this.basePath + '/thirdparty/network/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
