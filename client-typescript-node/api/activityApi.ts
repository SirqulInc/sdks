...
export class ActivityApi {
     ...
     */
    public async createEntityReference (body: EntityReference, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ActivityResponse;  }> {
        const localVarPath = this.basePath + '/entity/reference';
