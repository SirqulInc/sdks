...
export class ActivityApi {
     ...
     */
    public async createEntityReference (version: number, body: EntityReference, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ActivityResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/entity/reference'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(body, "EntityReference")
        };
