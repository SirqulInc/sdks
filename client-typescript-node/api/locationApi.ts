...
export class LocationApi {
     ...
     */
    public async cacheTrilaterationData (version: number, udid: string, sourceTime?: number, minimumSampleSize?: number, data?: string, dataFile?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/location/trilaterate/cache'
     ...
     * @param body 
     */
    public async cacheTrilaterationDataGzip (version: number, body?: TrilatCacheRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/location/trilaterate/cache/submit'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getLocationByIp (version: number, ip?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CoordsResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/location/ip'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getLocationByTrilateration (version: number, accountId?: number, latitude?: number, longitude?: number, data?: string, responseFilters?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GeoPointResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/account/location/trilaterate'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
