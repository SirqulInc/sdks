...
export class GameLevelApi {
     ...
     */
    public async deleteGameLevel (version: number, accountId: number, levelId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/level/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getGameLevel (version: number, accountId: number, levelId: number, includeGameData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GameLevelResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/level/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param filters 
     */
    public async getGameLevelsByApplication (version: number, accountId: number, appKey: string, keyword?: string, sortField?: string, descending?: boolean, start?: number, limit?: number, appVersion?: string, includeGameData?: boolean, filters?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GameLevelListResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/level/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getGameLevelsByBillableEntity (version: number, accountId: number, appKey?: string, keyword?: string, sortField?: 'LEVEL_ACTIVE' | 'LEVEL_NAME' | 'LEVEL_DESCRIPTION' | 'LEVEL_CREATED' | 'LEVEL_UPDATED' | 'LEVEL_LIKES' | 'LEVEL_DISLIKES' | 'LEVEL_NOTES' | 'LEVEL_PLAYS' | 'LEVEL_DOWNLOADS' | 'LEVEL_QUITS' | 'LEVEL_COMPLETES' | 'LEVEL_VERSION' | 'LEVEL_MISSION_TYPE' | 'LEVEL_OWNER_DISPLAY' | 'GAME_OWNER_DISPLAY' | 'GAME_TITLE' | 'GAME_DESCRIPTION' | 'GAME_LIKES' | 'GAME_DISLIKES' | 'APP_NAME' | 'APP_SCORING_TYPE', descending?: boolean, activeOnly?: boolean, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GameLevelResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/level/searchByBillableEntity'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getQuestionsInLevel (version: number, levelId: number, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QuestionResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/level/questions/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param accountId the id of the logged in user
     */
    public async getWordsInLevel (version: number, levelId: number, accountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WordzWordResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/level/words/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param metaData external custom client defined data
     */
    public async updateGameLevel (version: number, accountId: number, levelId: number, appKey?: string, name?: string, description?: string, difficulty?: string, appVersion?: string, assetImageId?: number, assetIconId?: number, gameData?: string, gameDataSuffix?: string, visibility?: string, friendGroup?: boolean, connectionIds?: string, connectionGroupIds?: string, balance?: number, active?: boolean, allocateTickets?: boolean, ticketCount?: number, ticketType?: string, points?: number, tutorialTitle?: string, tutorialMessage?: string, tutorialAlignment?: string, tutorialImageAssetId?: number, offerId?: number, metaData?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GameLevelResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/level/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async updateQuestionsInLevel (version: number, levelId: number, accountId: number, questionIds: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/level/questions/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async updateWordsInLevel (version: number, levelId: number, accountId: number, wordIds: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/level/words/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
