...
export class RatingApi {
     ...
     */
    public async createRating (version: number, ratableType: string, ratableId: number, ratingValue: number, deviceId?: string, accountId?: number, categoryId?: number, display?: string, description?: string, locationDescription?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RatingResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/rating/create'
     ...
     * @param accountId The unique accountId that made the request (either deviceId or accountId must be used)
     */
    public async deleteRating (version: number, ratingId: number, deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/rating/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async searchLocationRatingIndexes (version: number, categoryIds?: string, keyword?: string, locationType?: string, sortField?: 'ID' | 'CREATED' | 'UPDATED' | 'DELETED' | 'SEARCH_TAGS' | 'ACTIVE' | 'RATABLE_TYPE' | 'RATABLE_ID' | 'RATABLE_DISPLAY' | 'CATEGORY_ID' | 'CATEGORY_NAME' | 'CATEGORY_SHORT_NAME' | 'CATEGORY_DISPLAY' | 'COUNT' | 'SUMMATION' | 'AVERAGE' | 'VALUE', descending?: boolean, start?: number, limit?: number, searchRange?: number, latitude?: number, longitude?: number, returnOverallRating?: boolean, distanceUnit?: 'MILES' | 'KILOMETERS', returnRetailer?: boolean, returnAssets?: boolean, returnOffers?: boolean, returnCategories?: boolean, returnFilters?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<RatingIndexResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/location/rating/index/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param limit The number of records to return
     */
    public async searchRatings (version: number, deviceId?: string, accountId?: number, filterAccountId?: number, ratableType?: string, ratableId?: number, categoryIds?: string, keyword?: string, sortField?: 'ID' | 'CREATED' | 'UPDATED' | 'DELETED' | 'SEARCH_TAGS' | 'ACTIVE' | 'OWNER_DISPLAY' | 'RATABLE_TYPE' | 'RATABLE_ID' | 'RATABLE_DISPLAY' | 'CATEGORY_ID' | 'CATEGORY_NAME' | 'CATEGORY_SHORT_NAME' | 'CATEGORY_DISPLAY' | 'VALUE', descending?: boolean, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<RatingResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/rating/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param longitude The current location of the user
     */
    public async updateRating (version: number, ratingId: number, deviceId?: string, accountId?: number, ratingValue?: number, categoryId?: number, display?: string, description?: string, locationDescription?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RatingResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/rating/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
