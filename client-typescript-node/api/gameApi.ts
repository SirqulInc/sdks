...
export class GameApi {
     ...
     */
    public async createGame (accountId?: number, appKey?: string, title?: string, description?: string, metaData?: string, packIds?: string, includeGameData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GameResponse;  }> {
        const localVarPath = this.basePath + '/game/create';
     ...
     */
    public async deleteGame (accountId: number, gameId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/game/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getGame (accountId: number, gameId: number, includeGameData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GameResponse;  }> {
        const localVarPath = this.basePath + '/game/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async searchGames (accountId: number, appKey: string, start: number, limit: number, keyword?: string, appVersion?: string, includeGameData?: boolean, includeInactive?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GameResponse;  }> {
        const localVarPath = this.basePath + '/game/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param includeGameData show more details in response.
     */
    public async updateGame (accountId?: number, gameId?: number, appKey?: string, title?: string, description?: string, metaData?: string, packIds?: string, includeGameData?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GameResponse;  }> {
        const localVarPath = this.basePath + '/game/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
