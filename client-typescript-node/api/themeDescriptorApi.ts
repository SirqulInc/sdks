...
export class ThemeDescriptorApi {
     ...
     */
    public async getThemeDescriptor (version: number, themeDescriptorId: number, deviceId?: string, accountId?: number, gameType?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PurchaseItemListResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/consumer/theme/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param longitude longitude used to update the user\&#39;s current location
     */
    public async removeThemeDescriptor (version: number, themeDescriptorId: number, deviceId?: string, accountId?: number, gameType?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/consumer/theme/remove'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
