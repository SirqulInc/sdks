...
export class TicketApi {
     ...
     */
    public async getTicketCount (deviceId?: string, accountId?: number, gameType?: string, appKey?: string, ticketType?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CountResponse;  }> {
        const localVarPath = this.basePath + '/ticket/count';
     ...
     */
    public async getTicketList (deviceId?: string, accountId?: number, ticketObjectType?: string, actionType?: string, ticketIds?: string, objectIds?: string, receiptTokens?: string, gameType?: string, appKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TicketListResponse;  }> {
        const localVarPath = this.basePath + '/ticket/getList';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param appKey the application key
     */
    public async giftPurchase (receiverAccountId: number, ticketId: number, deviceId?: string, accountId?: number, assetId?: number, customMessage?: string, gameType?: string, appKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/purchase/gift';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async ticketOffers (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TicketOfferResponse;  }> {
        const localVarPath = this.basePath + '/ticket/ticketoffers';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
