...
export class VehicleApi {
     ...
     * @param body 
     */
    public async createVehicle (vehicle: string, body?: Vehicle, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Vehicle;  }> {
     ...
     */
    public async deleteVehicle (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     */
    public async getVehicle (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Vehicle;  }> {
        const localVarPath = this.basePath + '/vehicle/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async searchVehicle (hubId: number, sortField: string, descending: boolean, start: number, limit: number, activeOnly: boolean, keyword?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<Vehicle>;  }> {
        const localVarPath = this.basePath + '/vehicle';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param body 
     */
    public async updateVehicle (id: number, vehicle: string, body?: Vehicle, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Vehicle;  }> {
        const localVarPath = this.basePath + '/vehicle/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
