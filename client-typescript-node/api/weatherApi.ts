...
export class WeatherApi {
     ...
     */
    public async searchWeather (version: number, regionId?: number, latitude?: number, longitude?: number, timezoneOffset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WeatherResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/weather/search'
