...
export class PreviewPersonaApi {
     ...
     */
    public async createPersona (version: number, accountId: number, title: string, previewAccounts?: string, date?: number, age?: number, gender?: string, gameExperienceLevel?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PreviewPersonaResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/persona/create'
     ...
     */
    public async deletePersona (version: number, accountId: number, personaId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/persona/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getPersonaList (version: number, accountId: number, personaId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PreviewPersonaResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/persona/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async searchPersona (version: number, accountId: number, start: number, limit: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PreviewPersonaResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/persona/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param longitude the specified longitude of the persona
     */
    public async updatePersona (version: number, accountId: number, personaId: number, title?: string, previewAccounts?: string, active?: boolean, date?: number, age?: number, gender?: string, gameExperienceLevel?: string, latitude?: number, longitude?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PreviewPersonaResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/persona/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
