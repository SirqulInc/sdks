...
export class PurchaseOrderApi {
     ...
     */
    public async createOrder (appKey: string, cart: string, deviceId?: string, accountId?: number, description?: string, currencyType?: 'VOID' | 'CASH' | 'POINTS' | 'TICKETS' | 'REFUND' | 'CREDIT' | 'RELOAD', paymentMethodId?: number, externalOrderId?: string, externalPaymentId?: string, remoteRefType?: string, externalDate?: number, promoCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrderResponse;  }> {
        const localVarPath = this.basePath + '/order/create';
     ...
     * @param accountId The account id of the user (deviceId or accountId required)
     */
    public async deleteOrder (orderId: number, deviceId?: string, accountId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/order/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getOrder (deviceId?: string, accountId?: number, orderId?: number, externalOrderId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrderResponse;  }> {
        const localVarPath = this.basePath + '/order/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param promoCode The Promo Code
     */
    public async previewOrder (appKey: string, cart: string, deviceId?: string, accountId?: number, description?: string, currencyType?: 'VOID' | 'CASH' | 'POINTS' | 'TICKETS' | 'REFUND' | 'CREDIT' | 'RELOAD', paymentMethodId?: number, externalOrderId?: string, externalPaymentId?: string, remoteRefType?: string, externalDate?: number, promoCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrderResponse;  }> {
        const localVarPath = this.basePath + '/order/preview';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param externalDate External Date
     */
    public async updateOrder (orderId: number, appKey: string, cart: string, deviceId?: string, accountId?: number, paymentTransactionId?: number, description?: string, currencyType?: 'VOID' | 'CASH' | 'POINTS' | 'TICKETS' | 'REFUND' | 'CREDIT' | 'RELOAD', paymentMethodId?: number, externalPaymentId?: string, externalDate?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OrderResponse;  }> {
        const localVarPath = this.basePath + '/order/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
