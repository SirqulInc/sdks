...
export class ApplicationConfigApi {
     ...
     */
    public async createApplicationConfig (version: number, accountId: number, appKey: string, configVersion: string, assetId: number, retailerId?: number, retailerLocationId?: number, udid?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ApplicationConfigResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/appconfig/create'
     ...
     */
    public async deleteApplicationConfig (version: number, accountId: number, configId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/appconfig/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getApplicationConfig (version: number, accountId: number, configId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ApplicationConfigResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/appconfig/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async getApplicationConfigByConfigVersion (version: number, appKey: string, configVersion: string, retailerId?: number, retailerLocationId?: number, udid?: string, allowOlderVersions?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ApplicationConfigResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/appconfig/getbyversion'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param udid The device udid for device specific configurations
     */
    public async updateApplicationConfig (version: number, accountId: number, configId: number, appKey?: string, configVersion?: string, assetId?: number, retailerId?: number, retailerLocationId?: number, udid?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ApplicationConfigResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/appconfig/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
