...
export class ScoreApi {
     ...
     * @param highest 
     */
    public async createScore (accountId: number, appKey: string, points: number, missionId?: number, gameId?: number, packId?: number, gameLevelId?: number, gameObjectId?: number, timeTaken?: number, highest?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ScoreResponse;  }> {
        const localVarPath = this.basePath + '/score/create';
     ...
     */
    public async getScore (accountId: number, appKey: string, missionId?: number, gameId?: number, packId?: number, gameLevelId?: number, gameObjectId?: number, scoreObjectType?: string, scoreStatus?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ScoreResponse;  }> {
        const localVarPath = this.basePath + '/score/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param gameObjectId The gameObjectId to score for, null if level based scoring.
     */
    public async searchScores (accountId: number, appKey: string, missionId?: number, gameId?: number, packId?: number, gameLevelId?: number, gameObjectId?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<ScoreResponse>;  }> {
        const localVarPath = this.basePath + '/score/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
