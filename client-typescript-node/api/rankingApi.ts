...
export class RankingApi {
     ...
     */
    public async getHistoricalRankings (appKey: string, rankType: string, startDate: number, endDate: number, deviceId?: string, accountId?: number, sortField?: string, descending?: boolean, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RankFullResponse;  }> {
        const localVarPath = this.basePath + '/ranking/historical/search';
     ...
     * @param limit the limit for pagination
     */
    public async getRankings (deviceId?: string, accountId?: number, gameType?: string, appKey?: string, q?: string, keyword?: string, rankType?: string, leaderboardMode?: string, withinAccountIds?: string, returnUserRank?: boolean, albumId?: number, audienceId?: number, sortField?: string, descending?: boolean, i?: number, start?: number, l?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RankFullResponse;  }> {
        const localVarPath = this.basePath + '/ranking/search';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param limit the limit for pagination
     */
    public async getUserRank (deviceId?: string, accountId?: number, appKey?: string, rankType?: string, returnUserRank?: boolean, leaderboardMode?: string, sortField?: string, keyword?: string, descending?: boolean, start?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/ranking/personal/ranks';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
    ...
    public async overrideUserRank (accountId: number, ownerAccountId: number, appKey: string, rankType: string, totalScore?: number, totalCount?: number, totalTime?: number, dailyScore?: number, dailyCount?: number, dailyTime?: number, weeklyScore?: number, weeklyCount?: number, weeklyTime?: number, monthlyScore?: number, monthlyCount?: number, monthlyTime?: number, topScore?: number, lowestScore?: number, streakCount?: number, streakBestCount?: number, startDate?: number, endDate?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/ranking/override';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async updateRankings (accountId: number, appKey: string, rankType: string, increment?: number, timeIncrement?: number, tag?: string, startDate?: number, endDate?: number, updateGlobal?: boolean, createLeaderboard?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/ranking/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
