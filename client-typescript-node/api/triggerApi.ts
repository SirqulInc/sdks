...
export class TriggerApi {
     ...
     */
    public async createTrigger (version: number, accountId: number, name: string, appKey?: string, groupingId?: string, endpointURL?: string, payload?: string, scheduledDate?: number, startDate?: number, endDate?: number, cronExpression?: string, conditionalInput?: string, visibility?: 'PUBLIC' | 'PRIVATE' | 'FRIENDS', active?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TriggerResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/trigger/create'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TriggerResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "TriggerResponse");
     ...
     */
    public async deleteTrigger (version: number, accountId: number, triggerId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/trigger/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        ...
        if (triggerId !== undefined) {
            localVarQueryParameters['triggerId'] = ObjectSerializer.serialize(triggerId, "number");
        }
     ...
     */
    public async getTrigger (version: number, accountId: number, triggerId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TriggerResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/trigger/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async searchTriggers (version: number, accountId: number, groupingId?: string, filter?: string, statuses?: string, templateTypes?: string, appKey?: string, keyword?: string, sortField?: string, descending?: boolean, start?: number, limit?: number, activeOnly?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<TriggerResponse>;  }> {
        const localVarPath = this.basePath + '/api/{version}/trigger/search'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<TriggerResponse>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<TriggerResponse>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param active Sets whether the Trigger is active or not (inactive Triggers are not processed)
     */
    public async updateTrigger (version: number, triggerId: number, accountId: number, name?: string, appKey?: string, groupingId?: string, endpointURL?: string, payload?: string, scheduledDate?: number, startDate?: number, endDate?: number, cronExpression?: string, conditionalInput?: string, visibility?: 'PUBLIC' | 'PRIVATE' | 'FRIENDS', active?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TriggerResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/trigger/update'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
