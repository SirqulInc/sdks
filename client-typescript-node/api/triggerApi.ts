...
export class TriggerApi {
     ...
     */
    public async createTrigger (accountId: number, name: string, appKey?: string, groupingId?: string, endpointURL?: string, payload?: string, scheduledDate?: number, startDate?: number, endDate?: number, cronExpression?: string, conditionalInput?: string, visibility?: 'PUBLIC' | 'PRIVATE' | 'FRIENDS', active?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TriggerResponse;  }> {
        const localVarPath = this.basePath + '/trigger/create';
     ...
     */
    public async deleteTrigger (accountId: number, triggerId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/trigger/delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     */
    public async getTrigger (accountId: number, triggerId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TriggerResponse;  }> {
        const localVarPath = this.basePath + '/trigger/get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
     ...
     * @param active Sets whether the Trigger is active or not (inactive Triggers are not processed)
     */
    public async updateTrigger (triggerId: number, accountId: number, name?: string, appKey?: string, groupingId?: string, endpointURL?: string, payload?: string, scheduledDate?: number, startDate?: number, endDate?: number, cronExpression?: string, conditionalInput?: string, visibility?: 'PUBLIC' | 'PRIVATE' | 'FRIENDS', active?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TriggerResponse;  }> {
        const localVarPath = this.basePath + '/trigger/update';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        // give precedence to 'application/json'
