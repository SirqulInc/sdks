...
export class EmployeeApi {
     ...
     */
    public async assignEmployee (version: number, accountId: number, managerAccountId: number, employeeAccountId: number, role?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: EmployeeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/employee/assign'
     ...
     */
    public async assignToLocationEmployee (version: number, accountId: number, retailerLocationId: number, employeeAccountId?: number, assign?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/employee/assignToLocation'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async deleteEmployee (version: number, accountId: number, employeeAccountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SirqulResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/employee/delete'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     * @param settingsAppKey Determines whether to return the application settings for the employee for a particular application
     */
    public async getEmployee (version: number, accountId: number, employeeAccountId: number, settingsAppKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: EmployeeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/employee/get'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
     ...
     */
    public async unassignEmployee (version: number, accountId: number, employeeAccountId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: EmployeeResponse;  }> {
        const localVarPath = this.basePath + '/api/{version}/employee/unassign'
            .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
