...
#
package WWW::OpenAPIClient::CarrierApi;
...
# @param boolean $active_only Determines whether to return inactive results (optional, default to true)
{
    ...
    __PACKAGE__->method_documentation->{ 'search_carriers' } = {
        summary => 'Search Carriers',
        params => $params,
        returns => 'ARRAY[CellCarrierResponse]',
        };
}
...
sub search_carriers {
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[CellCarrierResponse]', $response);
