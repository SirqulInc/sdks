...
/**
 * SubscriptionOption Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const OPTION_TYPE_MISSION = 'MISSION';
    public const OPTION_TYPE_LOCATION = 'LOCATION';
    public const OPTION_TYPE_OFFER = 'OFFER';
    public const OPTION_TYPE_NOTIFICATION = 'NOTIFICATION';
    public const OPTION_TYPE_REQUEST = 'REQUEST';
    public const OPTION_TYPE_STORAGE_S3 = 'STORAGE_S3';
    public const OPTION_TYPE_STORAGE_DB = 'STORAGE_DB';
    public const OFFER_TYPE_VOUCHER = 'VOUCHER';
    public const OFFER_TYPE_COUPON = 'COUPON';
    public const OFFER_TYPE_PRODUCT = 'PRODUCT';
    public const OFFER_TYPE_MEDIA = 'MEDIA';
    public const OFFER_TYPE_EVENT = 'EVENT';
    public const OFFER_TYPE_DEVICE = 'DEVICE';
    ...
    {
        return [
            self::OPTION_TYPE_MISSION,
            self::OPTION_TYPE_LOCATION,
            self::OPTION_TYPE_OFFER,
            self::OPTION_TYPE_NOTIFICATION,
            self::OPTION_TYPE_REQUEST,
            self::OPTION_TYPE_STORAGE_S3,
            self::OPTION_TYPE_STORAGE_DB,
        ];
    }
    ...
    {
        return [
            self::OFFER_TYPE_VOUCHER,
            self::OFFER_TYPE_COUPON,
            self::OFFER_TYPE_PRODUCT,
            self::OFFER_TYPE_MEDIA,
            self::OFFER_TYPE_EVENT,
            self::OFFER_TYPE_DEVICE,
        ];
    }
