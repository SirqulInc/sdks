...
class SubscriptionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'subscription_plan' => '\OpenAPI\Client\Model\SubscriptionPlanResponse',
        'promo_code' => 'string',
        'active' => 'bool'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\SubscriptionPlanResponse|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SubscriptionPlanResponse|null $subscription_plan subscription_plan
     *
     * @return self
     */
