...
class MessageResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('update_value', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['update_value'];
    }

    /**
     * Sets update_value
     *
     * @param string|null $update_value update_value
     *
     * @return self
     */
    public function setUpdateValue($update_value)
    {
        if (is_null($update_value)) {
            throw new \InvalidArgumentException('non-nullable update_value cannot be null');
        }
        $this->container['update_value'] = $update_value;
