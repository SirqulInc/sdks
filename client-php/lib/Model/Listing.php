...
class Listing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets participants
     *
     * @param \OpenAPI\Client\Model\Participant[]|null $participants participants
     *
     * @return self
     */
     ...
     *
     * @param string|null $external_group_id external_group_id
     *
     * @return self
     */
    public function setExternalGroupId($external_group_id)
    {
        if (is_null($external_group_id)) {
            throw new \InvalidArgumentException('non-nullable external_group_id cannot be null');
        }
