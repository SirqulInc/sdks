...
class RoutingApi
{
    ...
    /**
     * Operation computeRoutingWithHttpInfo
     *
     * Compute Route
     *
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\RoutingListResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation computeRoutingAsyncWithHttpInfo
     *
     * Compute Route
     *
     * @param  float $version (required)
    ...
    public function computeRoutingRequest($version, $data, string $contentType = self::contentTypes['computeRouting'][0])
    {
        ...
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling computeRouting'
            );
        }
