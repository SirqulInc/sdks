...
class SimulationApi
{
    ...
    /**
     * Operation simulationWithHttpInfo
     *
     * Routing Simulation
     *
    ...
    /**
     * Operation simulationAsyncWithHttpInfo
     *
     * Routing Simulation
     *
     * @param  float $version (required)
    ...
    public function simulationRequest($version, $data, $real_time, string $contentType = self::contentTypes['simulation'][0])
    {
        ...
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling simulation'
            );
        }

        // verify the required parameter 'real_time' is set
        if ($real_time === null || (is_array($real_time) && count($real_time) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $real_time when calling simulation'
            );
        }
