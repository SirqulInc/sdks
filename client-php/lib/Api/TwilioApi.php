...
class TwilioApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['smsBuyOffer'] to see the possible values for this operation
     *
    ...
    /**
     * Operation smsBuyOfferWithHttpInfo
     *
     * Buy Offer by SMS
     *
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\TwiMLResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation smsBuyOfferAsyncWithHttpInfo
     *
     * Buy Offer by SMS
     *
     * @param  float $version (required)
    ...
    public function smsBuyOfferRequest($version, $app_key, $body, $from, $currency_type, string $contentType = self::contentTypes['smsBuyOffer'][0])
    {
        ...
        if ($app_key === null || (is_array($app_key) && count($app_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_key when calling smsBuyOffer'
            );
        }
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling smsBuyOffer'
            );
        }
        ...
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling smsBuyOffer'
            );
        }
        ...
        if ($currency_type === null || (is_array($currency_type) && count($currency_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $currency_type when calling smsBuyOffer'
            );
        }
