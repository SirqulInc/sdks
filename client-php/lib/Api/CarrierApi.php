...
class CarrierApi
{
     ...
     * @param  bool|null $active_only Determines whether to return inactive results (optional, default to true)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchCarriers'] to see the possible values for this operation
     *
    ...
    /**
     * Operation searchCarriersWithHttpInfo
     *
     * Search Carriers
     *
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CellCarrierResponse[]',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation searchCarriersAsyncWithHttpInfo
     *
     * Search Carriers
     *
     * @param  float $version (required)
