...
class WeatherApi
{
     ...
     * @param  int|null $timezone_offset Timezone Offset (optional, default to -6)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchWeather'] to see the possible values for this operation
     *
    ...
    /**
     * Operation searchWeatherWithHttpInfo
     *
     * Search Weather
     *
     * @param  int|null $region_id Region Id (optional)
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\WeatherResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation searchWeatherAsyncWithHttpInfo
     *
     * Search Weather
     *
     * @param  int|null $region_id Region Id (optional)
    ...
    public function searchWeatherRequest($region_id = null, $latitude = null, $longitude = null, $timezone_offset = -6, string $contentType = self::contentTypes['searchWeather'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $timezone_offset,
            'timezoneOffset', // param base name
            'integer', // openApiType
            'form', // style
            true, // explode
            false // required
