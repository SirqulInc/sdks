...
class StripeApi
{
    ...
    /**
     * Operation createStripeCheckoutSessionWithHttpInfo
     *
     * Create Stripe Checkout Session
     *
    ...
    /**
     * Operation createStripeCheckoutSessionAsync
     *
     * Create Stripe Checkout Session
     *
     * @param  float $version (required)
    ...
    /**
     * Operation createStripeCheckoutSessionAsyncWithHttpInfo
     *
     * Create Stripe Checkout Session
     *
     * @param  float $version (required)
    ...
    public function createStripeCheckoutSessionRequest($version, $app_key, $stripe_parameters, string $contentType = self::contentTypes['createStripeCheckoutSession'][0])
    {
        ...
        if ($app_key === null || (is_array($app_key) && count($app_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_key when calling createStripeCheckoutSession'
            );
        }

        // verify the required parameter 'stripe_parameters' is set
        if ($stripe_parameters === null || (is_array($stripe_parameters) && count($stripe_parameters) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $stripe_parameters when calling createStripeCheckoutSession'
            );
        }
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $stripe_parameters,
            'stripeParameters', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            true // required
