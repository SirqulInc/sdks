...
class ActivityApi
{
    ...
    /**
     * Operation createEntityReferenceWithHttpInfo
     *
     * Create an entity reference.
     *
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\ActivityResponse',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation createEntityReferenceAsync
     *
     * Create an entity reference.
     *
     * @param  float $version (required)
    ...
    /**
     * Operation createEntityReferenceAsyncWithHttpInfo
     *
     * Create an entity reference.
     *
     * @param  float $version (required)
    ...
    public function createEntityReferenceRequest($version, $body, string $contentType = self::contentTypes['createEntityReference'][0])
    {
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createEntityReference'
            );
        }
