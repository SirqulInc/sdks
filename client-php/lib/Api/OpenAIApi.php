            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\WrappedProxyItemResponse',
                        $request,
                        $response,
                    );
            }
    ...
    public function imageGenerationRequest($account_id, $post_body, $return_raw_response = null, string $contentType = self::contentTypes['imageGeneration'][0])
    {
        ...
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling imageGeneration'
            );
        }

        // verify the required parameter 'post_body' is set
        if ($post_body === null || (is_array($post_body) && count($post_body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $post_body when calling imageGeneration'
            );
        }
