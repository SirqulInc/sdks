...
class WorkflowApi
{
     ...
     * @param  int|null $version_code this runs a particular sku version on the workflow (optional)
     * @param  string|null $parameters Override parameters in JSON format. Example: &#x60;&#x60;&#x60;json {   \&quot;arguments_81\&quot;: { \&quot;filter\&quot;: \&quot;PUBLIC\&quot; },   \&quot;arguments_87\&quot;: { \&quot;tag\&quot;: \&quot;custom_tag\&quot; } } &#x60;&#x60;&#x60; (optional)
    ...
    public function runWorkflowRequest($account_id, $workflow_id, $sku_id = null, $version_code = null, $parameters = null, string $contentType = self::contentTypes['runWorkflow'][0])
    {
        ...
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling runWorkflow'
            );
        }
