...
object TournamentResponse {
  ...
  implicit val TournamentResponseCodecJson: CodecJson[TournamentResponse] = CodecJson.derive[TournamentResponse]
  implicit val TournamentResponseDecoder: EntityDecoder[TournamentResponse] = jsonOf[TournamentResponse]
  implicit val TournamentResponseEncoder: EntityEncoder[TournamentResponse] = jsonEncoderOf[TournamentResponse]
}
