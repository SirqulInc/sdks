...
object AlbumResponse {
  ...
  implicit val AlbumResponseCodecJson: CodecJson[AlbumResponse] = CodecJson.derive[AlbumResponse]
  implicit val AlbumResponseDecoder: EntityDecoder[AlbumResponse] = jsonOf[AlbumResponse]
  implicit val AlbumResponseEncoder: EntityEncoder[AlbumResponse] = jsonEncoderOf[AlbumResponse]
}
