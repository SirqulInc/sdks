...
import AssignmentStatusResponse._
...
object AssignmentStatusResponse {
  ...
  implicit val AssignmentStatusResponseCodecJson: CodecJson[AssignmentStatusResponse] = CodecJson.derive[AssignmentStatusResponse]
  implicit val AssignmentStatusResponseDecoder: EntityDecoder[AssignmentStatusResponse] = jsonOf[AssignmentStatusResponse]
  implicit val AssignmentStatusResponseEncoder: EntityEncoder[AssignmentStatusResponse] = jsonEncoderOf[AssignmentStatusResponse]
}
