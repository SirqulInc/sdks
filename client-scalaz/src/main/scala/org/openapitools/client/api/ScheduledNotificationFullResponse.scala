...
import ScheduledNotificationFullResponse._
...
object ScheduledNotificationFullResponse {
  ...
  implicit val ScheduledNotificationFullResponseCodecJson: CodecJson[ScheduledNotificationFullResponse] = CodecJson.derive[ScheduledNotificationFullResponse]
  implicit val ScheduledNotificationFullResponseDecoder: EntityDecoder[ScheduledNotificationFullResponse] = jsonOf[ScheduledNotificationFullResponse]
  implicit val ScheduledNotificationFullResponseEncoder: EntityEncoder[ScheduledNotificationFullResponse] = jsonEncoderOf[ScheduledNotificationFullResponse]
}
