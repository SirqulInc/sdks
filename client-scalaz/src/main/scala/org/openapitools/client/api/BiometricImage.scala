...
object BiometricImage {
  ...
  implicit val BiometricImageCodecJson: CodecJson[BiometricImage] = CodecJson.derive[BiometricImage]
  implicit val BiometricImageDecoder: EntityDecoder[BiometricImage] = jsonOf[BiometricImage]
  implicit val BiometricImageEncoder: EntityEncoder[BiometricImage] = jsonEncoderOf[BiometricImage]
}
