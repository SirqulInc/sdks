...
object TaskResponse {
  ...
  implicit val TaskResponseCodecJson: CodecJson[TaskResponse] = CodecJson.derive[TaskResponse]
  implicit val TaskResponseDecoder: EntityDecoder[TaskResponse] = jsonOf[TaskResponse]
  implicit val TaskResponseEncoder: EntityEncoder[TaskResponse] = jsonEncoderOf[TaskResponse]
}
