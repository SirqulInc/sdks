...
object MediaOfferResponse {
  ...
  implicit val MediaOfferResponseCodecJson: CodecJson[MediaOfferResponse] = CodecJson.derive[MediaOfferResponse]
  implicit val MediaOfferResponseDecoder: EntityDecoder[MediaOfferResponse] = jsonOf[MediaOfferResponse]
  implicit val MediaOfferResponseEncoder: EntityEncoder[MediaOfferResponse] = jsonEncoderOf[MediaOfferResponse]
}
