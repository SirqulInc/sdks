...
import ConnectionGroupShortResponse._
...
object ConnectionGroupShortResponse {
  ...
  implicit val ConnectionGroupShortResponseCodecJson: CodecJson[ConnectionGroupShortResponse] = CodecJson.derive[ConnectionGroupShortResponse]
  implicit val ConnectionGroupShortResponseDecoder: EntityDecoder[ConnectionGroupShortResponse] = jsonOf[ConnectionGroupShortResponse]
  implicit val ConnectionGroupShortResponseEncoder: EntityEncoder[ConnectionGroupShortResponse] = jsonEncoderOf[ConnectionGroupShortResponse]
}
