...
object OfferResponse {
  ...
  implicit val OfferResponseCodecJson: CodecJson[OfferResponse] = CodecJson.derive[OfferResponse]
  implicit val OfferResponseDecoder: EntityDecoder[OfferResponse] = jsonOf[OfferResponse]
  implicit val OfferResponseEncoder: EntityEncoder[OfferResponse] = jsonEncoderOf[OfferResponse]
}
