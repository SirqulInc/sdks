...
object StripeApi {
  ...
  def createStripeCheckoutSession(host: String, appKey: String, stripeParameters: String)(implicit appKeyQuery: QueryParam[String], stripeParametersQuery: QueryParam[String]): Task[SirqulResponse] = {
    ...
    val queryParams = Query(
      ("appKey", Some(appKeyQuery.toParamString(appKey))), ("stripeParameters", Some(stripeParametersQuery.toParamString(stripeParameters))))
...
class HttpServiceStripeApi(service: HttpService) {
