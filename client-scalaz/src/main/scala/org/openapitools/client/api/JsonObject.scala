...
object JsonObject {
  ...
  implicit val JsonObjectCodecJson: CodecJson[JsonObject] = CodecJson.derive[JsonObject]
  implicit val JsonObjectDecoder: EntityDecoder[JsonObject] = jsonOf[JsonObject]
  implicit val JsonObjectEncoder: EntityEncoder[JsonObject] = jsonEncoderOf[JsonObject]
}
