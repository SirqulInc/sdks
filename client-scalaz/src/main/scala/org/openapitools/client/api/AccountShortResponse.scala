...
object AccountShortResponse {
  ...
  implicit val AccountShortResponseCodecJson: CodecJson[AccountShortResponse] = CodecJson.derive[AccountShortResponse]
  implicit val AccountShortResponseDecoder: EntityDecoder[AccountShortResponse] = jsonOf[AccountShortResponse]
  implicit val AccountShortResponseEncoder: EntityEncoder[AccountShortResponse] = jsonEncoderOf[AccountShortResponse]
}
