...
object ProfileInfoResponse {
  ...
  implicit val ProfileInfoResponseCodecJson: CodecJson[ProfileInfoResponse] = CodecJson.derive[ProfileInfoResponse]
  implicit val ProfileInfoResponseDecoder: EntityDecoder[ProfileInfoResponse] = jsonOf[ProfileInfoResponse]
  implicit val ProfileInfoResponseEncoder: EntityEncoder[ProfileInfoResponse] = jsonEncoderOf[ProfileInfoResponse]
}
