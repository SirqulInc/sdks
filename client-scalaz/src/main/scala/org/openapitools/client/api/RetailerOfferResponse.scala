...
import RetailerOfferResponse._
...
object RetailerOfferResponse {
  ...
  implicit val RetailerOfferResponseCodecJson: CodecJson[RetailerOfferResponse] = CodecJson.derive[RetailerOfferResponse]
  implicit val RetailerOfferResponseDecoder: EntityDecoder[RetailerOfferResponse] = jsonOf[RetailerOfferResponse]
  implicit val RetailerOfferResponseEncoder: EntityEncoder[RetailerOfferResponse] = jsonEncoderOf[RetailerOfferResponse]
}
