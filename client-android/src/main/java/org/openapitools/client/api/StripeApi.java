  ...
  public SirqulResponse createStripeCheckoutSession (BigDecimal version, String appKey, String stripeParameters) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (appKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'appKey' when calling createStripeCheckoutSession",
        new ApiException(400, "Missing the required parameter 'appKey' when calling createStripeCheckoutSession"));
    }
    // verify the required parameter 'stripeParameters' is set
    if (stripeParameters == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'stripeParameters' when calling createStripeCheckoutSession",
        new ApiException(400, "Missing the required parameter 'stripeParameters' when calling createStripeCheckoutSession"));
    }
    ...
    queryParams.addAll(ApiInvoker.parameterToPairs("", "stripeParameters", stripeParameters));
    String[] contentTypes = {
    };
