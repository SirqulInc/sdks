...
public class SimulationApi {
  ...
  */
  public SirqulResponse simulation (String data, Boolean realTime) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    String path = "/simulation/routing";
  ...
  */
  public void simulation (String data, Boolean realTime, final Response.Listener<SirqulResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/simulation/routing".replaceAll("\\{format\\}","json");
