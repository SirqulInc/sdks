(ns sirqul-io-t-platform.api.wallet
...
(defn-spec update-offer-transaction-with-http-info any?
  "Update Wallet Offer
...
(defn-spec update-offer-transaction offer-transaction-response-spec
  "Update Wallet Offer
  Update offer status. The status values are: 0 - not redeemable, 1 - redeemable.
