(ns sirqul-io-t-platform.specs.offer-short-response
...
(def offer-short-response-spec
  (ds/spec
    {:name ::offer-short-response
     :spec offer-short-response-data}))
