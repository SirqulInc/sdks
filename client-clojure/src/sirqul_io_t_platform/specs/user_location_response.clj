(ns sirqul-io-t-platform.specs.user-location-response
...
(def user-location-response-data
  {
   ...
   (ds/opt :distanceFromMe) string?
   (ds/opt :returning) string?
   })

(def user-location-response-spec
  (ds/spec
    {:name ::user-location-response
     :spec user-location-response-data}))
