(ns sirqul-io-t-platform.specs.offer-transaction-response
...
(def offer-transaction-response-data
  {
   ...
   (ds/opt :purchasedDate) int?
   (ds/opt :usedDate) int?
   (ds/opt :transactionCreated) int?
   (ds/opt :transactionUpdated) int?
   (ds/opt :returning) string?
   })

(def offer-transaction-response-spec
  (ds/spec
    {:name ::offer-transaction-response
     :spec offer-transaction-response-data}))
