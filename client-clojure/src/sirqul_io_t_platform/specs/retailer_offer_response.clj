(ns sirqul-io-t-platform.specs.retailer-offer-response
...
(def retailer-offer-response-data
  {
   ...
   (ds/opt :locations) (s/coll-of (s/map-of string? any?))
   (ds/opt :returning) string?
   })

(def retailer-offer-response-spec
  (ds/spec
    {:name ::retailer-offer-response
     :spec retailer-offer-response-data}))
