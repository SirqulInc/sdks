(ns sirqul-io-t-platform.specs.leaderboard-full-response
...
(def leaderboard-full-response-data
  {
   ...
   (ds/opt :leaderboardRankings) rank-list-response-spec
   })

(def leaderboard-full-response-spec
  (ds/spec
    {:name ::leaderboard-full-response
     :spec leaderboard-full-response-data}))
