...
LocationApiV2API_createLocationV2(apiClient_t *apiClient, double version, location_t *body)
{
    ...
    if (body != NULL)
    {
        ...
        localVarSingleItemJSON_body = location_convertToJSON(body);
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LocationApiV2APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = sirqul_response_parseFromJSON(LocationApiV2APIlocalVarJSON);
        cJSON_Delete(LocationApiV2APIlocalVarJSON);
