...
// Functions for enum VISIBILITY for TriggerAPI_createTrigger

static char* createTrigger_VISIBILITY_ToString(sirqul_iot_platform_createTrigger_visibility_e VISIBILITY){
    char *VISIBILITYArray[] =  { "NULL", "PUBLIC", "PRIVATE", "FRIENDS" };
    return VISIBILITYArray[VISIBILITY];
}

static sirqul_iot_platform_createTrigger_visibility_e createTrigger_VISIBILITY_FromString(char* VISIBILITY){
...
/*
// Function createTrigger_VISIBILITY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *createTrigger_VISIBILITY_convertToJSON(sirqul_iot_platform_createTrigger_visibility_e VISIBILITY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "visibility", createTrigger_VISIBILITY_ToString(VISIBILITY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function createTrigger_VISIBILITY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static sirqul_iot_platform_createTrigger_visibility_e createTrigger_VISIBILITY_parseFromJSON(cJSON* VISIBILITYJSON) {
    sirqul_iot_platform_createTrigger_visibility_e VISIBILITYVariable = 0;
    ...
    VISIBILITYVariable = createTrigger_VISIBILITY_FromString(VISIBILITYVar->valuestring);
...
// Functions for enum VISIBILITY for TriggerAPI_updateTrigger

static char* updateTrigger_VISIBILITY_ToString(sirqul_iot_platform_updateTrigger_visibility_e VISIBILITY){
    char *VISIBILITYArray[] =  { "NULL", "PUBLIC", "PRIVATE", "FRIENDS" };
    return VISIBILITYArray[VISIBILITY];
}

static sirqul_iot_platform_updateTrigger_visibility_e updateTrigger_VISIBILITY_FromString(char* VISIBILITY){
    int stringToReturn = 0;
    char *VISIBILITYArray[] =  { "NULL", "PUBLIC", "PRIVATE", "FRIENDS" };
    size_t sizeofArray = sizeof(VISIBILITYArray) / sizeof(VISIBILITYArray[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function updateTrigger_VISIBILITY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *updateTrigger_VISIBILITY_convertToJSON(sirqul_iot_platform_updateTrigger_visibility_e VISIBILITY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "visibility", updateTrigger_VISIBILITY_ToString(VISIBILITY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function updateTrigger_VISIBILITY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static sirqul_iot_platform_updateTrigger_visibility_e updateTrigger_VISIBILITY_parseFromJSON(cJSON* VISIBILITYJSON) {
    sirqul_iot_platform_updateTrigger_visibility_e VISIBILITYVariable = 0;
    cJSON *VISIBILITYVar = cJSON_GetObjectItemCaseSensitive(VISIBILITYJSON, "visibility");
    if(!cJSON_IsString(VISIBILITYVar) || (VISIBILITYVar->valuestring == NULL))
    {
        goto end;
    }
    VISIBILITYVariable = updateTrigger_VISIBILITY_FromString(VISIBILITYVar->valuestring);
    return VISIBILITYVariable;
end:
    return 0;
}
...
TriggerAPI_createTrigger(apiClient_t *apiClient, long accountId, char *name, char *appKey, char *groupingId, char *endpointURL, char *payload, long scheduledDate, long startDate, long endDate, char *cronExpression, char *conditionalInput, sirqul_iot_platform_createTrigger_visibility_e visibility, int *active)
{
    ...
    sirqul_iot_platform_createTrigger_visibility_e valueQuery_visibility ;
    keyValuePair_t *keyPairQuery_visibility = 0;
    if (visibility)
    {
        keyQuery_visibility = strdup("visibility");
        valueQuery_visibility = (visibility);
        keyPairQuery_visibility = keyValuePair_create(keyQuery_visibility, strdup(createTrigger_VISIBILITY_ToString(
    ...
    trigger_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *TriggerAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = trigger_response_parseFromJSON(TriggerAPIlocalVarJSON);
        cJSON_Delete(TriggerAPIlocalVarJSON);
...
TriggerAPI_deleteTrigger(apiClient_t *apiClient, long accountId, long triggerId)
{
    ...
    // query parameters
    char *keyQuery_triggerId = NULL;
    char * valueQuery_triggerId ;
    keyValuePair_t *keyPairQuery_triggerId = 0;
    {
        keyQuery_triggerId = strdup("triggerId");
        valueQuery_triggerId = calloc(1,MAX_NUMBER_LENGTH_LONG);
        snprintf(valueQuery_triggerId, MAX_NUMBER_LENGTH_LONG, "%d", triggerId);
        keyPairQuery_triggerId = keyValuePair_create(keyQuery_triggerId, valueQuery_triggerId);
        list_addElement(localVarQueryParameters,keyPairQuery_triggerId);
    }
    list_addElement(localVarHeaderType,"*/*"); //produces
    apiClient_invoke(apiClient,
                    localVarPath,
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *TriggerAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = sirqul_response_parseFromJSON(TriggerAPIlocalVarJSON);
        cJSON_Delete(TriggerAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    if(keyPairQuery_triggerId){
        keyValuePair_free(keyPairQuery_triggerId);
        keyPairQuery_triggerId = NULL;
    }
    return elementToReturn;
end:
    free(localVarPath);
...
TriggerAPI_searchTriggers(apiClient_t *apiClient, long accountId, char *groupingId, char *filter, char *statuses, char *templateTypes, char *appKey, char *keyword, char *sortField, int *descending, int *start, int *limit, int *activeOnly)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *TriggerAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(TriggerAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, TriggerAPIlocalVarJSON)
        {
...
TriggerAPI_updateTrigger(apiClient_t *apiClient, long triggerId, long accountId, char *name, char *appKey, char *groupingId, char *endpointURL, char *payload, long scheduledDate, long startDate, long endDate, char *cronExpression, char *conditionalInput, sirqul_iot_platform_updateTrigger_visibility_e visibility, int *active)
{
    ...
    // query parameters
    char *keyQuery_visibility = NULL;
    sirqul_iot_platform_updateTrigger_visibility_e valueQuery_visibility ;
    keyValuePair_t *keyPairQuery_visibility = 0;
    if (visibility)
    {
        keyQuery_visibility = strdup("visibility");
        valueQuery_visibility = (visibility);
        keyPairQuery_visibility = keyValuePair_create(keyQuery_visibility, strdup(updateTrigger_VISIBILITY_ToString(
        valueQuery_visibility)));
        list_addElement(localVarQueryParameters,keyPairQuery_visibility);
    }
