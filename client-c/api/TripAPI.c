...
TripAPI_createTrip(apiClient_t *apiClient, double version, trip_t *body)
{
    ...
    if (body != NULL)
    {
        ...
        localVarSingleItemJSON_body = trip_convertToJSON(body);
    ...
    trip_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *TripAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = trip_parseFromJSON(TripAPIlocalVarJSON);
        cJSON_Delete(TripAPIlocalVarJSON);
...
TripAPI_driveTrip(apiClient_t *apiClient, double version, long id, int *recurrence)
{
    ...
    // query parameters
    char *keyQuery_recurrence = NULL;
    char * valueQuery_recurrence = NULL;
    keyValuePair_t *keyPairQuery_recurrence = 0;
    if (recurrence)
    {
        keyQuery_recurrence = strdup("recurrence");
        valueQuery_recurrence = calloc(1,MAX_NUMBER_LENGTH);
        snprintf(valueQuery_recurrence, MAX_NUMBER_LENGTH, "%d", *recurrence);
        keyPairQuery_recurrence = keyValuePair_create(keyQuery_recurrence, valueQuery_recurrence);
        list_addElement(localVarQueryParameters,keyPairQuery_recurrence);
    }
    list_addElement(localVarHeaderType,"*/*"); //produces
    apiClient_invoke(apiClient,
                    localVarPath,
    ...
    if(keyQuery_recurrence){
        ...
        keyQuery_recurrence = NULL;
    }
    if(valueQuery_recurrence){
        free(valueQuery_recurrence);
        valueQuery_recurrence = NULL;
    }
    if(keyPairQuery_recurrence){
        keyValuePair_free(keyPairQuery_recurrence);
        keyPairQuery_recurrence = NULL;
    }
    return elementToReturn;
end:
    free(localVarPath);
...
TripAPI_getTripMatches(apiClient_t *apiClient, double version, long id, char *sortField, int *descending, int *start, int *limit, int *activeOnly, int *matchedHasRoute, int *matchedHasDriver)
{
    ...
    // query parameters
    char *keyQuery_matchedHasRoute = NULL;
    char * valueQuery_matchedHasRoute = NULL;
    keyValuePair_t *keyPairQuery_matchedHasRoute = 0;
    if (matchedHasRoute)
    {
        keyQuery_matchedHasRoute = strdup("matchedHasRoute");
        valueQuery_matchedHasRoute = calloc(1,MAX_NUMBER_LENGTH);
        snprintf(valueQuery_matchedHasRoute, MAX_NUMBER_LENGTH, "%d", *matchedHasRoute);
        keyPairQuery_matchedHasRoute = keyValuePair_create(keyQuery_matchedHasRoute, valueQuery_matchedHasRoute);
        list_addElement(localVarQueryParameters,keyPairQuery_matchedHasRoute);
    }

    // query parameters
    char *keyQuery_matchedHasDriver = NULL;
    char * valueQuery_matchedHasDriver = NULL;
    keyValuePair_t *keyPairQuery_matchedHasDriver = 0;
    if (matchedHasDriver)
    {
        keyQuery_matchedHasDriver = strdup("matchedHasDriver");
        valueQuery_matchedHasDriver = calloc(1,MAX_NUMBER_LENGTH);
        snprintf(valueQuery_matchedHasDriver, MAX_NUMBER_LENGTH, "%d", *matchedHasDriver);
        keyPairQuery_matchedHasDriver = keyValuePair_create(keyQuery_matchedHasDriver, valueQuery_matchedHasDriver);
        list_addElement(localVarQueryParameters,keyPairQuery_matchedHasDriver);
    }
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *TripAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(TripAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, TripAPIlocalVarJSON)
        {
    ...
    if(keyQuery_matchedHasRoute){
        ...
        keyQuery_matchedHasRoute = NULL;
    }
    if(valueQuery_matchedHasRoute){
        free(valueQuery_matchedHasRoute);
        valueQuery_matchedHasRoute = NULL;
    }
    if(keyPairQuery_matchedHasRoute){
        keyValuePair_free(keyPairQuery_matchedHasRoute);
        keyPairQuery_matchedHasRoute = NULL;
    }
    if(keyQuery_matchedHasDriver){
        free(keyQuery_matchedHasDriver);
        keyQuery_matchedHasDriver = NULL;
    }
    if(valueQuery_matchedHasDriver){
        free(valueQuery_matchedHasDriver);
        valueQuery_matchedHasDriver = NULL;
    }
    if(keyPairQuery_matchedHasDriver){
        keyValuePair_free(keyPairQuery_matchedHasDriver);
        keyPairQuery_matchedHasDriver = NULL;
    }
...
TripAPI_processTripMatches(apiClient_t *apiClient, double version, long startDate, long endDate, long tripId)
{
    ...
    // query parameters
    char *keyQuery_tripId = NULL;
    char * valueQuery_tripId ;
    keyValuePair_t *keyPairQuery_tripId = 0;
    {
        keyQuery_tripId = strdup("tripId");
        valueQuery_tripId = calloc(1,MAX_NUMBER_LENGTH_LONG);
        snprintf(valueQuery_tripId, MAX_NUMBER_LENGTH_LONG, "%d", tripId);
        keyPairQuery_tripId = keyValuePair_create(keyQuery_tripId, valueQuery_tripId);
        list_addElement(localVarQueryParameters,keyPairQuery_tripId);
    }
    list_addElement(localVarHeaderType,"*/*"); //produces
    apiClient_invoke(apiClient,
                    localVarPath,
    ...
    if(keyQuery_tripId){
        free(keyQuery_tripId);
        keyQuery_tripId = NULL;
    }
    if(keyPairQuery_tripId){
        keyValuePair_free(keyPairQuery_tripId);
        keyPairQuery_tripId = NULL;
    }
    return elementToReturn;
end:
    free(localVarPath);
...
TripAPI_search(apiClient_t *apiClient, double version, long accountId, char *sortField, int *descending, int *start, int *limit, int *activeOnly, long startDate, long endDate, int *hasNotifications)
{
    ...
    // query parameters
    char *keyQuery_hasNotifications = NULL;
    char * valueQuery_hasNotifications = NULL;
    keyValuePair_t *keyPairQuery_hasNotifications = 0;
    if (hasNotifications)
    {
        keyQuery_hasNotifications = strdup("hasNotifications");
        valueQuery_hasNotifications = calloc(1,MAX_NUMBER_LENGTH);
        snprintf(valueQuery_hasNotifications, MAX_NUMBER_LENGTH, "%d", *hasNotifications);
        keyPairQuery_hasNotifications = keyValuePair_create(keyQuery_hasNotifications, valueQuery_hasNotifications);
        list_addElement(localVarQueryParameters,keyPairQuery_hasNotifications);
    }
    ...
    if(keyQuery_hasNotifications){
        free(keyQuery_hasNotifications);
        keyQuery_hasNotifications = NULL;
    }
    if(valueQuery_hasNotifications){
        free(valueQuery_hasNotifications);
        valueQuery_hasNotifications = NULL;
    }
    if(keyPairQuery_hasNotifications){
        keyValuePair_free(keyPairQuery_hasNotifications);
        keyPairQuery_hasNotifications = NULL;
    }
    if(keyQuery_sortField){
        free(keyQuery_sortField);
        keyQuery_sortField = NULL;
...
TripAPI_updateTripNotifications(apiClient_t *apiClient, double version, long id, char *notifications)
{
    ...
    // query parameters
    char *keyQuery_notifications = NULL;
    char * valueQuery_notifications = NULL;
    keyValuePair_t *keyPairQuery_notifications = 0;
    if (notifications)
    {
        keyQuery_notifications = strdup("notifications");
        valueQuery_notifications = strdup((notifications));
        keyPairQuery_notifications = keyValuePair_create(keyQuery_notifications, valueQuery_notifications);
        list_addElement(localVarQueryParameters,keyPairQuery_notifications);
    }
    list_addElement(localVarHeaderType,"*/*"); //produces
    apiClient_invoke(apiClient,
                    localVarPath,
    ...
    if(keyQuery_notifications){
        free(keyQuery_notifications);
        keyQuery_notifications = NULL;
    }
    if(valueQuery_notifications){
        free(valueQuery_notifications);
        valueQuery_notifications = NULL;
    }
    if(keyPairQuery_notifications){
        keyValuePair_free(keyPairQuery_notifications);
        keyPairQuery_notifications = NULL;
    }
    return elementToReturn;
end:
    free(localVarPath);
