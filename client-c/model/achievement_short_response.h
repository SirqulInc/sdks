/*
 * achievement_short_response.h
 *
 * 
 */

#ifndef _achievement_short_response_H_
#define _achievement_short_response_H_
...
typedef struct achievement_short_response_t achievement_short_response_t;

#include "name_string_value_response.h"



typedef struct achievement_short_response_t {
    int valid; //boolean
    char *message; // string
...
#endif /* _achievement_short_response_H_ */
