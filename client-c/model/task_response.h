...
#ifndef _task_response_H_
#define _task_response_H_
...
typedef struct task_response_t task_response_t;

#include "account_short_response.h"
#include "application_mini_response.h"
#include "billable_entity_short_response.h"

// Enum STATUS for task_response

typedef enum  { sirqul_iot_platform_task_response_STATUS_NULL = 0, sirqul_iot_platform_task_response_STATUS__NEW, sirqul_iot_platform_task_response_STATUS_ERROR, sirqul_iot_platform_task_response_STATUS_COMPLETE, sirqul_iot_platform_task_response_STATUS_PROCESSING, sirqul_iot_platform_task_response_STATUS__TEMPLATE } sirqul_iot_platform_task_response_STATUS_e;
...
// Enum TYPE for task_response

typedef enum  { sirqul_iot_platform_task_response_TYPE_NULL = 0, sirqul_iot_platform_task_response_TYPE_HTTP, sirqul_iot_platform_task_response_TYPE_SAVE, sirqul_iot_platform_task_response_TYPE_EMAIL, sirqul_iot_platform_task_response_TYPE_SMS, sirqul_iot_platform_task_response_TYPE_APNS, sirqul_iot_platform_task_response_TYPE_GCM, sirqul_iot_platform_task_response_TYPE_PUSH, sirqul_iot_platform_task_response_TYPE_MOBILE_NOTIFICATION } sirqul_iot_platform_task_response_TYPE_e;
...
// Enum TEMPLATETYPE for task_response

typedef enum  { sirqul_iot_platform_task_response_TEMPLATETYPE_NULL = 0, sirqul_iot_platform_task_response_TEMPLATETYPE_REPORTING, sirqul_iot_platform_task_response_TEMPLATETYPE_ACHIEVEMENT_OWNER, sirqul_iot_platform_task_response_TEMPLATETYPE_ACHIEVEMENT_TRIGGER, sirqul_iot_platform_task_response_TEMPLATETYPE_GEOFENCE_OWNER, sirqul_iot_platform_task_response_TEMPLATETYPE_GEOFENCE_TARGET, sirqul_iot_platform_task_response_TEMPLATETYPE_GEOFENCE_TRIGGER, sirqul_iot_platform_task_response_TEMPLATETYPE_GEOFENCE_HTTP_CALL } sirqul_iot_platform_task_response_TEMPLATETYPE_e;
...
// Enum GROUPEDTYPES for task_response

typedef enum  { sirqul_iot_platform_task_response_GROUPEDTYPES_NULL = 0, sirqul_iot_platform_task_response_GROUPEDTYPES_HTTP, sirqul_iot_platform_task_response_GROUPEDTYPES_SAVE, sirqul_iot_platform_task_response_GROUPEDTYPES_EMAIL, sirqul_iot_platform_task_response_GROUPEDTYPES_SMS, sirqul_iot_platform_task_response_GROUPEDTYPES_APNS, sirqul_iot_platform_task_response_GROUPEDTYPES_GCM, sirqul_iot_platform_task_response_GROUPEDTYPES_PUSH, sirqul_iot_platform_task_response_GROUPEDTYPES_MOBILE_NOTIFICATION } sirqul_iot_platform_task_response_GROUPEDTYPES_e;
...
typedef struct task_response_t {
    long scheduled_notification_id; //numeric
    int active; //boolean
    sirqul_iot_platform_task_response_STATUS_e status; //enum
    sirqul_iot_platform_task_response_TYPE_e type; //enum
    char *name; // string
    char *message; // string
    ...
    sirqul_iot_platform_task_response_TEMPLATETYPE_e template_type; //enum
    list_t *grouped_types; //primitive container
    long task_id; //numeric
