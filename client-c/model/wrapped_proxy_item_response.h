/*
 * wrapped_proxy_item_response.h
 *
 * 
 */

#ifndef _wrapped_proxy_item_response_H_
#define _wrapped_proxy_item_response_H_
...
typedef struct wrapped_proxy_item_response_t wrapped_proxy_item_response_t;
...
typedef struct wrapped_proxy_item_response_t {
    int valid; //boolean
    char *message; // string
    ...
    struct image_generation_response_t *item; //model
...
#endif /* _wrapped_proxy_item_response_H_ */
