/*
 * asset_full_response.h
 *
 * 
 */

#ifndef _asset_full_response_H_
#define _asset_full_response_H_
...
typedef struct asset_full_response_t asset_full_response_t;
...
typedef struct asset_full_response_t {
    int valid; //boolean
    char *message; // string
