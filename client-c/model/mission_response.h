...
#ifndef _mission_response_H_
#define _mission_response_H_
...
typedef struct mission_response_t mission_response_t;
...
// Enum ACTION for mission_response

typedef enum  { sirqul_iot_platform_mission_response_ACTION_NULL = 0, sirqul_iot_platform_mission_response_ACTION_DATA, sirqul_iot_platform_mission_response_ACTION_SAVE, sirqul_iot_platform_mission_response_ACTION__DELETE, sirqul_iot_platform_mission_response_ACTION_GET } sirqul_iot_platform_mission_response_ACTION_e;
...
// Enum INVITESTATUS for mission_response

typedef enum  { sirqul_iot_platform_mission_response_INVITESTATUS_NULL = 0, sirqul_iot_platform_mission_response_INVITESTATUS_AVAILABLE, sirqul_iot_platform_mission_response_INVITESTATUS_PENDING, sirqul_iot_platform_mission_response_INVITESTATUS_UPDATED, sirqul_iot_platform_mission_response_INVITESTATUS_ACCEPTED, sirqul_iot_platform_mission_response_INVITESTATUS_ACTIVE, sirqul_iot_platform_mission_response_INVITESTATUS_BUY_BACK, sirqul_iot_platform_mission_response_INVITESTATUS_FAILED, sirqul_iot_platform_mission_response_INVITESTATUS_QUIT, sirqul_iot_platform_mission_response_INVITESTATUS_COMPLETED, sirqul_iot_platform_mission_response_INVITESTATUS_PENDING_REVIEW, sirqul_iot_platform_mission_response_INVITESTATUS_REJECTED } sirqul_iot_platform_mission_response_INVITESTATUS_e;
...
typedef struct mission_response_t {
    sirqul_iot_platform_mission_response_ACTION_e action; //enum
    ...
    sirqul_iot_platform_mission_response_INVITESTATUS_e invite_status; //enum
