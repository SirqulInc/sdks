...
#ifndef _offer_response_H_
#define _offer_response_H_
...
typedef struct offer_response_t offer_response_t;
...
// Enum BARCODETYPE for offer_response

typedef enum  { sirqul_iot_platform_offer_response_BARCODETYPE_NULL = 0, sirqul_iot_platform_offer_response_BARCODETYPE_NONE, sirqul_iot_platform_offer_response_BARCODETYPE_UPC, sirqul_iot_platform_offer_response_BARCODETYPE_CODE_128, sirqul_iot_platform_offer_response_BARCODETYPE_QR, sirqul_iot_platform_offer_response_BARCODETYPE_CUSTOM_MEDIA } sirqul_iot_platform_offer_response_BARCODETYPE_e;
...
// Enum SPECIALOFFERTYPE for offer_response

typedef enum  { sirqul_iot_platform_offer_response_SPECIALOFFERTYPE_NULL = 0, sirqul_iot_platform_offer_response_SPECIALOFFERTYPE_ALL, sirqul_iot_platform_offer_response_SPECIALOFFERTYPE_RESERVABLE, sirqul_iot_platform_offer_response_SPECIALOFFERTYPE_REGULAR_OFFER, sirqul_iot_platform_offer_response_SPECIALOFFERTYPE_ACT_NOW, sirqul_iot_platform_offer_response_SPECIALOFFERTYPE_GET_THERE_NOW, sirqul_iot_platform_offer_response_SPECIALOFFERTYPE_SQOOT, sirqul_iot_platform_offer_response_SPECIALOFFERTYPE_TICKETS, sirqul_iot_platform_offer_response_SPECIALOFFERTYPE_YIPIT } sirqul_iot_platform_offer_response_SPECIALOFFERTYPE_e;
...
typedef struct offer_response_t {
    int valid; //boolean
    char *message; // string
    ...
    sirqul_iot_platform_offer_response_BARCODETYPE_e barcode_type; //enum
    long tickets_reward; //numeric
    char *tickets_reward_type; // string
    sirqul_iot_platform_offer_response_SPECIALOFFERTYPE_e special_offer_type; //enum
