/*
 * orson_ai_prod_response.h
 *
 * 
 */

#ifndef _orson_ai_prod_response_H_
#define _orson_ai_prod_response_H_
...
typedef struct orson_ai_prod_response_t orson_ai_prod_response_t;




typedef struct orson_ai_prod_response_t {
    char *request_id; // string
    int response_code; //numeric
    char *response_raw; // string

    int _library_owned; // Is the library responsible for freeing this object?
} orson_ai_prod_response_t;
...
#endif /* _orson_ai_prod_response_H_ */
