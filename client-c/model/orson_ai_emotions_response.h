/*
 * orson_ai_emotions_response.h
 *
 * 
 */

#ifndef _orson_ai_emotions_response_H_
#define _orson_ai_emotions_response_H_
...
typedef struct orson_ai_emotions_response_t orson_ai_emotions_response_t;

#include "orson_ai_visual_emotion_response.h"



typedef struct orson_ai_emotions_response_t {
    char *request_id; // string
    int response_code; //numeric
    char *response_raw; // string
    char *status; // string
    char *error; // string
    list_t *audio_emotions; //primitive container
    list_t *visual_emotions; //nonprimitive container
...
#endif /* _orson_ai_emotions_response_H_ */
