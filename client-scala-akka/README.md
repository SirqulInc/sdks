...
object AMQPApiExample extends App {

    implicit val system: ActorSystem = ActorSystem()
    import system.dispatcher
    // Create invoker to execute requests
    val apiInvoker = ApiInvoker()
    val apiInstance = AMQPApi("http://localhost")
    val version: BigDecimal = 3.16 // BigDecimal | 

    val appKey: String = appKey_example // String | The application key to use when creating an analytic or service request. The account needs to have permissions to the applicaton or it will be denied.

    val name: String = name_example // String | The name of the queue to connect to

    val hostname: String = hostname_example // String | The hostname of the server the queue is hosted on

    val username: String = username_example // String | The username to access the server the queue is hosted on

    val password: String = password_example // String | The password to access the queue to connect to

    val dataMapping: String = dataMapping_example // String | The data mapping information in the format of AMQPRequest

    val deviceId: String = deviceId_example // String | The client deviceID

    val accountId: Long = 789 // Long | The logged in user ID

    val port: Int = 56 // Int | The port of the server the queue is hosted on

    val virtualHost: String = virtualHost_example // String | The virtual host defined on the server the queue is associated on

    val exchanger: String = exchanger_example // String | The exchanger of the queue to connect to

    val exchangerType: String = exchangerType_example // String | The exchanger type of the queue to connect to

    val workers: Int = 56 // Int | The number of workers to generate 

    val useSSL: Boolean = true // Boolean | Use SSL

    val request = apiInstance.consumerCreate(version, appKey, name, hostname, username, password, dataMapping, deviceId, accountId, port, virtualHost, exchanger, exchangerType, workers, useSSL)
