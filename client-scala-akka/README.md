...
object AMQPApiExample extends App {
    ...
    val apiInstance = AMQPApi("https://dev.sirqul.com/api/3.18")
    ...
    val request = apiInstance.consumerCreate(appKey, name, hostname, username, password, dataMapping, deviceId, accountId, port, virtualHost, exchanger, exchangerType, workers, useSSL)
