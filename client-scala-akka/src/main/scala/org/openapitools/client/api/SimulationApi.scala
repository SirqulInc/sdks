...
object SimulationApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new SimulationApi(baseUrl)
}
...
class SimulationApi(baseUrl: String) {
   ...
   */
  def simulation(version: BigDecimal, data: String, realTime: Boolean): ApiRequest[SirqulResponse] =
    ApiRequest[SirqulResponse](ApiMethods.POST, baseUrl, "/api/{version}/simulation/routing", "application/json")
