...
case class TaskResponse (
  ...
  status: Option[TaskResponseEnums.Status] = None,
  `type`: Option[TaskResponseEnums.`Type`] = None,
  ...
  templateType: Option[TaskResponseEnums.TemplateType] = None,
  groupedTypes: Option[TaskResponseEnums.Seq[GroupedTypes]] = None,
  taskId: Option[Long] = None
) extends ApiModel

object TaskResponseEnums {
