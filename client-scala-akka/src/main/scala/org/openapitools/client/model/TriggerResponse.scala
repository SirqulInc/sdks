...
case class TriggerResponse (
  ...
  status: Option[TriggerResponseEnums.Status] = None,
  `type`: Option[TriggerResponseEnums.`Type`] = None,
  ...
  templateType: Option[TriggerResponseEnums.TemplateType] = None,
  groupedTypes: Option[TriggerResponseEnums.Seq[GroupedTypes]] = None,
  triggerId: Option[Long] = None
) extends ApiModel

object TriggerResponseEnums {
