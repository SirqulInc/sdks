...
class AppVersion {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('versionIndex')) {
                obj['versionIndex'] = ApiClient.convertToType(data['versionIndex'], 'Number');
            }
        }
        return obj;
    }
 ...
 */
AppVersion.prototype['minorVersion'] = undefined;

/**
 * @member {Number} majorVersion
 */
AppVersion.prototype['majorVersion'] = undefined;

/**
 * @member {Number} versionIndex
 */
AppVersion.prototype['versionIndex'] = undefined;
