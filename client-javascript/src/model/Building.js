...
class Building {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['buildingType'] && !(typeof data['buildingType'] === 'string' || data['buildingType'] instanceof String)) {
            throw new Error("Expected the field `buildingType` to be a primitive type in the JSON string but got " + data['buildingType']);
        }
 ...
 */
Building.prototype['active'] = undefined;

/**
 * @member {Boolean} valid
 */
Building.prototype['valid'] = undefined;
 ...
 */
Building.prototype['buildingType'] = undefined;
