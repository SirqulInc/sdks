...
export default class SimulationApi {
    ...
    */
     ...
     */
    simulation(version, data, realTime, callback) {
      let postBody = null;
      // verify the required parameter 'version' is set
      if (version === undefined || version === null) {
        throw new Error("Missing the required parameter 'version' when calling simulation");
      }
      ...
      return this.apiClient.callApi(
        '/api/{version}/simulation/routing', 'POST',
