...
public struct ListResponse: Codable {
    ...
    public init(valid: Bool? = nil, message: String? = nil, version: Double? = nil, serializeNulls: Bool? = nil, startTimeLog: Int64? = nil, errorCode: String? = nil, request: [NameStringValueResponse]? = nil, items: [[String: Any]]? = nil, count: Int? = nil, returning: String? = nil) {
        self.valid = valid
