...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("appKey", new ApiKeyAuth("header", "Application-Key"));
        authentications.put("restKey", new ApiKeyAuth("header", "Application-Rest-Key"));
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/3.16/java");
