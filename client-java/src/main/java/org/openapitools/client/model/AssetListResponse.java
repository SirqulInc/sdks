...
public class AssetListResponse {
  ...
  @javax.annotation.Nullable
  private List<AssetResponse> items = new ArrayList<>();
  ...
  public AssetListResponse valid(@javax.annotation.Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public AssetListResponse message(@javax.annotation.Nullable String message) {
  ...
  public AssetListResponse version(@javax.annotation.Nullable Double version) {
  ...
  public AssetListResponse serializeNulls(@javax.annotation.Nullable Boolean serializeNulls) {
  ...
  public AssetListResponse startTimeLog(@javax.annotation.Nullable Long startTimeLog) {
  ...
  public AssetListResponse errorCode(@javax.annotation.Nullable String errorCode) {
  ...
  public AssetListResponse request(@javax.annotation.Nullable List<NameStringValueResponse> request) {
  ...
  public AssetListResponse items(@javax.annotation.Nullable List<AssetResponse> items) {
    this.items = items;
    return this;
  }
  ...
  public void setItems(@javax.annotation.Nullable List<AssetResponse> items) {
    this.items = items;
  }


  public AssetListResponse hasMoreResults(@javax.annotation.Nullable Boolean hasMoreResults) {
  ...
  public AssetListResponse count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public AssetListResponse returning(@javax.annotation.Nullable String returning) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("valid", "message", "version", "serializeNulls", "startTimeLog", "errorCode", "request", "items", "hasMoreResults", "count", "returning"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssetListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AssetListResponse is not found in the empty JSON string", AssetListResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssetListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AssetListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            AssetResponse.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
