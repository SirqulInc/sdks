...
public class Program {
  ...
  public static final String SERIALIZED_NAME_COST_PER_RIDE = "costPerRide";
  @SerializedName(SERIALIZED_NAME_COST_PER_RIDE)
  @javax.annotation.Nullable
  ...
  public Program id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public Program active(@javax.annotation.Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public Program valid(@javax.annotation.Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public Program name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Program description(@javax.annotation.Nullable String description) {
  ...
  public Program costPerRide(@javax.annotation.Nullable Integer costPerRide) {
  ...
  public void setCostPerRide(@javax.annotation.Nullable Integer costPerRide) {
    this.costPerRide = costPerRide;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "active", "valid", "name", "description", "costPerRide"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Program.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Program is not found in the empty JSON string", Program.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Program.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Program` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
