...
public class Event {
  public static final String SERIALIZED_NAME_SPONSERED = "sponsered";
  @SerializedName(SERIALIZED_NAME_SPONSERED)
  ...
  public Event sponsered(@javax.annotation.Nullable Boolean sponsered) {
  ...
  public void setSponsered(@javax.annotation.Nullable Boolean sponsered) {
    this.sponsered = sponsered;
  }


  public Event listing(@javax.annotation.Nullable Listing listing) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sponsered", "listing"));
