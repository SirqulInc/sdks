...
public class Subscription {
  ...
  public static final String SERIALIZED_NAME_REMOTE_SUBSCRIPTION_ID = "remoteSubscriptionId";
  @SerializedName(SERIALIZED_NAME_REMOTE_SUBSCRIPTION_ID)
  @javax.annotation.Nullable
  ...
  public Subscription id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public Subscription active(@javax.annotation.Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public Subscription valid(@javax.annotation.Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public Subscription subscriptionPlan(@javax.annotation.Nullable SubscriptionPlan subscriptionPlan) {
  ...
  public void setSubscriptionPlan(@javax.annotation.Nullable SubscriptionPlan subscriptionPlan) {
    this.subscriptionPlan = subscriptionPlan;
  }


  public Subscription remoteSubscriptionId(@javax.annotation.Nullable String remoteSubscriptionId) {
  ...
  public void setRemoteSubscriptionId(@javax.annotation.Nullable String remoteSubscriptionId) {
    this.remoteSubscriptionId = remoteSubscriptionId;
  }


  public Subscription promoCode(@javax.annotation.Nullable String promoCode) {
  ...
  public Subscription failed(@javax.annotation.Nullable Boolean failed) {
    this.failed = failed;
    return this;
  }
  ...
  public Subscription message(@javax.annotation.Nullable MessageEnum message) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "active", "valid", "subscriptionPlan", "remoteSubscriptionId", "promoCode", "failed", "message"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("remoteSubscriptionId") != null && !jsonObj.get("remoteSubscriptionId").isJsonNull()) && !jsonObj.get("remoteSubscriptionId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `remoteSubscriptionId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("remoteSubscriptionId").toString()));
      }
