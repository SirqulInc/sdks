...
public class AccountResponse {
  ...
  public AccountResponse accountId(@javax.annotation.Nullable Long accountId) {
  ...
  public AccountResponse locationDisplay(@javax.annotation.Nullable String locationDisplay) {
  ...
  public AccountResponse display(@javax.annotation.Nullable String display) {
  ...
  public AccountResponse username(@javax.annotation.Nullable String username) {
  ...
  public AccountResponse accountType(@javax.annotation.Nullable String accountType) {
  ...
  public AccountResponse profileImage(@javax.annotation.Nullable String profileImage) {
  ...
  public AccountResponse gender(@javax.annotation.Nullable GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  public AccountResponse contactEmail(@javax.annotation.Nullable String contactEmail) {
  ...
  public AccountResponse contact(@javax.annotation.Nullable ContactResponse contact) {
  ...
  public AccountResponse manager(@javax.annotation.Nullable AccountMiniResponse manager) {
  ...
  public AccountResponse active(@javax.annotation.Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("accountId", "locationDisplay", "display", "username", "accountType", "profileImage", "gender", "contactEmail", "contact", "manager", "active"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AccountResponse is not found in the empty JSON string", AccountResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AccountResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
