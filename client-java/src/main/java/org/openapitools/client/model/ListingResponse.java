...
public class ListingResponse {
  ...
  public ListingResponse id(@javax.annotation.Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public ListingResponse name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ListingResponse description(@javax.annotation.Nullable String description) {
  ...
  public ListingResponse start(@javax.annotation.Nullable Long start) {
    this.start = start;
    return this;
  }
  ...
  public ListingResponse end(@javax.annotation.Nullable Long end) {
    this.end = end;
    return this;
  }
  ...
  public ListingResponse locationName(@javax.annotation.Nullable String locationName) {
  ...
  public ListingResponse locationDescription(@javax.annotation.Nullable String locationDescription) {
  ...
  public ListingResponse privateListing(@javax.annotation.Nullable Boolean privateListing) {
  ...
  public ListingResponse active(@javax.annotation.Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public ListingResponse participants(@javax.annotation.Nullable List<ParticipantResponse> participants) {
  ...
  public ListingResponse owner(@javax.annotation.Nullable AccountShortResponse owner) {
    this.owner = owner;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "description", "start", "end", "locationName", "locationDescription", "privateListing", "active", "participants", "owner"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListingResponse is not found in the empty JSON string", ListingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
