...
Sirqul IoT Platform
- API version: 3.16
  - Build date: 2026-02-11T18:59:03.014614210Z[Etc/UTC]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://dev.sirqul.com/api/3.18");
