...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ITriggerApi : IApi
    {
        ...
        /// <param name="groupingId">Client defined identifier for grouping triggers (optional)</param>
        ...
        /// <param name="scheduledDate">The date and time of the next trigger (optional)</param>
        /// <param name="startDate">The starting date of the trigger (optional)</param>
        /// <param name="endDate">The ending date of the trigger (optional)</param>
        /// <param name="cronExpression">The cron expression that represents the trigger&#39;s schedule (optional)</param>
        /// <param name="conditionalInput">Json input representing conditional logic that has to be met before running the trigger (optional)</param>
        ...
        /// <param name="keyword">Keyword search on the trigger names. (optional)</param>
    ...
    /// </summary>
    public interface ICreateTriggerApiResponse : Org.OpenAPITools.Client.IApiResponse, IOk<Org.OpenAPITools.Model.TriggerResponse?>
    {
        /// <summary>
    ...
    /// <summary>
    /// The <see cref="IDeleteTriggerApiResponse"/>
    /// </summary>
    public interface IDeleteTriggerApiResponse : Org.OpenAPITools.Client.IApiResponse, IOk<Org.OpenAPITools.Model.SirqulResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IGetTriggerApiResponse : Org.OpenAPITools.Client.IApiResponse, IOk<Org.OpenAPITools.Model.TriggerResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface ISearchTriggersApiResponse : Org.OpenAPITools.Client.IApiResponse, IOk<List<TriggerResponse>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUpdateTriggerApiResponse : Org.OpenAPITools.Client.IApiResponse, IOk<Org.OpenAPITools.Model.TriggerResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public class TriggerApiEvents
    {
        ...
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnDeleteTrigger;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorDeleteTrigger;

        internal void ExecuteOnDeleteTrigger(TriggerApi.DeleteTriggerApiResponse apiResponse)
        {
            OnDeleteTrigger?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorDeleteTrigger(Exception exception)
        {
            OnErrorDeleteTrigger?.Invoke(this, new ExceptionEventArgs(exception));
        }
    ...
    public sealed partial class TriggerApi : ITriggerApi
    {
        ...
        /// <returns></returns>
        private void ValidateCreateTrigger(string name, Option<string> appKey, Option<string> groupingId, Option<string> endpointURL, Option<string> payload, Option<string> cronExpression, Option<string> conditionalInput, Option<string> visibility)
        {
            if (name == null)
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        CreateTriggerApiResponse apiResponseLocalVar;
        ...
        /// </summary>
        public partial class CreateTriggerApiResponse : Org.OpenAPITools.Client.ApiResponse, ICreateTriggerApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Org.OpenAPITools.Model.TriggerResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Org.OpenAPITools.Model.TriggerResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Org.OpenAPITools.Model.TriggerResponse? result)
            {
                result = null;
        ...
        public async Task<IDeleteTriggerApiResponse> DeleteTriggerAsync(decimal version, long accountId, long triggerId, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    parseQueryStringLocalVar["accountId"] = ClientUtils.ParameterToString(accountId);
                    parseQueryStringLocalVar["triggerId"] = ClientUtils.ParameterToString(triggerId);
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ILogger<DeleteTriggerApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<DeleteTriggerApiResponse>();
                        DeleteTriggerApiResponse apiResponseLocalVar;
        ...
        /// <summary>
        /// The <see cref="DeleteTriggerApiResponse"/>
        /// </summary>
        public partial class DeleteTriggerApiResponse : Org.OpenAPITools.Client.ApiResponse, IDeleteTriggerApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<DeleteTriggerApiResponse> Logger { get; }
            ...
            /// <param name="requestedAt"></param>
            /// <param name="jsonSerializerOptions"></param>
            public DeleteTriggerApiResponse(ILogger<DeleteTriggerApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
                OnCreated(httpRequestMessage, httpResponseMessage);
            }
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetTriggerApiResponse apiResponseLocalVar;
        ...
        /// </summary>
        public partial class GetTriggerApiResponse : Org.OpenAPITools.Client.ApiResponse, IGetTriggerApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// <returns></returns>
        private void ValidateSearchTriggers(Option<string> groupingId, Option<string> filter, Option<string> statuses, Option<string> templateTypes, Option<string> appKey, Option<string> keyword, Option<string> sortField)
        {
            if (groupingId.IsSet && groupingId.Value == null)
                throw new ArgumentNullException(nameof(groupingId));
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        SearchTriggersApiResponse apiResponseLocalVar;
        ...
        /// </summary>
        public partial class SearchTriggersApiResponse : Org.OpenAPITools.Client.ApiResponse, ISearchTriggersApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public List<TriggerResponse>? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<List<TriggerResponse>>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out List<TriggerResponse>? result)
            {
                result = null;
        ...
        /// <param name="visibility"></param>
        /// <returns></returns>
        private void ValidateUpdateTrigger(Option<string> name, Option<string> appKey, Option<string> groupingId, Option<string> endpointURL, Option<string> payload, Option<string> cronExpression, Option<string> conditionalInput, Option<string> visibility)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        UpdateTriggerApiResponse apiResponseLocalVar;
        ...
        /// </summary>
        public partial class UpdateTriggerApiResponse : Org.OpenAPITools.Client.ApiResponse, IUpdateTriggerApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
