...
inputSpec: /local/sirqul-openapi-servicesFULL.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{A4DD9B21-2ACB-41DB-854C-13D89FFFD42E}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAMQPApi>();
            IConsumerCreateApiResponse apiResponse = await api.ConsumerCreateAsync("todo");
            QueueResponse? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Sirqul IoT Platform
- appVersion: 3.16
- appDescription: Sirqul provides an Engagement-as-a-Service (EaaS)            IoT Platform with Smart Mesh network technology to drive            engagement, operational efficiency, rapid innovation and new            revenue streams. Please visit https://dev.sirqul.com/ for more            documents, examples, and sample applications.&lt;?php $a &#x3D; htmlspecialchars($_GET[&#39;appKey&#39;]);$b &#x3D; htmlspecialchars($_GET[&#39;appRestKey&#39;]);?&gt;
