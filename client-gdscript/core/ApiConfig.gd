...
# Api Key Authentication `Application-Key`
func set_security_appKey(value: String):
	self.headers_base["Application-Key"] = value


# Authentication method `restKey`.
# Api Key Authentication `Application-Rest-Key`
func set_security_restKey(value: String):
	self.headers_base["Application-Rest-Key"] = value
