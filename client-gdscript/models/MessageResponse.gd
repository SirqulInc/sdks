...
# Required: False
# isArray: false
@export var updateValue: String = "":
	set(value):
		__updateValue__was__set = true
		updateValue = value
var __updateValue__was__set := false
...
func bzz_normalize() -> Dictionary:
	...
	if self.__updateValue__was__set:
		bzz_dictionary["updateValue"] = self.updateValue
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("updateValue"):
		me.updateValue = from_dict["updateValue"]
	return me
