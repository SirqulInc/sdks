#' Create a new AssetListResponse
#'
#' @description
...
#' @description AssetListResponse Class
...
#' @field items  list(\link{AssetResponse}) [optional]
...
AssetListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AssetListResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `items` = NULL, `hasMoreResults` = NULL, `count` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return AssetListResponse as a base R list.
    #' @examples
    #' # convert array of AssetListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AssetListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AssetListResponseObject <- list()
      if (!is.null(self$`valid`)) {
        AssetListResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        AssetListResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        AssetListResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        AssetListResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        AssetListResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        AssetListResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        AssetListResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`items`)) {
        AssetListResponseObject[["items"]] <-
          self$extractSimpleType(self$`items`)
      }
      if (!is.null(self$`hasMoreResults`)) {
        AssetListResponseObject[["hasMoreResults"]] <-
          self$`hasMoreResults`
      }
      if (!is.null(self$`count`)) {
        AssetListResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`returning`)) {
        AssetListResponseObject[["returning"]] <-
          self$`returning`
      }
      return(AssetListResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of AssetListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of AssetListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[AssetResponse]", loadNamespace("openapi"))
      }
    ...
    #' @return AssetListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AssetListResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of AssetListResponse
    toString = function() {
      self$toJSONString()
    },
...
# AssetListResponse$unlock()
#
## Below is an example to define the print function
# AssetListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AssetListResponse$lock()
