...
#' @description ProductResponse Class
...
#' @field size  \link{SizeGroupResponse} [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ProductResponse <- R6::R6Class(
  "ProductResponse",
  public = list(
    `brand` = NULL,
    `productType` = NULL,
    ...
    #' @description
    #' Initialize a new ProductResponse class.
    #'
    #' @param brand brand
    ...
    #'
    #' @return ProductResponse as a base R list.
    #' @examples
    #' # convert array of ProductResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProductResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProductResponseObject <- list()
      if (!is.null(self$`brand`)) {
        ProductResponseObject[["brand"]] <-
          self$`brand`
      }
      if (!is.null(self$`productType`)) {
        ProductResponseObject[["productType"]] <-
          self$`productType`
      }
      if (!is.null(self$`condition`)) {
        ProductResponseObject[["condition"]] <-
          self$`condition`
      }
      if (!is.null(self$`isbn`)) {
        ProductResponseObject[["isbn"]] <-
          self$`isbn`
      }
      if (!is.null(self$`asin`)) {
        ProductResponseObject[["asin"]] <-
          self$`asin`
      }
      if (!is.null(self$`catalogNumbers`)) {
        ProductResponseObject[["catalogNumbers"]] <-
          self$`catalogNumbers`
      }
      if (!is.null(self$`department`)) {
        ProductResponseObject[["department"]] <-
          self$`department`
      }
      if (!is.null(self$`features`)) {
        ProductResponseObject[["features"]] <-
          self$`features`
      }
      if (!is.null(self$`minimumPrice`)) {
        ProductResponseObject[["minimumPrice"]] <-
          self$`minimumPrice`
      }
      if (!is.null(self$`width`)) {
        ProductResponseObject[["width"]] <-
          self$`width`
      }
      if (!is.null(self$`height`)) {
        ProductResponseObject[["height"]] <-
          self$`height`
      }
      if (!is.null(self$`depth`)) {
        ProductResponseObject[["depth"]] <-
          self$`depth`
      }
      if (!is.null(self$`weight`)) {
        ProductResponseObject[["weight"]] <-
          self$`weight`
      }
      if (!is.null(self$`unit`)) {
        ProductResponseObject[["unit"]] <-
          self$`unit`
      }
      if (!is.null(self$`studio`)) {
        ProductResponseObject[["studio"]] <-
          self$`studio`
      }
      if (!is.null(self$`parentalRating`)) {
        ProductResponseObject[["parentalRating"]] <-
          self$`parentalRating`
      }
      if (!is.null(self$`publishDate`)) {
        ProductResponseObject[["publishDate"]] <-
          self$`publishDate`
      }
      if (!is.null(self$`availabilityDate`)) {
        ProductResponseObject[["availabilityDate"]] <-
          self$`availabilityDate`
      }
      if (!is.null(self$`size`)) {
        ProductResponseObject[["size"]] <-
    ...
    #' @description
    #' Deserialize JSON string into an instance of ProductResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProductResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`size`)) {
        `size_object` <- SizeGroupResponse$new()
    ...
    #' @return ProductResponse in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`publishDate` <- this_object$`publishDate`
      self$`availabilityDate` <- this_object$`availabilityDate`
      self$`size` <- SizeGroupResponse$new()$fromJSON(jsonlite::toJSON(this_object$`size`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to ProductResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ProductResponse
    toString = function() {
      self$toJSONString()
    },
...
# ProductResponse$unlock()
#
## Below is an example to define the print function
# ProductResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProductResponse$lock()
