#' Create a new TicketListResponse
#'
#' @description
...
#' @description TicketListResponse Class
...
#' @field items  list(\link{TicketResponse}) [optional]
...
TicketListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TicketListResponse class.
    #'
    #' @param valid valid
    ...
    #'
    #' @return TicketListResponse as a base R list.
    #' @examples
    #' # convert array of TicketListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TicketListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TicketListResponseObject <- list()
      if (!is.null(self$`valid`)) {
        TicketListResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        TicketListResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        TicketListResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        TicketListResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        TicketListResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        TicketListResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        TicketListResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`items`)) {
        TicketListResponseObject[["items"]] <-
          self$extractSimpleType(self$`items`)
      }
      if (!is.null(self$`count`)) {
        TicketListResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`hasMoreResults`)) {
        TicketListResponseObject[["hasMoreResults"]] <-
          self$`hasMoreResults`
      }
      if (!is.null(self$`start`)) {
        TicketListResponseObject[["start"]] <-
          self$`start`
      }
      if (!is.null(self$`limit`)) {
        TicketListResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`countTotal`)) {
        TicketListResponseObject[["countTotal"]] <-
          self$`countTotal`
      }
      if (!is.null(self$`returning`)) {
        TicketListResponseObject[["returning"]] <-
          self$`returning`
      }
      return(TicketListResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of TicketListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of TicketListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[TicketResponse]", loadNamespace("openapi"))
      }
    ...
    #' @return TicketListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TicketListResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of TicketListResponse
    toString = function() {
      self$toJSONString()
    },
...
# TicketListResponse$unlock()
#
## Below is an example to define the print function
# TicketListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TicketListResponse$lock()
