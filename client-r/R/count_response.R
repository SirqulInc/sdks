...
CountResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `count` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return CountResponse as a base R list.
    #' @examples
    #' # convert array of CountResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CountResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CountResponseObject <- list()
      if (!is.null(self$`valid`)) {
        CountResponseObject[["valid"]] <-
          self$`valid`
      }
      ...
      if (!is.null(self$`version`)) {
        CountResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        CountResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        CountResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        CountResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        CountResponseObject[["request"]] <-
      ...
      if (!is.null(self$`returning`)) {
        CountResponseObject[["returning"]] <-
          self$`returning`
      }
      return(CountResponseObject)
    },
