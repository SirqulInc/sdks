...
Contact <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`firstName` = NULL, `middleName` = NULL, `lastName` = NULL, `prefix` = NULL, `suffix` = NULL, `title` = NULL, `homePhone` = NULL, `cellPhone` = NULL, `cellCarrier` = NULL, `businessPhone` = NULL, `businessPhoneExt` = NULL, `faxNumber` = NULL, `timeZone` = NULL, `utcOffset` = NULL, `code501c3` = NULL, `emailAddress` = NULL, `address` = NULL, `web` = NULL, `display` = NULL, ...) {
