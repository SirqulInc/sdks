...
#' @description WrappedResponse Class
...
WrappedResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new WrappedResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `type` = NULL, `item` = NULL, `messages` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return WrappedResponse as a base R list.
    #' @examples
    #' # convert array of WrappedResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert WrappedResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      WrappedResponseObject <- list()
      if (!is.null(self$`valid`)) {
        WrappedResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        WrappedResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        WrappedResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        WrappedResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        WrappedResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        WrappedResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        WrappedResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`type`)) {
        WrappedResponseObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`item`)) {
        WrappedResponseObject[["item"]] <-
          self$`item`
      }
      if (!is.null(self$`messages`)) {
        WrappedResponseObject[["messages"]] <-
          self$extractSimpleType(self$`messages`)
      }
      if (!is.null(self$`returning`)) {
        WrappedResponseObject[["returning"]] <-
          self$`returning`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of WrappedResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of WrappedResponse
    ...
    #' @return WrappedResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to WrappedResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of WrappedResponse
    toString = function() {
      self$toJSONString()
    },
...
# WrappedResponse$unlock()
#
## Below is an example to define the print function
# WrappedResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# WrappedResponse$lock()
