...
ListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ListResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `items` = NULL, `count` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return ListResponse as a base R list.
    #' @examples
    #' # convert array of ListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ListResponseObject <- list()
      if (!is.null(self$`valid`)) {
        ListResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        ListResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        ListResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        ListResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        ListResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        ListResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        ListResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`items`)) {
        ListResponseObject[["items"]] <-
          self$`items`
      }
      if (!is.null(self$`count`)) {
        ListResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`returning`)) {
        ListResponseObject[["returning"]] <-
          self$`returning`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of ListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ListResponse
    ...
    #' @return ListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ListResponse and throw an exception if invalid
    #'
...
# ListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
