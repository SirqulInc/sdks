#' Create a new UserLocationSearchResponse
#'
#' @description
#' UserLocationSearchResponse Class
#'
#' @docType class
#' @title UserLocationSearchResponse
#' @description UserLocationSearchResponse Class
...
#' @field userLocations  list(\link{UserLocationListResponse}) [optional]
#' @field returning  character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
UserLocationSearchResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new UserLocationSearchResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `hasMoreResults` = NULL, `count` = NULL, `userLocations` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
      ...
      if (!is.null(`userLocations`)) {
        stopifnot(is.vector(`userLocations`), length(`userLocations`) != 0)
        sapply(`userLocations`, function(x) stopifnot(R6::is.R6(x)))
    ...
    #'
    #' @return UserLocationSearchResponse as a base R list.
    #' @examples
    #' # convert array of UserLocationSearchResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UserLocationSearchResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      UserLocationSearchResponseObject <- list()
      if (!is.null(self$`valid`)) {
        UserLocationSearchResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        UserLocationSearchResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        UserLocationSearchResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        UserLocationSearchResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        UserLocationSearchResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        UserLocationSearchResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        UserLocationSearchResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`hasMoreResults`)) {
        UserLocationSearchResponseObject[["hasMoreResults"]] <-
          self$`hasMoreResults`
      }
      if (!is.null(self$`count`)) {
        UserLocationSearchResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`userLocations`)) {
        UserLocationSearchResponseObject[["userLocations"]] <-
          self$extractSimpleType(self$`userLocations`)
      }
      if (!is.null(self$`returning`)) {
        UserLocationSearchResponseObject[["returning"]] <-
          self$`returning`
      }
      return(UserLocationSearchResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of UserLocationSearchResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of UserLocationSearchResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`userLocations`)) {
        self$`userLocations` <- ApiClient$new()$deserializeObj(this_object$`userLocations`, "array[UserLocationListResponse]", loadNamespace("openapi"))
      }
    ...
    #' @return UserLocationSearchResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to UserLocationSearchResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of UserLocationSearchResponse
    toString = function() {
      self$toJSONString()
    },
...
# UserLocationSearchResponse$unlock()
#
## Below is an example to define the print function
# UserLocationSearchResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UserLocationSearchResponse$lock()
