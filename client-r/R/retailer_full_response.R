#' Create a new RetailerFullResponse
#'
#' @description
#' RetailerFullResponse Class
#'
#' @docType class
#' @title RetailerFullResponse
#' @description RetailerFullResponse Class
...
#' @export
RetailerFullResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RetailerFullResponse class.
    #'
    ...
    initialize = function(`retailerId` = NULL, `name` = NULL, `facebookUrl` = NULL, `twitterUrl` = NULL, `active` = NULL, `contact` = NULL, `logo` = NULL, `picture1` = NULL, `picture2` = NULL, `latitude` = NULL, `longitude` = NULL, `visibility` = NULL, `responsible` = NULL, `manager` = NULL, `billableEntity` = NULL, `counts` = NULL, `locations` = NULL, ...) {
    ...
    #'
    #' @return RetailerFullResponse as a base R list.
    #' @examples
    #' # convert array of RetailerFullResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RetailerFullResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RetailerFullResponseObject <- list()
      if (!is.null(self$`retailerId`)) {
        RetailerFullResponseObject[["retailerId"]] <-
          self$`retailerId`
      }
      if (!is.null(self$`name`)) {
        RetailerFullResponseObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`facebookUrl`)) {
        RetailerFullResponseObject[["facebookUrl"]] <-
          self$`facebookUrl`
      }
      if (!is.null(self$`twitterUrl`)) {
        RetailerFullResponseObject[["twitterUrl"]] <-
          self$`twitterUrl`
      }
      if (!is.null(self$`active`)) {
        RetailerFullResponseObject[["active"]] <-
          self$`active`
      }
      if (!is.null(self$`contact`)) {
        RetailerFullResponseObject[["contact"]] <-
          self$extractSimpleType(self$`contact`)
      }
      if (!is.null(self$`logo`)) {
        RetailerFullResponseObject[["logo"]] <-
          self$extractSimpleType(self$`logo`)
      }
      if (!is.null(self$`picture1`)) {
        RetailerFullResponseObject[["picture1"]] <-
          self$extractSimpleType(self$`picture1`)
      }
      if (!is.null(self$`picture2`)) {
        RetailerFullResponseObject[["picture2"]] <-
          self$extractSimpleType(self$`picture2`)
      }
      if (!is.null(self$`latitude`)) {
        RetailerFullResponseObject[["latitude"]] <-
          self$`latitude`
      }
      if (!is.null(self$`longitude`)) {
        RetailerFullResponseObject[["longitude"]] <-
          self$`longitude`
      }
      if (!is.null(self$`visibility`)) {
        RetailerFullResponseObject[["visibility"]] <-
          self$`visibility`
      }
      if (!is.null(self$`responsible`)) {
        RetailerFullResponseObject[["responsible"]] <-
          self$extractSimpleType(self$`responsible`)
      }
      if (!is.null(self$`manager`)) {
        RetailerFullResponseObject[["manager"]] <-
          self$extractSimpleType(self$`manager`)
      }
      if (!is.null(self$`billableEntity`)) {
        RetailerFullResponseObject[["billableEntity"]] <-
          self$extractSimpleType(self$`billableEntity`)
      }
      if (!is.null(self$`counts`)) {
        RetailerFullResponseObject[["counts"]] <-
          self$extractSimpleType(self$`counts`)
      }
      if (!is.null(self$`locations`)) {
        RetailerFullResponseObject[["locations"]] <-
          self$extractSimpleType(self$`locations`)
      }
      return(RetailerFullResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of RetailerFullResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of RetailerFullResponse
    ...
    #' @return RetailerFullResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RetailerFullResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of RetailerFullResponse
    toString = function() {
      self$toJSONString()
    },
...
# RetailerFullResponse$unlock()
#
## Below is an example to define the print function
# RetailerFullResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RetailerFullResponse$lock()
