...
#' @description MissionResponse Class
...
MissionResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new MissionResponse class.
    #'
    #' @param action action
    ...
    #'
    #' @return MissionResponse as a base R list.
    #' @examples
    #' # convert array of MissionResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of MissionResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of MissionResponse
    ...
    #' @return MissionResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MissionResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of MissionResponse
    toString = function() {
      self$toJSONString()
    },
...
# MissionResponse$unlock()
#
## Below is an example to define the print function
# MissionResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MissionResponse$lock()
