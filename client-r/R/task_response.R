...
#' @docType class
#' @title TaskResponse
#' @description TaskResponse Class
...
#' @field taskId  integer [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
TaskResponse <- R6::R6Class(
  "TaskResponse",
  public = list(
    ...
    #' @description
    #' Initialize a new TaskResponse class.
    #'
    ...
    initialize = function(`scheduledNotificationId` = NULL, `active` = NULL, `status` = NULL, `type` = NULL, `name` = NULL, `message` = NULL, `groupingId` = NULL, `scheduledDate` = NULL, `startDate` = NULL, `endDate` = NULL, `owner` = NULL, `billableEntity` = NULL, `contentId` = NULL, `contentName` = NULL, `contentType` = NULL, `parentId` = NULL, `parentType` = NULL, `application` = NULL, `targetId` = NULL, `targetName` = NULL, `targetType` = NULL, `targetParams` = NULL, `deliverEstimate` = NULL, `deliverCount` = NULL, `deliverTotal` = NULL, `deliverFailed` = NULL, `processingTime` = NULL, `sendingTime` = NULL, `updated` = NULL, `created` = NULL, `cronExpression` = NULL, `endpointURL` = NULL, `payload` = NULL, `conditionalInput` = NULL, `connectionAccountIds` = NULL, `templateType` = NULL, `groupedTypes` = NULL, `taskId` = NULL, ...) {
      ...
      if (!is.null(`taskId`)) {
        if (!(is.numeric(`taskId`) && length(`taskId`) == 1)) {
          stop(paste("Error! Invalid data for `taskId`. Must be an integer:", `taskId`))
        }
        self$`taskId` <- `taskId`
      }
    },
    ...
    #'
    #' @return TaskResponse as a base R list.
    #' @examples
    #' # convert array of TaskResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TaskResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TaskResponseObject <- list()
      if (!is.null(self$`scheduledNotificationId`)) {
        TaskResponseObject[["scheduledNotificationId"]] <-
          self$`scheduledNotificationId`
      }
      if (!is.null(self$`active`)) {
        TaskResponseObject[["active"]] <-
          self$`active`
      }
      if (!is.null(self$`status`)) {
        TaskResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`type`)) {
        TaskResponseObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`name`)) {
        TaskResponseObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`message`)) {
        TaskResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`groupingId`)) {
        TaskResponseObject[["groupingId"]] <-
          self$`groupingId`
      }
      if (!is.null(self$`scheduledDate`)) {
        TaskResponseObject[["scheduledDate"]] <-
          self$`scheduledDate`
      }
      if (!is.null(self$`startDate`)) {
        TaskResponseObject[["startDate"]] <-
          self$`startDate`
      }
      if (!is.null(self$`endDate`)) {
        TaskResponseObject[["endDate"]] <-
          self$`endDate`
      }
      if (!is.null(self$`owner`)) {
        TaskResponseObject[["owner"]] <-
          self$extractSimpleType(self$`owner`)
      }
      if (!is.null(self$`billableEntity`)) {
        TaskResponseObject[["billableEntity"]] <-
          self$extractSimpleType(self$`billableEntity`)
      }
      if (!is.null(self$`contentId`)) {
        TaskResponseObject[["contentId"]] <-
          self$`contentId`
      }
      if (!is.null(self$`contentName`)) {
        TaskResponseObject[["contentName"]] <-
          self$`contentName`
      }
      if (!is.null(self$`contentType`)) {
        TaskResponseObject[["contentType"]] <-
          self$`contentType`
      }
      if (!is.null(self$`parentId`)) {
        TaskResponseObject[["parentId"]] <-
          self$`parentId`
      }
      if (!is.null(self$`parentType`)) {
        TaskResponseObject[["parentType"]] <-
          self$`parentType`
      }
      if (!is.null(self$`application`)) {
        TaskResponseObject[["application"]] <-
          self$extractSimpleType(self$`application`)
      }
      if (!is.null(self$`targetId`)) {
        TaskResponseObject[["targetId"]] <-
          self$`targetId`
      }
      if (!is.null(self$`targetName`)) {
        TaskResponseObject[["targetName"]] <-
          self$`targetName`
      }
      if (!is.null(self$`targetType`)) {
        TaskResponseObject[["targetType"]] <-
          self$`targetType`
      }
      if (!is.null(self$`targetParams`)) {
        TaskResponseObject[["targetParams"]] <-
          self$`targetParams`
      }
      if (!is.null(self$`deliverEstimate`)) {
        TaskResponseObject[["deliverEstimate"]] <-
          self$`deliverEstimate`
      }
      if (!is.null(self$`deliverCount`)) {
        TaskResponseObject[["deliverCount"]] <-
          self$`deliverCount`
      }
      if (!is.null(self$`deliverTotal`)) {
        TaskResponseObject[["deliverTotal"]] <-
          self$`deliverTotal`
      }
      if (!is.null(self$`deliverFailed`)) {
        TaskResponseObject[["deliverFailed"]] <-
          self$`deliverFailed`
      }
      if (!is.null(self$`processingTime`)) {
        TaskResponseObject[["processingTime"]] <-
          self$`processingTime`
      }
      if (!is.null(self$`sendingTime`)) {
        TaskResponseObject[["sendingTime"]] <-
          self$`sendingTime`
      }
      if (!is.null(self$`updated`)) {
        TaskResponseObject[["updated"]] <-
          self$`updated`
      }
      if (!is.null(self$`created`)) {
        TaskResponseObject[["created"]] <-
          self$`created`
      }
      if (!is.null(self$`cronExpression`)) {
        TaskResponseObject[["cronExpression"]] <-
          self$`cronExpression`
      }
      if (!is.null(self$`endpointURL`)) {
        TaskResponseObject[["endpointURL"]] <-
          self$`endpointURL`
      }
      if (!is.null(self$`payload`)) {
        TaskResponseObject[["payload"]] <-
          self$`payload`
      }
      if (!is.null(self$`conditionalInput`)) {
        TaskResponseObject[["conditionalInput"]] <-
          self$`conditionalInput`
      }
      if (!is.null(self$`connectionAccountIds`)) {
        TaskResponseObject[["connectionAccountIds"]] <-
          self$`connectionAccountIds`
      }
      if (!is.null(self$`templateType`)) {
        TaskResponseObject[["templateType"]] <-
          self$`templateType`
      }
      if (!is.null(self$`groupedTypes`)) {
        TaskResponseObject[["groupedTypes"]] <-
          self$`groupedTypes`
      }
      if (!is.null(self$`taskId`)) {
        TaskResponseObject[["taskId"]] <-
          self$`taskId`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of TaskResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of TaskResponse
    ...
    #' @return TaskResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TaskResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of TaskResponse
    toString = function() {
      self$toJSONString()
    },
...
# TaskResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
