#' Create a new RoutingListResponse
#'
#' @description
...
#' @description RoutingListResponse Class
...
#' @field items  list(\link{RoutingResponse}) [optional]
...
#' @export
RoutingListResponse <- R6::R6Class(
  "RoutingListResponse",
  public = list(
    `valid` = NULL,
    `message` = NULL,
    ...
    #' @description
    #' Initialize a new RoutingListResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `items` = NULL, `count` = NULL, `debug` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return RoutingListResponse as a base R list.
    #' @examples
    #' # convert array of RoutingListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RoutingListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RoutingListResponseObject <- list()
      if (!is.null(self$`valid`)) {
        RoutingListResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        RoutingListResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        RoutingListResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        RoutingListResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        RoutingListResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        RoutingListResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        RoutingListResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`items`)) {
        RoutingListResponseObject[["items"]] <-
          self$extractSimpleType(self$`items`)
      }
      if (!is.null(self$`count`)) {
        RoutingListResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`debug`)) {
        RoutingListResponseObject[["debug"]] <-
          self$`debug`
      }
      if (!is.null(self$`returning`)) {
        RoutingListResponseObject[["returning"]] <-
          self$`returning`
      }
      return(RoutingListResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of RoutingListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of RoutingListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[RoutingResponse]", loadNamespace("openapi"))
      }
    ...
    #' @return RoutingListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RoutingListResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of RoutingListResponse
    toString = function() {
      self$toJSONString()
    },
...
# RoutingListResponse$unlock()
#
## Below is an example to define the print function
# RoutingListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RoutingListResponse$lock()
