...
#' var_grouping_id <- "grouping_id_example" # character | Client defined identifier for grouping tasks (Optional)
...
#' var_scheduled_date <- 56 # integer | The date and time of the task (Optional)
#' var_start_date <- 56 # integer | The starting date of the task (Optional)
#' var_end_date <- 56 # integer | The ending date of the task (Optional)
#' var_cron_expression <- "cron_expression_example" # character | The cron expression that represents the task's schedule (Optional)
...
#' var_active <- TRUE # character | Sets whether the Task is active or not (inactive Tasks are not processed) (Optional)
#'
#' #Create Task
...
#' var_keyword <- "keyword_example" # character | Keyword search on the task names. (Optional)
...
#' var_cron_expression <- "cron_expression_example" # character | The cron expression that represents the task's schedule (Optional)
#' var_visibility <- "visibility_example" # character | The determines the scope of who is able to find and view the scheduled notification (PUBLIC - openly available to all Sirqul users, PRIVATE - only available to users that have been invited) (Optional)
#' var_active <- "active_example" # character | Sets whether the Task is active or not (inactive Tasks are not processed) (Optional)
#'
#' #Update Task
#' api_instance <- TaskApi$new()
#'
...
TaskApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param grouping_id (optional) Client defined identifier for grouping tasks
    #' @param endpoint_url (optional) The URL for making an HTTP call
    #' @param payload (optional) The parameters for making an HTTP call
    #' @param scheduled_date (optional) The date and time of the task
    #' @param start_date (optional) The starting date of the task
    #' @param end_date (optional) The ending date of the task
    #' @param cron_expression (optional) The cron expression that represents the task's schedule
    ...
    #' @param active (optional) Sets whether the Task is active or not (inactive Tasks are not processed) (default value: TRUE)
    ...
    CreateTaskWithHttpInfo = function(account_id, name, app_key = NULL, grouping_id = NULL, endpoint_url = NULL, payload = NULL, scheduled_date = NULL, start_date = NULL, end_date = NULL, cron_expression = NULL, visibility = NULL, active = TRUE, data_file = NULL, ..., .parse = TRUE) {
      ...
      if (!missing(`account_id`) && is.null(`account_id`)) {
        stop("Invalid value for `account_id` when calling TaskApi$CreateTask, `account_id` is not nullable")
      }

      if (!missing(`name`) && is.null(`name`)) {
        stop("Invalid value for `name` when calling TaskApi$CreateTask, `name` is not nullable")
      }

      if (!missing(`app_key`) && is.null(`app_key`)) {
        stop("Invalid value for `app_key` when calling TaskApi$CreateTask, `app_key` is not nullable")
      }

      if (!missing(`grouping_id`) && is.null(`grouping_id`)) {
        stop("Invalid value for `grouping_id` when calling TaskApi$CreateTask, `grouping_id` is not nullable")
      }

      if (!missing(`endpoint_url`) && is.null(`endpoint_url`)) {
        stop("Invalid value for `endpoint_url` when calling TaskApi$CreateTask, `endpoint_url` is not nullable")
      }

      if (!missing(`payload`) && is.null(`payload`)) {
        stop("Invalid value for `payload` when calling TaskApi$CreateTask, `payload` is not nullable")
      }

      if (!missing(`scheduled_date`) && is.null(`scheduled_date`)) {
        stop("Invalid value for `scheduled_date` when calling TaskApi$CreateTask, `scheduled_date` is not nullable")
      }

      if (!missing(`start_date`) && is.null(`start_date`)) {
        stop("Invalid value for `start_date` when calling TaskApi$CreateTask, `start_date` is not nullable")
      }

      if (!missing(`end_date`) && is.null(`end_date`)) {
        stop("Invalid value for `end_date` when calling TaskApi$CreateTask, `end_date` is not nullable")
      }

      if (!missing(`cron_expression`) && is.null(`cron_expression`)) {
        stop("Invalid value for `cron_expression` when calling TaskApi$CreateTask, `cron_expression` is not nullable")
      }

      if (!missing(`visibility`) && is.null(`visibility`)) {
        stop("Invalid value for `visibility` when calling TaskApi$CreateTask, `visibility` is not nullable")
      }

      if (!missing(`active`) && is.null(`active`)) {
        stop("Invalid value for `active` when calling TaskApi$CreateTask, `active` is not nullable")
      }
      ...
      if (!is.null(`visibility`) && !(`visibility` %in% c("PUBLIC", "PRIVATE", "FRIENDS"))) {
        stop("Invalid value for visibility when calling TaskApi$CreateTask. Must be [PUBLIC, PRIVATE, FRIENDS].")
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "TaskResponse"),
          error = function(e) {
    ...
    DeleteTaskWithHttpInfo = function(account_id, task_id, data_file = NULL, ..., .parse = TRUE) {
      ...
      if (!missing(`account_id`) && is.null(`account_id`)) {
        stop("Invalid value for `account_id` when calling TaskApi$DeleteTask, `account_id` is not nullable")
      }

      if (!missing(`task_id`) && is.null(`task_id`)) {
        stop("Invalid value for `task_id` when calling TaskApi$DeleteTask, `task_id` is not nullable")
      }
    ...
    GetTaskWithHttpInfo = function(account_id, task_id, data_file = NULL, ..., .parse = TRUE) {
      ...
      if (!missing(`account_id`) && is.null(`account_id`)) {
        stop("Invalid value for `account_id` when calling TaskApi$GetTask, `account_id` is not nullable")
      }

      if (!missing(`task_id`) && is.null(`task_id`)) {
        stop("Invalid value for `task_id` when calling TaskApi$GetTask, `task_id` is not nullable")
      }
    ...
    #' @param keyword (optional) Keyword search on the task names.
    ...
    SearchTasksWithHttpInfo = function(account_id, grouping_id = NULL, filter = "MINE", statuses = "NEW,ERROR,COMPLETE,PROCESSING", template_types = NULL, app_key = NULL, keyword = NULL, sort_field = "CREATED", descending = TRUE, start = 0, limit = 20, active_only = TRUE, data_file = NULL, ..., .parse = TRUE) {
      ...
      if (!missing(`account_id`) && is.null(`account_id`)) {
        stop("Invalid value for `account_id` when calling TaskApi$SearchTasks, `account_id` is not nullable")
      }

      if (!missing(`grouping_id`) && is.null(`grouping_id`)) {
        stop("Invalid value for `grouping_id` when calling TaskApi$SearchTasks, `grouping_id` is not nullable")
      }

      if (!missing(`filter`) && is.null(`filter`)) {
        stop("Invalid value for `filter` when calling TaskApi$SearchTasks, `filter` is not nullable")
      }

      if (!missing(`statuses`) && is.null(`statuses`)) {
        stop("Invalid value for `statuses` when calling TaskApi$SearchTasks, `statuses` is not nullable")
      }

      if (!missing(`template_types`) && is.null(`template_types`)) {
        stop("Invalid value for `template_types` when calling TaskApi$SearchTasks, `template_types` is not nullable")
      }

      if (!missing(`app_key`) && is.null(`app_key`)) {
        stop("Invalid value for `app_key` when calling TaskApi$SearchTasks, `app_key` is not nullable")
      }

      if (!missing(`keyword`) && is.null(`keyword`)) {
        stop("Invalid value for `keyword` when calling TaskApi$SearchTasks, `keyword` is not nullable")
      }

      if (!missing(`sort_field`) && is.null(`sort_field`)) {
        stop("Invalid value for `sort_field` when calling TaskApi$SearchTasks, `sort_field` is not nullable")
      }

      if (!missing(`descending`) && is.null(`descending`)) {
        stop("Invalid value for `descending` when calling TaskApi$SearchTasks, `descending` is not nullable")
      }

      if (!missing(`start`) && is.null(`start`)) {
        stop("Invalid value for `start` when calling TaskApi$SearchTasks, `start` is not nullable")
      }

      if (!missing(`limit`) && is.null(`limit`)) {
        stop("Invalid value for `limit` when calling TaskApi$SearchTasks, `limit` is not nullable")
      }

      if (!missing(`active_only`) && is.null(`active_only`)) {
        stop("Invalid value for `active_only` when calling TaskApi$SearchTasks, `active_only` is not nullable")
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "array[TaskResponse]"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    #' @param cron_expression (optional) The cron expression that represents the task's schedule
    #' @param visibility (optional) The determines the scope of who is able to find and view the scheduled notification (PUBLIC - openly available to all Sirqul users, PRIVATE - only available to users that have been invited)
    #' @param active (optional) Sets whether the Task is active or not (inactive Tasks are not processed)
    #' @param data_file (optional) name of the data file to save the result
    #' @param ... Other optional arguments
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    ...
    UpdateTaskWithHttpInfo = function(task_id, account_id, name = NULL, app_key = NULL, grouping_id = NULL, endpoint_url = NULL, payload = NULL, scheduled_date = NULL, start_date = NULL, end_date = NULL, cron_expression = NULL, visibility = NULL, active = NULL, data_file = NULL, ..., .parse = TRUE) {
      ...
      if (!missing(`task_id`) && is.null(`task_id`)) {
        stop("Invalid value for `task_id` when calling TaskApi$UpdateTask, `task_id` is not nullable")
      }

      if (!missing(`account_id`) && is.null(`account_id`)) {
        stop("Invalid value for `account_id` when calling TaskApi$UpdateTask, `account_id` is not nullable")
      }

      if (!missing(`name`) && is.null(`name`)) {
        stop("Invalid value for `name` when calling TaskApi$UpdateTask, `name` is not nullable")
      }

      if (!missing(`app_key`) && is.null(`app_key`)) {
        stop("Invalid value for `app_key` when calling TaskApi$UpdateTask, `app_key` is not nullable")
      }

      if (!missing(`grouping_id`) && is.null(`grouping_id`)) {
        stop("Invalid value for `grouping_id` when calling TaskApi$UpdateTask, `grouping_id` is not nullable")
      }

      if (!missing(`endpoint_url`) && is.null(`endpoint_url`)) {
        stop("Invalid value for `endpoint_url` when calling TaskApi$UpdateTask, `endpoint_url` is not nullable")
      }

      if (!missing(`payload`) && is.null(`payload`)) {
        stop("Invalid value for `payload` when calling TaskApi$UpdateTask, `payload` is not nullable")
      }

      if (!missing(`scheduled_date`) && is.null(`scheduled_date`)) {
        stop("Invalid value for `scheduled_date` when calling TaskApi$UpdateTask, `scheduled_date` is not nullable")
      }

      if (!missing(`start_date`) && is.null(`start_date`)) {
        stop("Invalid value for `start_date` when calling TaskApi$UpdateTask, `start_date` is not nullable")
      }

      if (!missing(`end_date`) && is.null(`end_date`)) {
        stop("Invalid value for `end_date` when calling TaskApi$UpdateTask, `end_date` is not nullable")
      }

      if (!missing(`cron_expression`) && is.null(`cron_expression`)) {
        stop("Invalid value for `cron_expression` when calling TaskApi$UpdateTask, `cron_expression` is not nullable")
      }

      if (!missing(`visibility`) && is.null(`visibility`)) {
        stop("Invalid value for `visibility` when calling TaskApi$UpdateTask, `visibility` is not nullable")
      }

      if (!missing(`active`) && is.null(`active`)) {
        stop("Invalid value for `active` when calling TaskApi$UpdateTask, `active` is not nullable")
      }
      ...
      if (!is.null(`visibility`) && !(`visibility` %in% c("PUBLIC", "PRIVATE", "FRIENDS"))) {
        stop("Invalid value for visibility when calling TaskApi$UpdateTask. Must be [PUBLIC, PRIVATE, FRIENDS].")
      }
      query_params[["visibility"]] <- `visibility`
