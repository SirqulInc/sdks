...
JsonObject <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new JsonObject class.
    #'
    #' @param asInt asInt
    ...
    #'
    #' @return JsonObject as a base R list.
    #' @examples
    #' # convert array of JsonObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of JsonObject
    #'
    #' @param input_json the JSON input
    #' @return the instance of JsonObject
    ...
    #' @return JsonObject in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to JsonObject and throw an exception if invalid
    #'
...
# JsonObject$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
