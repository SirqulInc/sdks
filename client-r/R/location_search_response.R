#' Create a new LocationSearchResponse
#'
#' @description
...
#' @description LocationSearchResponse Class
...
#' @field locations  list(\link{LocationResponse}) [optional]
#' @field returning  character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
LocationSearchResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new LocationSearchResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `count` = NULL, `locations` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return LocationSearchResponse as a base R list.
    #' @examples
    #' # convert array of LocationSearchResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LocationSearchResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LocationSearchResponseObject <- list()
      if (!is.null(self$`valid`)) {
        LocationSearchResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        LocationSearchResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        LocationSearchResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        LocationSearchResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        LocationSearchResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        LocationSearchResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        LocationSearchResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`count`)) {
        LocationSearchResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`locations`)) {
        LocationSearchResponseObject[["locations"]] <-
          self$extractSimpleType(self$`locations`)
      }
      if (!is.null(self$`returning`)) {
        LocationSearchResponseObject[["returning"]] <-
          self$`returning`
      }
      return(LocationSearchResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of LocationSearchResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of LocationSearchResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`locations`)) {
        self$`locations` <- ApiClient$new()$deserializeObj(this_object$`locations`, "array[LocationResponse]", loadNamespace("openapi"))
      }
    ...
    #' @return LocationSearchResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LocationSearchResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of LocationSearchResponse
    toString = function() {
      self$toJSONString()
    },
...
# LocationSearchResponse$unlock()
#
## Below is an example to define the print function
# LocationSearchResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LocationSearchResponse$lock()
