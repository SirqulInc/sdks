#' Create a new ProfileInfoResponse
#'
#' @description
...
#' @description ProfileInfoResponse Class
...
#' @export
ProfileInfoResponse <- R6::R6Class(
  "ProfileInfoResponse",
  public = list(
    `valid` = NULL,
    `message` = NULL,
    ...
    #' @description
    #' Initialize a new ProfileInfoResponse class.
    #'
    #' @param valid valid
    ...
    #'
    #' @return ProfileInfoResponse as a base R list.
    #' @examples
    #' # convert array of ProfileInfoResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProfileInfoResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProfileInfoResponseObject <- list()
      if (!is.null(self$`valid`)) {
        ProfileInfoResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        ProfileInfoResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        ProfileInfoResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        ProfileInfoResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        ProfileInfoResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        ProfileInfoResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        ProfileInfoResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`accountId`)) {
        ProfileInfoResponseObject[["accountId"]] <-
          self$`accountId`
      }
      if (!is.null(self$`locationDisplay`)) {
        ProfileInfoResponseObject[["locationDisplay"]] <-
          self$`locationDisplay`
      }
      if (!is.null(self$`display`)) {
        ProfileInfoResponseObject[["display"]] <-
          self$`display`
      }
      if (!is.null(self$`username`)) {
        ProfileInfoResponseObject[["username"]] <-
          self$`username`
      }
      if (!is.null(self$`profileImage`)) {
        ProfileInfoResponseObject[["profileImage"]] <-
          self$`profileImage`
      }
      if (!is.null(self$`profileAvatar`)) {
        ProfileInfoResponseObject[["profileAvatar"]] <-
          self$extractSimpleType(self$`profileAvatar`)
      }
      if (!is.null(self$`aboutUs`)) {
        ProfileInfoResponseObject[["aboutUs"]] <-
          self$`aboutUs`
      }
      if (!is.null(self$`locale`)) {
        ProfileInfoResponseObject[["locale"]] <-
          self$`locale`
      }
      if (!is.null(self$`summaryTitle`)) {
        ProfileInfoResponseObject[["summaryTitle"]] <-
          self$`summaryTitle`
      }
      if (!is.null(self$`gender`)) {
        ProfileInfoResponseObject[["gender"]] <-
          self$`gender`
      }
      if (!is.null(self$`age`)) {
        ProfileInfoResponseObject[["age"]] <-
          self$`age`
      }
      if (!is.null(self$`gameExperience`)) {
        ProfileInfoResponseObject[["gameExperience"]] <-
          self$`gameExperience`
      }
      if (!is.null(self$`contact`)) {
        ProfileInfoResponseObject[["contact"]] <-
          self$extractSimpleType(self$`contact`)
      }
      if (!is.null(self$`categories`)) {
        ProfileInfoResponseObject[["categories"]] <-
          self$extractSimpleType(self$`categories`)
      }
      if (!is.null(self$`personalProfile`)) {
        ProfileInfoResponseObject[["personalProfile"]] <-
          self$extractSimpleType(self$`personalProfile`)
      }
      if (!is.null(self$`userSettings`)) {
        ProfileInfoResponseObject[["userSettings"]] <-
          self$extractSimpleType(self$`userSettings`)
      }
      if (!is.null(self$`latitude`)) {
        ProfileInfoResponseObject[["latitude"]] <-
          self$`latitude`
      }
      if (!is.null(self$`longitude`)) {
        ProfileInfoResponseObject[["longitude"]] <-
          self$`longitude`
      }
      if (!is.null(self$`currentPostalCode`)) {
        ProfileInfoResponseObject[["currentPostalCode"]] <-
          self$extractSimpleType(self$`currentPostalCode`)
      }
      if (!is.null(self$`accountType`)) {
        ProfileInfoResponseObject[["accountType"]] <-
          self$`accountType`
      }
      if (!is.null(self$`premiumExpiration`)) {
        ProfileInfoResponseObject[["premiumExpiration"]] <-
          self$`premiumExpiration`
      }
      if (!is.null(self$`matchIndex`)) {
        ProfileInfoResponseObject[["matchIndex"]] <-
          self$`matchIndex`
      }
      if (!is.null(self$`tags`)) {
        ProfileInfoResponseObject[["tags"]] <-
          self$`tags`
      }
      if (!is.null(self$`returning`)) {
        ProfileInfoResponseObject[["returning"]] <-
          self$`returning`
      }
      return(ProfileInfoResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of ProfileInfoResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProfileInfoResponse
    ...
    #' @return ProfileInfoResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProfileInfoResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ProfileInfoResponse
    toString = function() {
      self$toJSONString()
    },
...
# ProfileInfoResponse$unlock()
#
## Below is an example to define the print function
# ProfileInfoResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProfileInfoResponse$lock()
