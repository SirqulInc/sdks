#' Create a new AccountListResponse
#'
#' @description
...
#' @description AccountListResponse Class
...
#' @field items  list(\link{AccountResponse}) [optional]
...
#' @export
AccountListResponse <- R6::R6Class(
  "AccountListResponse",
  public = list(
    `valid` = NULL,
    `message` = NULL,
    ...
    #' @description
    #' Initialize a new AccountListResponse class.
    #'
    #' @param valid valid
    ...
    #'
    #' @return AccountListResponse as a base R list.
    #' @examples
    #' # convert array of AccountListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AccountListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AccountListResponseObject <- list()
      if (!is.null(self$`valid`)) {
        AccountListResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        AccountListResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        AccountListResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        AccountListResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        AccountListResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        AccountListResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        AccountListResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`items`)) {
        AccountListResponseObject[["items"]] <-
          self$extractSimpleType(self$`items`)
      }
      if (!is.null(self$`count`)) {
        AccountListResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`hasMoreResults`)) {
        AccountListResponseObject[["hasMoreResults"]] <-
          self$`hasMoreResults`
      }
      if (!is.null(self$`start`)) {
        AccountListResponseObject[["start"]] <-
          self$`start`
      }
      if (!is.null(self$`limit`)) {
        AccountListResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`countTotal`)) {
        AccountListResponseObject[["countTotal"]] <-
          self$`countTotal`
      }
      if (!is.null(self$`returning`)) {
        AccountListResponseObject[["returning"]] <-
          self$`returning`
      }
      return(AccountListResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of AccountListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of AccountListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[AccountResponse]", loadNamespace("openapi"))
      }
    ...
    #' @return AccountListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AccountListResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of AccountListResponse
    toString = function() {
      self$toJSONString()
    },
...
# AccountListResponse$unlock()
#
## Below is an example to define the print function
# AccountListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AccountListResponse$lock()
