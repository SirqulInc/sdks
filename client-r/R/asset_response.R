...
#' @docType class
#' @title AssetResponse
#' @description AssetResponse Class
...
AssetResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AssetResponse class.
    #'
    #' @param valid valid
    ...
    #'
    #' @return AssetResponse as a base R list.
    #' @examples
    #' # convert array of AssetResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AssetResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AssetResponseObject <- list()
      if (!is.null(self$`valid`)) {
        AssetResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        AssetResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        AssetResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        AssetResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        AssetResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        AssetResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        AssetResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`assetId`)) {
        AssetResponseObject[["assetId"]] <-
          self$`assetId`
      }
      if (!is.null(self$`fileName`)) {
        AssetResponseObject[["fileName"]] <-
          self$`fileName`
      }
      if (!is.null(self$`caption`)) {
        AssetResponseObject[["caption"]] <-
          self$`caption`
      }
      if (!is.null(self$`mediaType`)) {
        AssetResponseObject[["mediaType"]] <-
          self$`mediaType`
      }
      if (!is.null(self$`thumbnailURL`)) {
        AssetResponseObject[["thumbnailURL"]] <-
          self$`thumbnailURL`
      }
      if (!is.null(self$`coverURL`)) {
        AssetResponseObject[["coverURL"]] <-
          self$`coverURL`
      }
      if (!is.null(self$`fullURL`)) {
        AssetResponseObject[["fullURL"]] <-
          self$`fullURL`
      }
      if (!is.null(self$`assetVersion`)) {
        AssetResponseObject[["assetVersion"]] <-
          self$`assetVersion`
      }
      if (!is.null(self$`versionName`)) {
        AssetResponseObject[["versionName"]] <-
          self$`versionName`
      }
      if (!is.null(self$`versionCode`)) {
        AssetResponseObject[["versionCode"]] <-
          self$`versionCode`
      }
      if (!is.null(self$`display`)) {
        AssetResponseObject[["display"]] <-
          self$`display`
      }
      if (!is.null(self$`locationDescription`)) {
        AssetResponseObject[["locationDescription"]] <-
          self$`locationDescription`
      }
      if (!is.null(self$`uploader`)) {
        AssetResponseObject[["uploader"]] <-
          self$extractSimpleType(self$`uploader`)
      }
      if (!is.null(self$`likesCount`)) {
        AssetResponseObject[["likesCount"]] <-
          self$`likesCount`
      }
      if (!is.null(self$`commentsCount`)) {
        AssetResponseObject[["commentsCount"]] <-
          self$`commentsCount`
      }
      if (!is.null(self$`latitude`)) {
        AssetResponseObject[["latitude"]] <-
          self$`latitude`
      }
      if (!is.null(self$`longitude`)) {
        AssetResponseObject[["longitude"]] <-
          self$`longitude`
      }
      if (!is.null(self$`attachedMediaType`)) {
        AssetResponseObject[["attachedMediaType"]] <-
          self$`attachedMediaType`
      }
      if (!is.null(self$`attachedAssetURL`)) {
        AssetResponseObject[["attachedAssetURL"]] <-
          self$`attachedAssetURL`
      }
      if (!is.null(self$`created`)) {
        AssetResponseObject[["created"]] <-
          self$`created`
      }
      if (!is.null(self$`updated`)) {
        AssetResponseObject[["updated"]] <-
          self$`updated`
      }
      if (!is.null(self$`searchTags`)) {
        AssetResponseObject[["searchTags"]] <-
          self$`searchTags`
      }
      if (!is.null(self$`metaData`)) {
        AssetResponseObject[["metaData"]] <-
          self$`metaData`
      }
      if (!is.null(self$`returning`)) {
        AssetResponseObject[["returning"]] <-
          self$`returning`
      }
      return(AssetResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of AssetResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of AssetResponse
    ...
    #' @return AssetResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AssetResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of AssetResponse
    toString = function() {
      self$toJSONString()
    },
...
# AssetResponse$unlock()
#
## Below is an example to define the print function
# AssetResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
