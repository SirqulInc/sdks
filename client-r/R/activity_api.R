  ...
  public = list(
    ...
    CreateEntityReferenceWithHttpInfo = function(body, data_file = NULL, ..., .parse = TRUE) {
      ...
      if (!missing(`body`) && is.null(`body`)) {
        stop("Invalid value for `body` when calling ActivityApi$CreateEntityReference, `body` is not nullable")
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "ActivityResponse"),
          error = function(e) {
