...
#' @docType class
#' @title OfferResponse
#' @description OfferResponse Class
...
OfferResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OfferResponse class.
    #'
    #' @param valid valid
    ...
    #'
    #' @return OfferResponse as a base R list.
    #' @examples
    #' # convert array of OfferResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of OfferResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of OfferResponse
    ...
    #' @return OfferResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OfferResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of OfferResponse
    toString = function() {
      self$toJSONString()
    },
...
# OfferResponse$unlock()
#
## Below is an example to define the print function
# OfferResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
