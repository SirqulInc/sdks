...
JsonNull <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new JsonNull class.
    #'
    #' @param asInt asInt
    ...
    #'
    #' @return JsonNull as a base R list.
    #' @examples
    #' # convert array of JsonNull (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of JsonNull
    #'
    #' @param input_json the JSON input
    #' @return the instance of JsonNull
    ...
    #' @return JsonNull in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to JsonNull and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of JsonNull
    toString = function() {
      self$toJSONString()
    },
...
# JsonNull$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
