#' Create a new FilterTreeResponse
#'
#' @description
#' FilterTreeResponse Class
#'
#' @docType class
#' @title FilterTreeResponse
#' @description FilterTreeResponse Class
...
#' @field children  list(\link{FilterTreeResponse}) [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
FilterTreeResponse <- R6::R6Class(
  "FilterTreeResponse",
  public = list(
    `filterId` = NULL,
    `name` = NULL,
    ...
    #' @description
    #' Initialize a new FilterTreeResponse class.
    #'
    ...
    initialize = function(`filterId` = NULL, `name` = NULL, `display` = NULL, `subFilterCount` = NULL, `parentId` = NULL, `description` = NULL, `active` = NULL, `externalId` = NULL, `externalType` = NULL, `children` = NULL, ...) {
      if (!is.null(`filterId`)) {
    ...
    #'
    #' @return FilterTreeResponse as a base R list.
    #' @examples
    #' # convert array of FilterTreeResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert FilterTreeResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      FilterTreeResponseObject <- list()
      if (!is.null(self$`filterId`)) {
        FilterTreeResponseObject[["filterId"]] <-
          self$`filterId`
      }
      if (!is.null(self$`name`)) {
        FilterTreeResponseObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`display`)) {
        FilterTreeResponseObject[["display"]] <-
          self$`display`
      }
      if (!is.null(self$`subFilterCount`)) {
        FilterTreeResponseObject[["subFilterCount"]] <-
          self$`subFilterCount`
      }
      if (!is.null(self$`parentId`)) {
        FilterTreeResponseObject[["parentId"]] <-
          self$`parentId`
      }
      if (!is.null(self$`description`)) {
        FilterTreeResponseObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`active`)) {
        FilterTreeResponseObject[["active"]] <-
          self$`active`
      }
      if (!is.null(self$`externalId`)) {
        FilterTreeResponseObject[["externalId"]] <-
          self$`externalId`
      }
      if (!is.null(self$`externalType`)) {
        FilterTreeResponseObject[["externalType"]] <-
          self$`externalType`
      }
      if (!is.null(self$`children`)) {
        FilterTreeResponseObject[["children"]] <-
          self$extractSimpleType(self$`children`)
      }
      return(FilterTreeResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of FilterTreeResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of FilterTreeResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`children`)) {
        self$`children` <- ApiClient$new()$deserializeObj(this_object$`children`, "array[FilterTreeResponse]", loadNamespace("openapi"))
      }
      self
    },
    ...
    #' @return FilterTreeResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to FilterTreeResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of FilterTreeResponse
    toString = function() {
      self$toJSONString()
    },
...
# FilterTreeResponse$unlock()
#
## Below is an example to define the print function
# FilterTreeResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# FilterTreeResponse$lock()
