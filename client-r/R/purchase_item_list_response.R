#' Create a new PurchaseItemListResponse
#'
#' @description
#' PurchaseItemListResponse Class
#'
#' @docType class
#' @title PurchaseItemListResponse
#' @description PurchaseItemListResponse Class
...
#' @field items  list(\link{PurchaseItemResponse}) [optional]
...
#' @export
PurchaseItemListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PurchaseItemListResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `items` = NULL, `count` = NULL, `hasMoreResults` = NULL, `start` = NULL, `limit` = NULL, `countTotal` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return PurchaseItemListResponse as a base R list.
    #' @examples
    #' # convert array of PurchaseItemListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PurchaseItemListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PurchaseItemListResponseObject <- list()
      if (!is.null(self$`valid`)) {
        PurchaseItemListResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        PurchaseItemListResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        PurchaseItemListResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        PurchaseItemListResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        PurchaseItemListResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        PurchaseItemListResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        PurchaseItemListResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`items`)) {
        PurchaseItemListResponseObject[["items"]] <-
          self$extractSimpleType(self$`items`)
      }
      if (!is.null(self$`count`)) {
        PurchaseItemListResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`hasMoreResults`)) {
        PurchaseItemListResponseObject[["hasMoreResults"]] <-
          self$`hasMoreResults`
      }
      if (!is.null(self$`start`)) {
        PurchaseItemListResponseObject[["start"]] <-
          self$`start`
      }
      if (!is.null(self$`limit`)) {
        PurchaseItemListResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`countTotal`)) {
        PurchaseItemListResponseObject[["countTotal"]] <-
          self$`countTotal`
      }
      if (!is.null(self$`returning`)) {
        PurchaseItemListResponseObject[["returning"]] <-
          self$`returning`
      }
      return(PurchaseItemListResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of PurchaseItemListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of PurchaseItemListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[PurchaseItemResponse]", loadNamespace("openapi"))
      }
    ...
    #' @return PurchaseItemListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PurchaseItemListResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PurchaseItemListResponse
    toString = function() {
      self$toJSONString()
    },
...
# PurchaseItemListResponse$unlock()
#
## Below is an example to define the print function
# PurchaseItemListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PurchaseItemListResponse$lock()
