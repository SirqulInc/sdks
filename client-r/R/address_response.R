...
#' @description AddressResponse Class
...
AddressResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AddressResponse class.
    #'
    ...
    #'
    #' @return AddressResponse as a base R list.
    #' @examples
    #' # convert array of AddressResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AddressResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AddressResponseObject <- list()
      if (!is.null(self$`streetAddress`)) {
        AddressResponseObject[["streetAddress"]] <-
          self$`streetAddress`
      }
      if (!is.null(self$`streetAddress2`)) {
        AddressResponseObject[["streetAddress2"]] <-
          self$`streetAddress2`
      }
      if (!is.null(self$`city`)) {
        AddressResponseObject[["city"]] <-
          self$`city`
      }
      if (!is.null(self$`stateCode`)) {
        AddressResponseObject[["stateCode"]] <-
          self$`stateCode`
      }
      if (!is.null(self$`state`)) {
        AddressResponseObject[["state"]] <-
          self$`state`
      }
      if (!is.null(self$`postalCode`)) {
        AddressResponseObject[["postalCode"]] <-
          self$`postalCode`
      }
      if (!is.null(self$`countryCode`)) {
        AddressResponseObject[["countryCode"]] <-
          self$`countryCode`
      }
      if (!is.null(self$`country`)) {
        AddressResponseObject[["country"]] <-
          self$`country`
      }
      if (!is.null(self$`display`)) {
        AddressResponseObject[["display"]] <-
          self$`display`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of AddressResponse
    #'
    ...
    #' @return AddressResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AddressResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of AddressResponse
    toString = function() {
      self$toJSONString()
    },
...
# AddressResponse$unlock()
#
## Below is an example to define the print function
# AddressResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AddressResponse$lock()
