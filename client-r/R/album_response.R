...
#' @docType class
#' @title AlbumResponse
#' @description AlbumResponse Class
...
AlbumResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AlbumResponse class.
    #'
    #' @param valid valid
    ...
    #'
    #' @return AlbumResponse as a base R list.
    #' @examples
    #' # convert array of AlbumResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AlbumResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AlbumResponseObject <- list()
      if (!is.null(self$`valid`)) {
        AlbumResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        AlbumResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        AlbumResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        AlbumResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        AlbumResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        AlbumResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        AlbumResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`albumId`)) {
        AlbumResponseObject[["albumId"]] <-
          self$`albumId`
      }
      if (!is.null(self$`albumType`)) {
        AlbumResponseObject[["albumType"]] <-
          self$`albumType`
      }
      if (!is.null(self$`ownerId`)) {
        AlbumResponseObject[["ownerId"]] <-
          self$`ownerId`
      }
      if (!is.null(self$`owner`)) {
        AlbumResponseObject[["owner"]] <-
          self$extractSimpleType(self$`owner`)
      }
      if (!is.null(self$`title`)) {
        AlbumResponseObject[["title"]] <-
          self$`title`
      }
      if (!is.null(self$`description`)) {
        AlbumResponseObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`coverAsset`)) {
        AlbumResponseObject[["coverAsset"]] <-
          self$extractSimpleType(self$`coverAsset`)
      }
      if (!is.null(self$`tags`)) {
        AlbumResponseObject[["tags"]] <-
          self$`tags`
      }
      if (!is.null(self$`visibility`)) {
        AlbumResponseObject[["visibility"]] <-
          self$`visibility`
      }
      if (!is.null(self$`startDate`)) {
        AlbumResponseObject[["startDate"]] <-
          self$`startDate`
      }
      if (!is.null(self$`endDate`)) {
        AlbumResponseObject[["endDate"]] <-
          self$`endDate`
      }
      if (!is.null(self$`assetCount`)) {
        AlbumResponseObject[["assetCount"]] <-
          self$`assetCount`
      }
      if (!is.null(self$`likeCount`)) {
        AlbumResponseObject[["likeCount"]] <-
          self$`likeCount`
      }
      if (!is.null(self$`dislikeCount`)) {
        AlbumResponseObject[["dislikeCount"]] <-
          self$`dislikeCount`
      }
      if (!is.null(self$`commentsCount`)) {
        AlbumResponseObject[["commentsCount"]] <-
          self$`commentsCount`
      }
      if (!is.null(self$`userCount`)) {
        AlbumResponseObject[["userCount"]] <-
          self$`userCount`
      }
      if (!is.null(self$`notifications`)) {
        AlbumResponseObject[["notifications"]] <-
          self$`notifications`
      }
      if (!is.null(self$`latitude`)) {
        AlbumResponseObject[["latitude"]] <-
          self$`latitude`
      }
      if (!is.null(self$`longitude`)) {
        AlbumResponseObject[["longitude"]] <-
          self$`longitude`
      }
      if (!is.null(self$`locationDescription`)) {
        AlbumResponseObject[["locationDescription"]] <-
          self$`locationDescription`
      }
      if (!is.null(self$`distance`)) {
        AlbumResponseObject[["distance"]] <-
          self$`distance`
      }
      if (!is.null(self$`dateCreated`)) {
        AlbumResponseObject[["dateCreated"]] <-
          self$`dateCreated`
      }
      if (!is.null(self$`dateUpdated`)) {
        AlbumResponseObject[["dateUpdated"]] <-
          self$`dateUpdated`
      }
      if (!is.null(self$`cellPhone`)) {
        AlbumResponseObject[["cellPhone"]] <-
          self$`cellPhone`
      }
      if (!is.null(self$`fullAddress`)) {
        AlbumResponseObject[["fullAddress"]] <-
          self$`fullAddress`
      }
      if (!is.null(self$`approvalStatus`)) {
        AlbumResponseObject[["approvalStatus"]] <-
          self$`approvalStatus`
      }
      if (!is.null(self$`favoriteCount`)) {
        AlbumResponseObject[["favoriteCount"]] <-
          self$`favoriteCount`
      }
      if (!is.null(self$`liked`)) {
        AlbumResponseObject[["liked"]] <-
          self$`liked`
      }
      if (!is.null(self$`favorite`)) {
        AlbumResponseObject[["favorite"]] <-
          self$`favorite`
      }
      if (!is.null(self$`favoriteId`)) {
        AlbumResponseObject[["favoriteId"]] <-
          self$`favoriteId`
      }
      if (!is.null(self$`anonymous`)) {
        AlbumResponseObject[["anonymous"]] <-
          self$`anonymous`
      }
      if (!is.null(self$`flagCount`)) {
        AlbumResponseObject[["flagCount"]] <-
          self$`flagCount`
      }
      if (!is.null(self$`viewedCount`)) {
        AlbumResponseObject[["viewedCount"]] <-
          self$`viewedCount`
      }
      if (!is.null(self$`clickedCount`)) {
        AlbumResponseObject[["clickedCount"]] <-
          self$`clickedCount`
      }
      if (!is.null(self$`sharedCount`)) {
        AlbumResponseObject[["sharedCount"]] <-
          self$`sharedCount`
      }
      if (!is.null(self$`returning`)) {
        AlbumResponseObject[["returning"]] <-
          self$`returning`
      }
      return(AlbumResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of AlbumResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of AlbumResponse
    ...
    #' @return AlbumResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AlbumResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of AlbumResponse
    toString = function() {
      self$toJSONString()
    },
...
# AlbumResponse$unlock()
#
## Below is an example to define the print function
# AlbumResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
