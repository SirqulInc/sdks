#' Create a new MediaOfferResponse
#'
#' @description
#' MediaOfferResponse Class
#'
#' @docType class
#' @title MediaOfferResponse
#' @description MediaOfferResponse Class
...
MediaOfferResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new MediaOfferResponse class.
    #'
    #' @param title title
    ...
    #'
    #' @return MediaOfferResponse as a base R list.
    #' @examples
    #' # convert array of MediaOfferResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MediaOfferResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      MediaOfferResponseObject <- list()
      if (!is.null(self$`title`)) {
        MediaOfferResponseObject[["title"]] <-
          self$`title`
      }
      if (!is.null(self$`details`)) {
        MediaOfferResponseObject[["details"]] <-
          self$`details`
      }
      if (!is.null(self$`subTitle`)) {
        MediaOfferResponseObject[["subTitle"]] <-
          self$`subTitle`
      }
      if (!is.null(self$`activated`)) {
        MediaOfferResponseObject[["activated"]] <-
          self$`activated`
      }
      if (!is.null(self$`expiration`)) {
        MediaOfferResponseObject[["expiration"]] <-
          self$`expiration`
      }
      if (!is.null(self$`redeemableStart`)) {
        MediaOfferResponseObject[["redeemableStart"]] <-
          self$`redeemableStart`
      }
      if (!is.null(self$`redeemableEnd`)) {
        MediaOfferResponseObject[["redeemableEnd"]] <-
          self$`redeemableEnd`
      }
      if (!is.null(self$`offerType`)) {
        MediaOfferResponseObject[["offerType"]] <-
          self$`offerType`
      }
      if (!is.null(self$`offerVisibility`)) {
        MediaOfferResponseObject[["offerVisibility"]] <-
          self$`offerVisibility`
      }
      if (!is.null(self$`favorite`)) {
        MediaOfferResponseObject[["favorite"]] <-
          self$`favorite`
      }
      if (!is.null(self$`deleted`)) {
        MediaOfferResponseObject[["deleted"]] <-
          self$`deleted`
      }
      if (!is.null(self$`fullPrice`)) {
        MediaOfferResponseObject[["fullPrice"]] <-
          self$`fullPrice`
      }
      if (!is.null(self$`discountPrice`)) {
        MediaOfferResponseObject[["discountPrice"]] <-
          self$`discountPrice`
      }
      if (!is.null(self$`image`)) {
        MediaOfferResponseObject[["image"]] <-
          self$`image`
      }
      if (!is.null(self$`image1`)) {
        MediaOfferResponseObject[["image1"]] <-
          self$`image1`
      }
      if (!is.null(self$`image2`)) {
        MediaOfferResponseObject[["image2"]] <-
          self$`image2`
      }
      if (!is.null(self$`image3`)) {
        MediaOfferResponseObject[["image3"]] <-
          self$`image3`
      }
      if (!is.null(self$`image4`)) {
        MediaOfferResponseObject[["image4"]] <-
          self$`image4`
      }
      if (!is.null(self$`image5`)) {
        MediaOfferResponseObject[["image5"]] <-
          self$`image5`
      }
      if (!is.null(self$`images`)) {
        MediaOfferResponseObject[["images"]] <-
          self$extractSimpleType(self$`images`)
      }
      if (!is.null(self$`barcode`)) {
        MediaOfferResponseObject[["barcode"]] <-
          self$`barcode`
      }
      if (!is.null(self$`externalUrl`)) {
        MediaOfferResponseObject[["externalUrl"]] <-
          self$`externalUrl`
      }
      if (!is.null(self$`active`)) {
        MediaOfferResponseObject[["active"]] <-
          self$`active`
      }
      if (!is.null(self$`subDetails`)) {
        MediaOfferResponseObject[["subDetails"]] <-
          self$`subDetails`
      }
      if (!is.null(self$`externalRedeemOptions`)) {
        MediaOfferResponseObject[["externalRedeemOptions"]] <-
          self$`externalRedeemOptions`
      }
      if (!is.null(self$`publisher`)) {
        MediaOfferResponseObject[["publisher"]] <-
          self$`publisher`
      }
      if (!is.null(self$`viewedCount`)) {
        MediaOfferResponseObject[["viewedCount"]] <-
          self$`viewedCount`
      }
      if (!is.null(self$`clickedCount`)) {
        MediaOfferResponseObject[["clickedCount"]] <-
          self$`clickedCount`
      }
      if (!is.null(self$`addedLimit`)) {
        MediaOfferResponseObject[["addedLimit"]] <-
          self$`addedLimit`
      }
      if (!is.null(self$`addedCount`)) {
        MediaOfferResponseObject[["addedCount"]] <-
          self$`addedCount`
      }
      if (!is.null(self$`usedCount`)) {
        MediaOfferResponseObject[["usedCount"]] <-
          self$`usedCount`
      }
      if (!is.null(self$`removedCount`)) {
        MediaOfferResponseObject[["removedCount"]] <-
          self$`removedCount`
      }
      if (!is.null(self$`ticketsReward`)) {
        MediaOfferResponseObject[["ticketsReward"]] <-
          self$`ticketsReward`
      }
      if (!is.null(self$`ticketsRewardType`)) {
        MediaOfferResponseObject[["ticketsRewardType"]] <-
          self$`ticketsRewardType`
      }
      if (!is.null(self$`specialOfferType`)) {
        MediaOfferResponseObject[["specialOfferType"]] <-
          self$`specialOfferType`
      }
      if (!is.null(self$`likeCount`)) {
        MediaOfferResponseObject[["likeCount"]] <-
          self$`likeCount`
      }
      if (!is.null(self$`dislikeCount`)) {
        MediaOfferResponseObject[["dislikeCount"]] <-
          self$`dislikeCount`
      }
      if (!is.null(self$`favoriteCount`)) {
        MediaOfferResponseObject[["favoriteCount"]] <-
          self$`favoriteCount`
      }
      if (!is.null(self$`noteCount`)) {
        MediaOfferResponseObject[["noteCount"]] <-
          self$`noteCount`
      }
      if (!is.null(self$`billableEntityId`)) {
        MediaOfferResponseObject[["billableEntityId"]] <-
          self$`billableEntityId`
      }
      if (!is.null(self$`responsibleAccountId`)) {
        MediaOfferResponseObject[["responsibleAccountId"]] <-
          self$`responsibleAccountId`
      }
      if (!is.null(self$`availabilitySummary`)) {
        MediaOfferResponseObject[["availabilitySummary"]] <-
          self$`availabilitySummary`
      }
      if (!is.null(self$`flagCount`)) {
        MediaOfferResponseObject[["flagCount"]] <-
          self$`flagCount`
      }
      if (!is.null(self$`flagThreshold`)) {
        MediaOfferResponseObject[["flagThreshold"]] <-
          self$`flagThreshold`
      }
      if (!is.null(self$`externalId`)) {
        MediaOfferResponseObject[["externalId"]] <-
          self$`externalId`
      }
      if (!is.null(self$`parentOffer`)) {
        MediaOfferResponseObject[["parentOffer"]] <-
          self$extractSimpleType(self$`parentOffer`)
      }
      if (!is.null(self$`categories`)) {
        MediaOfferResponseObject[["categories"]] <-
          self$extractSimpleType(self$`categories`)
      }
      if (!is.null(self$`filters`)) {
        MediaOfferResponseObject[["filters"]] <-
          self$extractSimpleType(self$`filters`)
      }
      return(MediaOfferResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of MediaOfferResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of MediaOfferResponse
    ...
    #' @return MediaOfferResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MediaOfferResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of MediaOfferResponse
    toString = function() {
      self$toJSONString()
    },
...
# MediaOfferResponse$unlock()
#
## Below is an example to define the print function
# MediaOfferResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MediaOfferResponse$lock()
