#' Create a new OfferShortResponse
#'
#' @description
#' OfferShortResponse Class
#'
#' @docType class
#' @title OfferShortResponse
#' @description OfferShortResponse Class
...
OfferShortResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OfferShortResponse class.
    #'
    #' @param valid valid
    ...
    #'
    #' @return OfferShortResponse as a base R list.
    #' @examples
    #' # convert array of OfferShortResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OfferShortResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      OfferShortResponseObject <- list()
      if (!is.null(self$`valid`)) {
        OfferShortResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        OfferShortResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        OfferShortResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        OfferShortResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        OfferShortResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        OfferShortResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        OfferShortResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`offerLocationId`)) {
        OfferShortResponseObject[["offerLocationId"]] <-
          self$`offerLocationId`
      }
      if (!is.null(self$`offerId`)) {
        OfferShortResponseObject[["offerId"]] <-
          self$`offerId`
      }
      if (!is.null(self$`retailerId`)) {
        OfferShortResponseObject[["retailerId"]] <-
          self$`retailerId`
      }
      if (!is.null(self$`transactionId`)) {
        OfferShortResponseObject[["transactionId"]] <-
          self$`transactionId`
      }
      if (!is.null(self$`favoriteId`)) {
        OfferShortResponseObject[["favoriteId"]] <-
          self$`favoriteId`
      }
      if (!is.null(self$`offerName`)) {
        OfferShortResponseObject[["offerName"]] <-
          self$`offerName`
      }
      if (!is.null(self$`subTitle`)) {
        OfferShortResponseObject[["subTitle"]] <-
          self$`subTitle`
      }
      if (!is.null(self$`locationName`)) {
        OfferShortResponseObject[["locationName"]] <-
          self$`locationName`
      }
      if (!is.null(self$`starts`)) {
        OfferShortResponseObject[["starts"]] <-
          self$`starts`
      }
      if (!is.null(self$`expires`)) {
        OfferShortResponseObject[["expires"]] <-
          self$`expires`
      }
      if (!is.null(self$`activated`)) {
        OfferShortResponseObject[["activated"]] <-
          self$`activated`
      }
      if (!is.null(self$`expiration`)) {
        OfferShortResponseObject[["expiration"]] <-
          self$`expiration`
      }
      if (!is.null(self$`redeemableStart`)) {
        OfferShortResponseObject[["redeemableStart"]] <-
          self$`redeemableStart`
      }
      if (!is.null(self$`redeemableEnd`)) {
        OfferShortResponseObject[["redeemableEnd"]] <-
          self$`redeemableEnd`
      }
      if (!is.null(self$`distance`)) {
        OfferShortResponseObject[["distance"]] <-
          self$`distance`
      }
      if (!is.null(self$`offerType`)) {
        OfferShortResponseObject[["offerType"]] <-
          self$`offerType`
      }
      if (!is.null(self$`longitude`)) {
        OfferShortResponseObject[["longitude"]] <-
          self$`longitude`
      }
      if (!is.null(self$`latitude`)) {
        OfferShortResponseObject[["latitude"]] <-
          self$`latitude`
      }
      if (!is.null(self$`favorite`)) {
        OfferShortResponseObject[["favorite"]] <-
          self$`favorite`
      }
      if (!is.null(self$`fullPrice`)) {
        OfferShortResponseObject[["fullPrice"]] <-
          self$`fullPrice`
      }
      if (!is.null(self$`discountPrice`)) {
        OfferShortResponseObject[["discountPrice"]] <-
          self$`discountPrice`
      }
      if (!is.null(self$`estimatedValue`)) {
        OfferShortResponseObject[["estimatedValue"]] <-
          self$`estimatedValue`
      }
      if (!is.null(self$`voucherDiscountPrice`)) {
        OfferShortResponseObject[["voucherDiscountPrice"]] <-
          self$`voucherDiscountPrice`
      }
      if (!is.null(self$`missionListResponse`)) {
        OfferShortResponseObject[["missionListResponse"]] <-
          self$extractSimpleType(self$`missionListResponse`)
      }
      if (!is.null(self$`image`)) {
        OfferShortResponseObject[["image"]] <-
          self$`image`
      }
      if (!is.null(self$`image1`)) {
        OfferShortResponseObject[["image1"]] <-
          self$`image1`
      }
      if (!is.null(self$`image2`)) {
        OfferShortResponseObject[["image2"]] <-
          self$`image2`
      }
      if (!is.null(self$`image3`)) {
        OfferShortResponseObject[["image3"]] <-
          self$`image3`
      }
      if (!is.null(self$`image4`)) {
        OfferShortResponseObject[["image4"]] <-
          self$`image4`
      }
      if (!is.null(self$`image5`)) {
        OfferShortResponseObject[["image5"]] <-
          self$`image5`
      }
      if (!is.null(self$`images`)) {
        OfferShortResponseObject[["images"]] <-
          self$extractSimpleType(self$`images`)
      }
      if (!is.null(self$`barcode`)) {
        OfferShortResponseObject[["barcode"]] <-
          self$`barcode`
      }
      if (!is.null(self$`externalUrl`)) {
        OfferShortResponseObject[["externalUrl"]] <-
          self$`externalUrl`
      }
      if (!is.null(self$`sqootUrl`)) {
        OfferShortResponseObject[["sqootUrl"]] <-
          self$`sqootUrl`
      }
      if (!is.null(self$`active`)) {
        OfferShortResponseObject[["active"]] <-
          self$`active`
      }
      if (!is.null(self$`location`)) {
        OfferShortResponseObject[["location"]] <-
          self$extractSimpleType(self$`location`)
      }
      if (!is.null(self$`subDetails`)) {
        OfferShortResponseObject[["subDetails"]] <-
          self$`subDetails`
      }
      if (!is.null(self$`externalRedeemAuth`)) {
        OfferShortResponseObject[["externalRedeemAuth"]] <-
          self$`externalRedeemAuth`
      }
      if (!is.null(self$`externalRedeemOptions`)) {
        OfferShortResponseObject[["externalRedeemOptions"]] <-
          self$`externalRedeemOptions`
      }
      if (!is.null(self$`publisher`)) {
        OfferShortResponseObject[["publisher"]] <-
          self$`publisher`
      }
      if (!is.null(self$`product`)) {
        OfferShortResponseObject[["product"]] <-
          self$extractSimpleType(self$`product`)
      }
      if (!is.null(self$`event`)) {
        OfferShortResponseObject[["event"]] <-
          self$extractSimpleType(self$`event`)
      }
      if (!is.null(self$`media`)) {
        OfferShortResponseObject[["media"]] <-
          self$extractSimpleType(self$`media`)
      }
      if (!is.null(self$`viewedCount`)) {
        OfferShortResponseObject[["viewedCount"]] <-
          self$`viewedCount`
      }
      if (!is.null(self$`clickedCount`)) {
        OfferShortResponseObject[["clickedCount"]] <-
          self$`clickedCount`
      }
      if (!is.null(self$`addedLimit`)) {
        OfferShortResponseObject[["addedLimit"]] <-
          self$`addedLimit`
      }
      if (!is.null(self$`addedCount`)) {
        OfferShortResponseObject[["addedCount"]] <-
          self$`addedCount`
      }
      if (!is.null(self$`usedCount`)) {
        OfferShortResponseObject[["usedCount"]] <-
          self$`usedCount`
      }
      if (!is.null(self$`removedCount`)) {
        OfferShortResponseObject[["removedCount"]] <-
          self$`removedCount`
      }
      if (!is.null(self$`locationAddedCount`)) {
        OfferShortResponseObject[["locationAddedCount"]] <-
          self$`locationAddedCount`
      }
      if (!is.null(self$`barcodeEntry`)) {
        OfferShortResponseObject[["barcodeEntry"]] <-
          self$`barcodeEntry`
      }
      if (!is.null(self$`barcodeType`)) {
        OfferShortResponseObject[["barcodeType"]] <-
          self$`barcodeType`
      }
      if (!is.null(self$`ticketsReward`)) {
        OfferShortResponseObject[["ticketsReward"]] <-
          self$`ticketsReward`
      }
      if (!is.null(self$`ticketsRewardType`)) {
        OfferShortResponseObject[["ticketsRewardType"]] <-
          self$`ticketsRewardType`
      }
      if (!is.null(self$`specialOfferType`)) {
        OfferShortResponseObject[["specialOfferType"]] <-
          self$`specialOfferType`
      }
      if (!is.null(self$`likeCount`)) {
        OfferShortResponseObject[["likeCount"]] <-
          self$`likeCount`
      }
      if (!is.null(self$`dislikeCount`)) {
        OfferShortResponseObject[["dislikeCount"]] <-
          self$`dislikeCount`
      }
      if (!is.null(self$`favoriteCount`)) {
        OfferShortResponseObject[["favoriteCount"]] <-
          self$`favoriteCount`
      }
      if (!is.null(self$`noteCount`)) {
        OfferShortResponseObject[["noteCount"]] <-
          self$`noteCount`
      }
      if (!is.null(self$`logId`)) {
        OfferShortResponseObject[["logId"]] <-
          self$`logId`
      }
      if (!is.null(self$`billableEntityId`)) {
        OfferShortResponseObject[["billableEntityId"]] <-
          self$`billableEntityId`
      }
      if (!is.null(self$`responsibleAccountId`)) {
        OfferShortResponseObject[["responsibleAccountId"]] <-
          self$`responsibleAccountId`
      }
      if (!is.null(self$`availabilitySummary`)) {
        OfferShortResponseObject[["availabilitySummary"]] <-
          self$`availabilitySummary`
      }
      if (!is.null(self$`externalId`)) {
        OfferShortResponseObject[["externalId"]] <-
          self$`externalId`
      }
      if (!is.null(self$`parentOffer`)) {
        OfferShortResponseObject[["parentOffer"]] <-
          self$extractSimpleType(self$`parentOffer`)
      }
      if (!is.null(self$`returning`)) {
        OfferShortResponseObject[["returning"]] <-
          self$`returning`
      }
      return(OfferShortResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of OfferShortResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of OfferShortResponse
    ...
    #' @return OfferShortResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OfferShortResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of OfferShortResponse
    toString = function() {
      self$toJSONString()
    },
...
# OfferShortResponse$unlock()
#
## Below is an example to define the print function
# OfferShortResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OfferShortResponse$lock()
