#' Create a new SirqulResponse
#'
#' @description
#' SirqulResponse Class
#'
#' @docType class
#' @title SirqulResponse
#' @description SirqulResponse Class
...
SirqulResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new SirqulResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return SirqulResponse as a base R list.
    #' @examples
    #' # convert array of SirqulResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SirqulResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SirqulResponseObject <- list()
      if (!is.null(self$`valid`)) {
        SirqulResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        SirqulResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        SirqulResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        SirqulResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        SirqulResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        SirqulResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        SirqulResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`returning`)) {
        SirqulResponseObject[["returning"]] <-
          self$`returning`
      }
      return(SirqulResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of SirqulResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of SirqulResponse
    ...
    #' @return SirqulResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to SirqulResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SirqulResponse
    toString = function() {
      self$toJSONString()
    },
...
# SirqulResponse$unlock()
#
## Below is an example to define the print function
# SirqulResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
