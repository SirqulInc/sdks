...
TokenResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TokenResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `token` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return TokenResponse as a base R list.
    #' @examples
    #' # convert array of TokenResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TokenResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TokenResponseObject <- list()
      if (!is.null(self$`valid`)) {
        TokenResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        TokenResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        TokenResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        TokenResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        TokenResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        TokenResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        TokenResponseObject[["request"]] <-
    ...
    #' @description
    #' Deserialize JSON string into an instance of TokenResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of TokenResponse
    ...
    #' @return TokenResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TokenResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of TokenResponse
    toString = function() {
      self$toJSONString()
    },
...
# TokenResponse$unlock()
#
## Below is an example to define the print function
# TokenResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
