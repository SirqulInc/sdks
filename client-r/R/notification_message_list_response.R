#' Create a new NotificationMessageListResponse
#'
#' @description
#' NotificationMessageListResponse Class
#'
#' @docType class
#' @title NotificationMessageListResponse
#' @description NotificationMessageListResponse Class
...
#' @field items  list(\link{NotificationMessageResponse}) [optional]
...
#' @export
NotificationMessageListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new NotificationMessageListResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `items` = NULL, `count` = NULL, `hasMoreResults` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return NotificationMessageListResponse as a base R list.
    #' @examples
    #' # convert array of NotificationMessageListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert NotificationMessageListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      NotificationMessageListResponseObject <- list()
      if (!is.null(self$`valid`)) {
        NotificationMessageListResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        NotificationMessageListResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        NotificationMessageListResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        NotificationMessageListResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        NotificationMessageListResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        NotificationMessageListResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        NotificationMessageListResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`items`)) {
        NotificationMessageListResponseObject[["items"]] <-
          self$extractSimpleType(self$`items`)
      }
      if (!is.null(self$`count`)) {
        NotificationMessageListResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`hasMoreResults`)) {
        NotificationMessageListResponseObject[["hasMoreResults"]] <-
          self$`hasMoreResults`
      }
      if (!is.null(self$`returning`)) {
        NotificationMessageListResponseObject[["returning"]] <-
          self$`returning`
      }
      return(NotificationMessageListResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of NotificationMessageListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of NotificationMessageListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[NotificationMessageResponse]", loadNamespace("openapi"))
      }
    ...
    #' @return NotificationMessageListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to NotificationMessageListResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of NotificationMessageListResponse
    toString = function() {
      self$toJSONString()
    },
...
# NotificationMessageListResponse$unlock()
#
## Below is an example to define the print function
# NotificationMessageListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# NotificationMessageListResponse$lock()
