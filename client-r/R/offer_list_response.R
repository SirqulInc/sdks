#' Create a new OfferListResponse
#'
#' @description
...
#' @description OfferListResponse Class
...
#' @field items  list(\link{OfferResponse}) [optional]
...
OfferListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OfferListResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `items` = NULL, `hasMoreResults` = NULL, `count` = NULL, `start` = NULL, `limit` = NULL, `countTotal` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return OfferListResponse as a base R list.
    #' @examples
    #' # convert array of OfferListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OfferListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      OfferListResponseObject <- list()
      if (!is.null(self$`valid`)) {
        OfferListResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        OfferListResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        OfferListResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        OfferListResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        OfferListResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        OfferListResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        OfferListResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`items`)) {
        OfferListResponseObject[["items"]] <-
          self$extractSimpleType(self$`items`)
      }
      if (!is.null(self$`hasMoreResults`)) {
        OfferListResponseObject[["hasMoreResults"]] <-
          self$`hasMoreResults`
      }
      if (!is.null(self$`count`)) {
        OfferListResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`start`)) {
        OfferListResponseObject[["start"]] <-
          self$`start`
      }
      if (!is.null(self$`limit`)) {
        OfferListResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`countTotal`)) {
        OfferListResponseObject[["countTotal"]] <-
          self$`countTotal`
      }
      if (!is.null(self$`returning`)) {
        OfferListResponseObject[["returning"]] <-
          self$`returning`
      }
      return(OfferListResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of OfferListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of OfferListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`items`)) {
        self$`items` <- ApiClient$new()$deserializeObj(this_object$`items`, "array[OfferResponse]", loadNamespace("openapi"))
      }
    ...
    #' @return OfferListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OfferListResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of OfferListResponse
    toString = function() {
      self$toJSONString()
    },
...
# OfferListResponse$unlock()
#
## Below is an example to define the print function
# OfferListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OfferListResponse$lock()
