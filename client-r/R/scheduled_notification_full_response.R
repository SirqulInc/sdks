#' Create a new ScheduledNotificationFullResponse
#'
#' @description
#' ScheduledNotificationFullResponse Class
#'
#' @docType class
#' @title ScheduledNotificationFullResponse
#' @description ScheduledNotificationFullResponse Class
...
#' @export
ScheduledNotificationFullResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ScheduledNotificationFullResponse class.
    #'
    ...
    #'
    #' @return ScheduledNotificationFullResponse as a base R list.
    #' @examples
    #' # convert array of ScheduledNotificationFullResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ScheduledNotificationFullResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ScheduledNotificationFullResponseObject <- list()
      if (!is.null(self$`scheduledNotificationId`)) {
        ScheduledNotificationFullResponseObject[["scheduledNotificationId"]] <-
          self$`scheduledNotificationId`
      }
      if (!is.null(self$`active`)) {
        ScheduledNotificationFullResponseObject[["active"]] <-
          self$`active`
      }
      if (!is.null(self$`status`)) {
        ScheduledNotificationFullResponseObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`type`)) {
        ScheduledNotificationFullResponseObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`name`)) {
        ScheduledNotificationFullResponseObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`message`)) {
        ScheduledNotificationFullResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`groupingId`)) {
        ScheduledNotificationFullResponseObject[["groupingId"]] <-
          self$`groupingId`
      }
      if (!is.null(self$`scheduledDate`)) {
        ScheduledNotificationFullResponseObject[["scheduledDate"]] <-
          self$`scheduledDate`
      }
      if (!is.null(self$`startDate`)) {
        ScheduledNotificationFullResponseObject[["startDate"]] <-
          self$`startDate`
      }
      if (!is.null(self$`endDate`)) {
        ScheduledNotificationFullResponseObject[["endDate"]] <-
          self$`endDate`
      }
      if (!is.null(self$`owner`)) {
        ScheduledNotificationFullResponseObject[["owner"]] <-
          self$extractSimpleType(self$`owner`)
      }
      if (!is.null(self$`billableEntity`)) {
        ScheduledNotificationFullResponseObject[["billableEntity"]] <-
          self$extractSimpleType(self$`billableEntity`)
      }
      if (!is.null(self$`contentId`)) {
        ScheduledNotificationFullResponseObject[["contentId"]] <-
          self$`contentId`
      }
      if (!is.null(self$`contentName`)) {
        ScheduledNotificationFullResponseObject[["contentName"]] <-
          self$`contentName`
      }
      if (!is.null(self$`contentType`)) {
        ScheduledNotificationFullResponseObject[["contentType"]] <-
          self$`contentType`
      }
      if (!is.null(self$`parentId`)) {
        ScheduledNotificationFullResponseObject[["parentId"]] <-
          self$`parentId`
      }
      if (!is.null(self$`parentType`)) {
        ScheduledNotificationFullResponseObject[["parentType"]] <-
          self$`parentType`
      }
      if (!is.null(self$`application`)) {
        ScheduledNotificationFullResponseObject[["application"]] <-
          self$extractSimpleType(self$`application`)
      }
      if (!is.null(self$`targetId`)) {
        ScheduledNotificationFullResponseObject[["targetId"]] <-
          self$`targetId`
      }
      if (!is.null(self$`targetName`)) {
        ScheduledNotificationFullResponseObject[["targetName"]] <-
          self$`targetName`
      }
      if (!is.null(self$`targetType`)) {
        ScheduledNotificationFullResponseObject[["targetType"]] <-
          self$`targetType`
      }
      if (!is.null(self$`targetParams`)) {
        ScheduledNotificationFullResponseObject[["targetParams"]] <-
          self$`targetParams`
      }
      if (!is.null(self$`deliverEstimate`)) {
        ScheduledNotificationFullResponseObject[["deliverEstimate"]] <-
          self$`deliverEstimate`
      }
      if (!is.null(self$`deliverCount`)) {
        ScheduledNotificationFullResponseObject[["deliverCount"]] <-
          self$`deliverCount`
      }
      if (!is.null(self$`deliverTotal`)) {
        ScheduledNotificationFullResponseObject[["deliverTotal"]] <-
          self$`deliverTotal`
      }
      if (!is.null(self$`deliverFailed`)) {
        ScheduledNotificationFullResponseObject[["deliverFailed"]] <-
          self$`deliverFailed`
      }
      if (!is.null(self$`processingTime`)) {
        ScheduledNotificationFullResponseObject[["processingTime"]] <-
          self$`processingTime`
      }
      if (!is.null(self$`sendingTime`)) {
        ScheduledNotificationFullResponseObject[["sendingTime"]] <-
          self$`sendingTime`
      }
      if (!is.null(self$`updated`)) {
        ScheduledNotificationFullResponseObject[["updated"]] <-
          self$`updated`
      }
      if (!is.null(self$`created`)) {
        ScheduledNotificationFullResponseObject[["created"]] <-
          self$`created`
      }
      if (!is.null(self$`cronExpression`)) {
        ScheduledNotificationFullResponseObject[["cronExpression"]] <-
          self$`cronExpression`
      }
      if (!is.null(self$`endpointURL`)) {
        ScheduledNotificationFullResponseObject[["endpointURL"]] <-
          self$`endpointURL`
      }
      if (!is.null(self$`payload`)) {
        ScheduledNotificationFullResponseObject[["payload"]] <-
          self$`payload`
      }
      if (!is.null(self$`conditionalInput`)) {
        ScheduledNotificationFullResponseObject[["conditionalInput"]] <-
          self$`conditionalInput`
      }
      if (!is.null(self$`connectionAccountIds`)) {
        ScheduledNotificationFullResponseObject[["connectionAccountIds"]] <-
          self$`connectionAccountIds`
      }
      if (!is.null(self$`templateType`)) {
        ScheduledNotificationFullResponseObject[["templateType"]] <-
          self$`templateType`
      }
      if (!is.null(self$`groupedTypes`)) {
        ScheduledNotificationFullResponseObject[["groupedTypes"]] <-
          self$`groupedTypes`
      }
      return(ScheduledNotificationFullResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of ScheduledNotificationFullResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ScheduledNotificationFullResponse
    ...
    #' @return ScheduledNotificationFullResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ScheduledNotificationFullResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ScheduledNotificationFullResponse
    toString = function() {
      self$toJSONString()
    },
...
# ScheduledNotificationFullResponse$unlock()
#
## Below is an example to define the print function
# ScheduledNotificationFullResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ScheduledNotificationFullResponse$lock()
