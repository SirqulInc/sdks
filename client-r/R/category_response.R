...
#' @description CategoryResponse Class
...
CategoryResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CategoryResponse class.
    #'
    ...
    initialize = function(`categoryId` = NULL, `name` = NULL, `display` = NULL, `subCategoryCount` = NULL, `parentId` = NULL, `parentName` = NULL, `description` = NULL, `active` = NULL, `asset` = NULL, `favoriteId` = NULL, `favorite` = NULL, `applicationId` = NULL, `type` = NULL, `externalId` = NULL, `externalType` = NULL, ...) {
    ...
    #'
    #' @return CategoryResponse as a base R list.
    #' @examples
    #' # convert array of CategoryResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CategoryResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CategoryResponseObject <- list()
      if (!is.null(self$`categoryId`)) {
        CategoryResponseObject[["categoryId"]] <-
          self$`categoryId`
      }
      if (!is.null(self$`name`)) {
        CategoryResponseObject[["name"]] <-
          self$`name`
      }
      if (!is.null(self$`display`)) {
        CategoryResponseObject[["display"]] <-
          self$`display`
      }
      if (!is.null(self$`subCategoryCount`)) {
        CategoryResponseObject[["subCategoryCount"]] <-
          self$`subCategoryCount`
      }
      if (!is.null(self$`parentId`)) {
        CategoryResponseObject[["parentId"]] <-
          self$`parentId`
      }
      if (!is.null(self$`parentName`)) {
        CategoryResponseObject[["parentName"]] <-
          self$`parentName`
      }
      if (!is.null(self$`description`)) {
        CategoryResponseObject[["description"]] <-
          self$`description`
      }
      if (!is.null(self$`active`)) {
        CategoryResponseObject[["active"]] <-
          self$`active`
      }
      if (!is.null(self$`asset`)) {
        CategoryResponseObject[["asset"]] <-
          self$extractSimpleType(self$`asset`)
      }
      if (!is.null(self$`favoriteId`)) {
        CategoryResponseObject[["favoriteId"]] <-
          self$`favoriteId`
      }
      if (!is.null(self$`favorite`)) {
        CategoryResponseObject[["favorite"]] <-
          self$`favorite`
      }
      if (!is.null(self$`applicationId`)) {
        CategoryResponseObject[["applicationId"]] <-
          self$`applicationId`
      }
      if (!is.null(self$`type`)) {
        CategoryResponseObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`externalId`)) {
        CategoryResponseObject[["externalId"]] <-
          self$`externalId`
      }
      if (!is.null(self$`externalType`)) {
        CategoryResponseObject[["externalType"]] <-
          self$`externalType`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of CategoryResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of CategoryResponse
    ...
    #' @return CategoryResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CategoryResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of CategoryResponse
    toString = function() {
      self$toJSONString()
    },
...
# CategoryResponse$unlock()
#
## Below is an example to define the print function
# CategoryResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CategoryResponse$lock()
