...
#' @description SearchResponse Class
...
SearchResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new SearchResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `items` = NULL, `count` = NULL, `hasMoreResults` = NULL, `countTotal` = NULL, `start` = NULL, `limit` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
    ...
    #'
    #' @return SearchResponse as a base R list.
    #' @examples
    #' # convert array of SearchResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SearchResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      SearchResponseObject <- list()
      if (!is.null(self$`valid`)) {
        SearchResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        SearchResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        SearchResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        SearchResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        SearchResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        SearchResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        SearchResponseObject[["request"]] <-
      ...
      if (!is.null(self$`count`)) {
        SearchResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`hasMoreResults`)) {
        SearchResponseObject[["hasMoreResults"]] <-
          self$`hasMoreResults`
      }
      if (!is.null(self$`countTotal`)) {
        SearchResponseObject[["countTotal"]] <-
          self$`countTotal`
      }
      if (!is.null(self$`start`)) {
        SearchResponseObject[["start"]] <-
          self$`start`
      }
      if (!is.null(self$`limit`)) {
        SearchResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`returning`)) {
        SearchResponseObject[["returning"]] <-
          self$`returning`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of SearchResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of SearchResponse
    ...
    #' @return SearchResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to SearchResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of SearchResponse
    toString = function() {
      self$toJSONString()
    },
...
# SearchResponse$unlock()
#
## Below is an example to define the print function
# SearchResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
