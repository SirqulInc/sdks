#' Create a new RankFullResponse
#'
#' @description
#' RankFullResponse Class
#'
#' @docType class
#' @title RankFullResponse
#' @description RankFullResponse Class
...
#' @field rankings  list(\link{RankListResponse}) [optional]
#' @field returning  character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
RankFullResponse <- R6::R6Class(
  "RankFullResponse",
  public = list(
    `valid` = NULL,
    `message` = NULL,
    ...
    #' @description
    #' Initialize a new RankFullResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `rankings` = NULL, `returning` = NULL, ...) {
      if (!is.null(`valid`)) {
      ...
      if (!is.null(`rankings`)) {
        stopifnot(is.vector(`rankings`), length(`rankings`) != 0)
        sapply(`rankings`, function(x) stopifnot(R6::is.R6(x)))
    ...
    #'
    #' @return RankFullResponse as a base R list.
    #' @examples
    #' # convert array of RankFullResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RankFullResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RankFullResponseObject <- list()
      if (!is.null(self$`valid`)) {
        RankFullResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        RankFullResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        RankFullResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        RankFullResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        RankFullResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        RankFullResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        RankFullResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`rankings`)) {
        RankFullResponseObject[["rankings"]] <-
          self$extractSimpleType(self$`rankings`)
      }
      if (!is.null(self$`returning`)) {
        RankFullResponseObject[["returning"]] <-
          self$`returning`
      }
      return(RankFullResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of RankFullResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of RankFullResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`rankings`)) {
        self$`rankings` <- ApiClient$new()$deserializeObj(this_object$`rankings`, "array[RankListResponse]", loadNamespace("openapi"))
      }
    ...
    #' @return RankFullResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RankFullResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of RankFullResponse
    toString = function() {
      self$toJSONString()
    },
...
# RankFullResponse$unlock()
#
## Below is an example to define the print function
# RankFullResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RankFullResponse$lock()
