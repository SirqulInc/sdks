#' Create a new OfferTransactionResponse
#'
#' @description
#' OfferTransactionResponse Class
#'
#' @docType class
#' @title OfferTransactionResponse
#' @description OfferTransactionResponse Class
...
#' @field purchasedDate  integer [optional]
#' @field usedDate  integer [optional]
#' @field transactionCreated  integer [optional]
#' @field transactionUpdated  integer [optional]
#' @field returning  character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
OfferTransactionResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new OfferTransactionResponse class.
    #'
    #' @param valid valid
    ...
    initialize = function(`valid` = NULL, `message` = NULL, `version` = NULL, `serializeNulls` = NULL, `startTimeLog` = NULL, `errorCode` = NULL, `request` = NULL, `offerLocationId` = NULL, `offerId` = NULL, `retailerId` = NULL, `transactionId` = NULL, `favoriteId` = NULL, `offerName` = NULL, `subTitle` = NULL, `locationName` = NULL, `starts` = NULL, `expires` = NULL, `activated` = NULL, `expiration` = NULL, `redeemableStart` = NULL, `redeemableEnd` = NULL, `distance` = NULL, `offerType` = NULL, `longitude` = NULL, `latitude` = NULL, `favorite` = NULL, `fullPrice` = NULL, `discountPrice` = NULL, `estimatedValue` = NULL, `voucherDiscountPrice` = NULL, `missionListResponse` = NULL, `image` = NULL, `image1` = NULL, `image2` = NULL, `image3` = NULL, `image4` = NULL, `image5` = NULL, `images` = NULL, `barcode` = NULL, `externalUrl` = NULL, `sqootUrl` = NULL, `active` = NULL, `location` = NULL, `subDetails` = NULL, `externalRedeemAuth` = NULL, `externalRedeemOptions` = NULL, `publisher` = NULL, `product` = NULL, `event` = NULL, `media` = NULL, `viewedCount` = NULL, `clickedCount` = NULL, `addedLimit` = NULL, `addedCount` = NULL, `usedCount` = NULL, `removedCount` = NULL, `locationAddedCount` = NULL, `barcodeEntry` = NULL, `barcodeType` = NULL, `ticketsReward` = NULL, `ticketsRewardType` = NULL, `specialOfferType` = NULL, `likeCount` = NULL, `dislikeCount` = NULL, `favoriteCount` = NULL, `noteCount` = NULL, `logId` = NULL, `billableEntityId` = NULL, `responsibleAccountId` = NULL, `availabilitySummary` = NULL, `externalId` = NULL, `parentOffer` = NULL, `address` = NULL, `details` = NULL, `finePrint` = NULL, `retailerPhoneNumber` = NULL, `ticketPriceType` = NULL, `ticketPrice` = NULL, `discountPercentage` = NULL, `paymentFees` = NULL, `voucherPrice` = NULL, `purchasesRemaining` = NULL, `redemptionsRemaining` = NULL, `redemptionStatus` = NULL, `redemptionCode` = NULL, `audiences` = NULL, `audienceCount` = NULL, `walletCount` = NULL, `qrCodeUrl` = NULL, `showRemaining` = NULL, `showRedeemed` = NULL, `purchaseLimit` = NULL, `purchaseLimitPerUser` = NULL, `redemptionLimit` = NULL, `userRedemptionLimit` = NULL, `categories` = NULL, `filters` = NULL, `customer` = NULL, `purchasedDate` = NULL, `usedDate` = NULL, `transactionCreated` = NULL, `transactionUpdated` = NULL, `returning` = NULL, ...) {
      ...
      if (!is.null(`purchasedDate`)) {
        if (!(is.numeric(`purchasedDate`) && length(`purchasedDate`) == 1)) {
          stop(paste("Error! Invalid data for `purchasedDate`. Must be an integer:", `purchasedDate`))
        }
        self$`purchasedDate` <- `purchasedDate`
      }
      if (!is.null(`usedDate`)) {
        if (!(is.numeric(`usedDate`) && length(`usedDate`) == 1)) {
          stop(paste("Error! Invalid data for `usedDate`. Must be an integer:", `usedDate`))
        }
        self$`usedDate` <- `usedDate`
      }
      if (!is.null(`transactionCreated`)) {
        if (!(is.numeric(`transactionCreated`) && length(`transactionCreated`) == 1)) {
          stop(paste("Error! Invalid data for `transactionCreated`. Must be an integer:", `transactionCreated`))
        }
        self$`transactionCreated` <- `transactionCreated`
      }
      if (!is.null(`transactionUpdated`)) {
        if (!(is.numeric(`transactionUpdated`) && length(`transactionUpdated`) == 1)) {
          stop(paste("Error! Invalid data for `transactionUpdated`. Must be an integer:", `transactionUpdated`))
        }
    ...
    #'
    #' @return OfferTransactionResponse as a base R list.
    #' @examples
    #' # convert array of OfferTransactionResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert OfferTransactionResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      OfferTransactionResponseObject <- list()
      if (!is.null(self$`valid`)) {
        OfferTransactionResponseObject[["valid"]] <-
          self$`valid`
      }
      if (!is.null(self$`message`)) {
        OfferTransactionResponseObject[["message"]] <-
          self$`message`
      }
      if (!is.null(self$`version`)) {
        OfferTransactionResponseObject[["version"]] <-
          self$`version`
      }
      if (!is.null(self$`serializeNulls`)) {
        OfferTransactionResponseObject[["serializeNulls"]] <-
          self$`serializeNulls`
      }
      if (!is.null(self$`startTimeLog`)) {
        OfferTransactionResponseObject[["startTimeLog"]] <-
          self$`startTimeLog`
      }
      if (!is.null(self$`errorCode`)) {
        OfferTransactionResponseObject[["errorCode"]] <-
          self$`errorCode`
      }
      if (!is.null(self$`request`)) {
        OfferTransactionResponseObject[["request"]] <-
          self$extractSimpleType(self$`request`)
      }
      if (!is.null(self$`offerLocationId`)) {
        OfferTransactionResponseObject[["offerLocationId"]] <-
          self$`offerLocationId`
      }
      if (!is.null(self$`offerId`)) {
        OfferTransactionResponseObject[["offerId"]] <-
          self$`offerId`
      }
      if (!is.null(self$`retailerId`)) {
        OfferTransactionResponseObject[["retailerId"]] <-
          self$`retailerId`
      }
      if (!is.null(self$`transactionId`)) {
        OfferTransactionResponseObject[["transactionId"]] <-
          self$`transactionId`
      }
      if (!is.null(self$`favoriteId`)) {
        OfferTransactionResponseObject[["favoriteId"]] <-
          self$`favoriteId`
      }
      if (!is.null(self$`offerName`)) {
        OfferTransactionResponseObject[["offerName"]] <-
          self$`offerName`
      }
      if (!is.null(self$`subTitle`)) {
        OfferTransactionResponseObject[["subTitle"]] <-
          self$`subTitle`
      }
      if (!is.null(self$`locationName`)) {
        OfferTransactionResponseObject[["locationName"]] <-
          self$`locationName`
      }
      if (!is.null(self$`starts`)) {
        OfferTransactionResponseObject[["starts"]] <-
          self$`starts`
      }
      if (!is.null(self$`expires`)) {
        OfferTransactionResponseObject[["expires"]] <-
          self$`expires`
      }
      if (!is.null(self$`activated`)) {
        OfferTransactionResponseObject[["activated"]] <-
          self$`activated`
      }
      if (!is.null(self$`expiration`)) {
        OfferTransactionResponseObject[["expiration"]] <-
          self$`expiration`
      }
      if (!is.null(self$`redeemableStart`)) {
        OfferTransactionResponseObject[["redeemableStart"]] <-
          self$`redeemableStart`
      }
      if (!is.null(self$`redeemableEnd`)) {
        OfferTransactionResponseObject[["redeemableEnd"]] <-
          self$`redeemableEnd`
      }
      if (!is.null(self$`distance`)) {
        OfferTransactionResponseObject[["distance"]] <-
          self$`distance`
      }
      if (!is.null(self$`offerType`)) {
        OfferTransactionResponseObject[["offerType"]] <-
          self$`offerType`
      }
      if (!is.null(self$`longitude`)) {
        OfferTransactionResponseObject[["longitude"]] <-
          self$`longitude`
      }
      if (!is.null(self$`latitude`)) {
        OfferTransactionResponseObject[["latitude"]] <-
          self$`latitude`
      }
      if (!is.null(self$`favorite`)) {
        OfferTransactionResponseObject[["favorite"]] <-
          self$`favorite`
      }
      if (!is.null(self$`fullPrice`)) {
        OfferTransactionResponseObject[["fullPrice"]] <-
          self$`fullPrice`
      }
      if (!is.null(self$`discountPrice`)) {
        OfferTransactionResponseObject[["discountPrice"]] <-
          self$`discountPrice`
      }
      if (!is.null(self$`estimatedValue`)) {
        OfferTransactionResponseObject[["estimatedValue"]] <-
          self$`estimatedValue`
      }
      if (!is.null(self$`voucherDiscountPrice`)) {
        OfferTransactionResponseObject[["voucherDiscountPrice"]] <-
          self$`voucherDiscountPrice`
      }
      if (!is.null(self$`missionListResponse`)) {
        OfferTransactionResponseObject[["missionListResponse"]] <-
          self$extractSimpleType(self$`missionListResponse`)
      }
      if (!is.null(self$`image`)) {
        OfferTransactionResponseObject[["image"]] <-
          self$`image`
      }
      if (!is.null(self$`image1`)) {
        OfferTransactionResponseObject[["image1"]] <-
          self$`image1`
      }
      if (!is.null(self$`image2`)) {
        OfferTransactionResponseObject[["image2"]] <-
          self$`image2`
      }
      if (!is.null(self$`image3`)) {
        OfferTransactionResponseObject[["image3"]] <-
          self$`image3`
      }
      if (!is.null(self$`image4`)) {
        OfferTransactionResponseObject[["image4"]] <-
          self$`image4`
      }
      if (!is.null(self$`image5`)) {
        OfferTransactionResponseObject[["image5"]] <-
          self$`image5`
      }
      if (!is.null(self$`images`)) {
        OfferTransactionResponseObject[["images"]] <-
          self$extractSimpleType(self$`images`)
      }
      if (!is.null(self$`barcode`)) {
        OfferTransactionResponseObject[["barcode"]] <-
          self$`barcode`
      }
      if (!is.null(self$`externalUrl`)) {
        OfferTransactionResponseObject[["externalUrl"]] <-
          self$`externalUrl`
      }
      if (!is.null(self$`sqootUrl`)) {
        OfferTransactionResponseObject[["sqootUrl"]] <-
          self$`sqootUrl`
      }
      if (!is.null(self$`active`)) {
        OfferTransactionResponseObject[["active"]] <-
          self$`active`
      }
      if (!is.null(self$`location`)) {
        OfferTransactionResponseObject[["location"]] <-
          self$extractSimpleType(self$`location`)
      }
      if (!is.null(self$`subDetails`)) {
        OfferTransactionResponseObject[["subDetails"]] <-
          self$`subDetails`
      }
      if (!is.null(self$`externalRedeemAuth`)) {
        OfferTransactionResponseObject[["externalRedeemAuth"]] <-
          self$`externalRedeemAuth`
      }
      if (!is.null(self$`externalRedeemOptions`)) {
        OfferTransactionResponseObject[["externalRedeemOptions"]] <-
          self$`externalRedeemOptions`
      }
      if (!is.null(self$`publisher`)) {
        OfferTransactionResponseObject[["publisher"]] <-
          self$`publisher`
      }
      if (!is.null(self$`product`)) {
        OfferTransactionResponseObject[["product"]] <-
          self$extractSimpleType(self$`product`)
      }
      if (!is.null(self$`event`)) {
        OfferTransactionResponseObject[["event"]] <-
          self$extractSimpleType(self$`event`)
      }
      if (!is.null(self$`media`)) {
        OfferTransactionResponseObject[["media"]] <-
          self$extractSimpleType(self$`media`)
      }
      if (!is.null(self$`viewedCount`)) {
        OfferTransactionResponseObject[["viewedCount"]] <-
          self$`viewedCount`
      }
      if (!is.null(self$`clickedCount`)) {
        OfferTransactionResponseObject[["clickedCount"]] <-
          self$`clickedCount`
      }
      if (!is.null(self$`addedLimit`)) {
        OfferTransactionResponseObject[["addedLimit"]] <-
          self$`addedLimit`
      }
      if (!is.null(self$`addedCount`)) {
        OfferTransactionResponseObject[["addedCount"]] <-
          self$`addedCount`
      }
      if (!is.null(self$`usedCount`)) {
        OfferTransactionResponseObject[["usedCount"]] <-
          self$`usedCount`
      }
      if (!is.null(self$`removedCount`)) {
        OfferTransactionResponseObject[["removedCount"]] <-
          self$`removedCount`
      }
      if (!is.null(self$`locationAddedCount`)) {
        OfferTransactionResponseObject[["locationAddedCount"]] <-
          self$`locationAddedCount`
      }
      if (!is.null(self$`barcodeEntry`)) {
        OfferTransactionResponseObject[["barcodeEntry"]] <-
          self$`barcodeEntry`
      }
      if (!is.null(self$`barcodeType`)) {
        OfferTransactionResponseObject[["barcodeType"]] <-
          self$`barcodeType`
      }
      if (!is.null(self$`ticketsReward`)) {
        OfferTransactionResponseObject[["ticketsReward"]] <-
          self$`ticketsReward`
      }
      if (!is.null(self$`ticketsRewardType`)) {
        OfferTransactionResponseObject[["ticketsRewardType"]] <-
          self$`ticketsRewardType`
      }
      if (!is.null(self$`specialOfferType`)) {
        OfferTransactionResponseObject[["specialOfferType"]] <-
          self$`specialOfferType`
      }
      if (!is.null(self$`likeCount`)) {
        OfferTransactionResponseObject[["likeCount"]] <-
          self$`likeCount`
      }
      if (!is.null(self$`dislikeCount`)) {
        OfferTransactionResponseObject[["dislikeCount"]] <-
          self$`dislikeCount`
      }
      if (!is.null(self$`favoriteCount`)) {
        OfferTransactionResponseObject[["favoriteCount"]] <-
          self$`favoriteCount`
      }
      if (!is.null(self$`noteCount`)) {
        OfferTransactionResponseObject[["noteCount"]] <-
          self$`noteCount`
      }
      if (!is.null(self$`logId`)) {
        OfferTransactionResponseObject[["logId"]] <-
          self$`logId`
      }
      if (!is.null(self$`billableEntityId`)) {
        OfferTransactionResponseObject[["billableEntityId"]] <-
          self$`billableEntityId`
      }
      if (!is.null(self$`responsibleAccountId`)) {
        OfferTransactionResponseObject[["responsibleAccountId"]] <-
          self$`responsibleAccountId`
      }
      if (!is.null(self$`availabilitySummary`)) {
        OfferTransactionResponseObject[["availabilitySummary"]] <-
          self$`availabilitySummary`
      }
      if (!is.null(self$`externalId`)) {
        OfferTransactionResponseObject[["externalId"]] <-
          self$`externalId`
      }
      if (!is.null(self$`parentOffer`)) {
        OfferTransactionResponseObject[["parentOffer"]] <-
          self$extractSimpleType(self$`parentOffer`)
      }
      if (!is.null(self$`address`)) {
        OfferTransactionResponseObject[["address"]] <-
          self$`address`
      }
      if (!is.null(self$`details`)) {
        OfferTransactionResponseObject[["details"]] <-
          self$`details`
      }
      if (!is.null(self$`finePrint`)) {
        OfferTransactionResponseObject[["finePrint"]] <-
          self$`finePrint`
      }
      if (!is.null(self$`retailerPhoneNumber`)) {
        OfferTransactionResponseObject[["retailerPhoneNumber"]] <-
          self$`retailerPhoneNumber`
      }
      if (!is.null(self$`ticketPriceType`)) {
        OfferTransactionResponseObject[["ticketPriceType"]] <-
          self$`ticketPriceType`
      }
      if (!is.null(self$`ticketPrice`)) {
        OfferTransactionResponseObject[["ticketPrice"]] <-
          self$`ticketPrice`
      }
      if (!is.null(self$`discountPercentage`)) {
        OfferTransactionResponseObject[["discountPercentage"]] <-
          self$`discountPercentage`
      }
      if (!is.null(self$`paymentFees`)) {
        OfferTransactionResponseObject[["paymentFees"]] <-
          self$`paymentFees`
      }
      if (!is.null(self$`voucherPrice`)) {
        OfferTransactionResponseObject[["voucherPrice"]] <-
          self$`voucherPrice`
      }
      if (!is.null(self$`purchasesRemaining`)) {
        OfferTransactionResponseObject[["purchasesRemaining"]] <-
          self$`purchasesRemaining`
      }
      if (!is.null(self$`redemptionsRemaining`)) {
        OfferTransactionResponseObject[["redemptionsRemaining"]] <-
          self$`redemptionsRemaining`
      }
      if (!is.null(self$`redemptionStatus`)) {
        OfferTransactionResponseObject[["redemptionStatus"]] <-
          self$`redemptionStatus`
      }
      if (!is.null(self$`redemptionCode`)) {
        OfferTransactionResponseObject[["redemptionCode"]] <-
          self$`redemptionCode`
      }
      if (!is.null(self$`audiences`)) {
        OfferTransactionResponseObject[["audiences"]] <-
          self$extractSimpleType(self$`audiences`)
      }
      if (!is.null(self$`audienceCount`)) {
        OfferTransactionResponseObject[["audienceCount"]] <-
          self$`audienceCount`
      }
      if (!is.null(self$`walletCount`)) {
        OfferTransactionResponseObject[["walletCount"]] <-
          self$`walletCount`
      }
      if (!is.null(self$`qrCodeUrl`)) {
        OfferTransactionResponseObject[["qrCodeUrl"]] <-
          self$`qrCodeUrl`
      }
      if (!is.null(self$`showRemaining`)) {
        OfferTransactionResponseObject[["showRemaining"]] <-
          self$`showRemaining`
      }
      if (!is.null(self$`showRedeemed`)) {
        OfferTransactionResponseObject[["showRedeemed"]] <-
          self$`showRedeemed`
      }
      if (!is.null(self$`purchaseLimit`)) {
        OfferTransactionResponseObject[["purchaseLimit"]] <-
          self$`purchaseLimit`
      }
      if (!is.null(self$`purchaseLimitPerUser`)) {
        OfferTransactionResponseObject[["purchaseLimitPerUser"]] <-
          self$`purchaseLimitPerUser`
      }
      if (!is.null(self$`redemptionLimit`)) {
        OfferTransactionResponseObject[["redemptionLimit"]] <-
          self$`redemptionLimit`
      }
      if (!is.null(self$`userRedemptionLimit`)) {
        OfferTransactionResponseObject[["userRedemptionLimit"]] <-
          self$`userRedemptionLimit`
      }
      if (!is.null(self$`categories`)) {
        OfferTransactionResponseObject[["categories"]] <-
          self$extractSimpleType(self$`categories`)
      }
      if (!is.null(self$`filters`)) {
        OfferTransactionResponseObject[["filters"]] <-
          self$extractSimpleType(self$`filters`)
      }
      if (!is.null(self$`customer`)) {
        OfferTransactionResponseObject[["customer"]] <-
          self$extractSimpleType(self$`customer`)
      }
      if (!is.null(self$`purchasedDate`)) {
        OfferTransactionResponseObject[["purchasedDate"]] <-
          self$`purchasedDate`
      }
      if (!is.null(self$`usedDate`)) {
        OfferTransactionResponseObject[["usedDate"]] <-
          self$`usedDate`
      }
      if (!is.null(self$`transactionCreated`)) {
        OfferTransactionResponseObject[["transactionCreated"]] <-
          self$`transactionCreated`
      }
      if (!is.null(self$`transactionUpdated`)) {
        OfferTransactionResponseObject[["transactionUpdated"]] <-
          self$`transactionUpdated`
      }
      if (!is.null(self$`returning`)) {
        OfferTransactionResponseObject[["returning"]] <-
          self$`returning`
      }
      return(OfferTransactionResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of OfferTransactionResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of OfferTransactionResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`purchasedDate`)) {
        self$`purchasedDate` <- this_object$`purchasedDate`
      }
      if (!is.null(this_object$`usedDate`)) {
        self$`usedDate` <- this_object$`usedDate`
      }
      if (!is.null(this_object$`transactionCreated`)) {
        self$`transactionCreated` <- this_object$`transactionCreated`
      }
      if (!is.null(this_object$`transactionUpdated`)) {
        self$`transactionUpdated` <- this_object$`transactionUpdated`
      }
    ...
    #' @return OfferTransactionResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to OfferTransactionResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of OfferTransactionResponse
    toString = function() {
      self$toJSONString()
    },
...
# OfferTransactionResponse$unlock()
#
## Below is an example to define the print function
# OfferTransactionResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OfferTransactionResponse$lock()
