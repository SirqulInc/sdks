...
#include "CppRestOpenAPIClient/api/OptimizeApi.h"
...
OptimizeApi::OptimizeApi( std::shared_ptr<const ApiClient> apiClient )
...
pplx::task<std::map<utility::string_t, std::shared_ptr<ShipmentOrder>>> OptimizeApi::getOptimizationResult(double version, utility::string_t batchID, int32_t start, int32_t limit) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("OptimizeApi->getOptimizationResult does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("OptimizeApi->getOptimizationResult does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        if (localVarResponse.status_code() >= 400)
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling getOptimizationResult: ") + localVarResponse.reason_phrase()
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( localVarContentType.find(localVarResponseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getOptimizationResult: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    {
        std::map<utility::string_t, std::shared_ptr<ShipmentOrder>> localVarResult;
        ...
        if(localVarResponseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            {
                std::shared_ptr<ShipmentOrder> localVarItemObj;
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getOptimizationResult: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<ImportStatuses>> OptimizeApi::requestOptimization(double version, boost::optional<std::shared_ptr<Orders>> body) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("OptimizeApi->requestOptimization does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("OptimizeApi->requestOptimization does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling requestOptimization: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling requestOptimization: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        std::shared_ptr<ImportStatuses> localVarResult(new ImportStatuses());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling requestOptimization: unsupported response type"));
        }
