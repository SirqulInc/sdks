...
#include "CppRestOpenAPIClient/api/CategoryApi.h"
...
CategoryApi::CategoryApi( std::shared_ptr<const ApiClient> apiClient )
...
pplx::task<std::vector<std::shared_ptr<CategoryResponse>>> CategoryApi::categoryDistanceSearch(double version, boost::optional<int64_t> accountId, boost::optional<utility::string_t> keyword, boost::optional<utility::string_t> appKey, boost::optional<utility::string_t> categoryIds, boost::optional<utility::string_t> parentCategoryIds, boost::optional<bool> rootOnly, boost::optional<utility::string_t> sortField, boost::optional<utility::string_t> responseGroup, boost::optional<bool> descending, boost::optional<int32_t> start, boost::optional<int32_t> limit, boost::optional<bool> activeOnly, boost::optional<bool> returnExternal, boost::optional<bool> exactMatch, boost::optional<utility::string_t> type, boost::optional<utility::string_t> externalType, boost::optional<int32_t> minOfferCount, boost::optional<double> latitude, boost::optional<double> longitude, boost::optional<double> range) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("CategoryApi->categoryDistanceSearch does not produce any supported media type"));
    }
    ...
    {
        localVarQueryParams[utility::conversions::to_string_t("parentCategoryIds")] = ApiClient::parameterToString(*parentCategoryIds);
    }
    if (rootOnly)
    {
    ...
    if (returnExternal)
    {
        localVarQueryParams[utility::conversions::to_string_t("returnExternal")] = ApiClient::parameterToString(*returnExternal);
    }
    if (exactMatch)
    {
    ...
    if (minOfferCount)
    {
        localVarQueryParams[utility::conversions::to_string_t("minOfferCount")] = ApiClient::parameterToString(*minOfferCount);
    }
    if (latitude)
    {
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("CategoryApi->categoryDistanceSearch does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        if (localVarResponse.status_code() >= 400)
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling categoryDistanceSearch: ") + localVarResponse.reason_phrase()
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( localVarContentType.find(localVarResponseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling categoryDistanceSearch: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    {
        std::vector<std::shared_ptr<CategoryResponse>> localVarResult;
        ...
        if(localVarResponseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            {
                std::shared_ptr<CategoryResponse> localVarItemObj;
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling categoryDistanceSearch: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<CategoryTreeResponse>> CategoryApi::createCategory(double version, int64_t accountId, utility::string_t name, boost::optional<utility::string_t> appKey, boost::optional<int64_t> parentCategoryId, boost::optional<utility::string_t> description, boost::optional<utility::string_t> type, boost::optional<int64_t> assetId, boost::optional<utility::string_t> externalId, boost::optional<utility::string_t> externalType, boost::optional<utility::string_t> externalCategorySlug, boost::optional<utility::string_t> sqootSlug, boost::optional<bool> active, boost::optional<utility::string_t> metaData, boost::optional<utility::string_t> searchTags) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("CategoryApi->createCategory does not produce any supported media type"));
    }
    ...
    if (parentCategoryId)
    {
        localVarQueryParams[utility::conversions::to_string_t("parentCategoryId")] = ApiClient::parameterToString(*parentCategoryId);
    }
    if (description)
    {
    ...
    {
        localVarQueryParams[utility::conversions::to_string_t("externalCategorySlug")] = ApiClient::parameterToString(*externalCategorySlug);
    }
    if (sqootSlug)
    {
        localVarQueryParams[utility::conversions::to_string_t("sqootSlug")] = ApiClient::parameterToString(*sqootSlug);
    }
    if (active)
    {
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("CategoryApi->createCategory does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling createCategory: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling createCategory: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        std::shared_ptr<CategoryTreeResponse> localVarResult(new CategoryTreeResponse());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling createCategory: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<SirqulResponse>> CategoryApi::deleteCategory(double version, int64_t accountId, int64_t categoryId) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("CategoryApi->deleteCategory does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("CategoryApi->deleteCategory does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling deleteCategory: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling deleteCategory: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling deleteCategory: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<CategoryTreeResponse>> CategoryApi::duplicateCategory(double version, int64_t accountId, int64_t categoryId, boost::optional<utility::string_t> appKey, boost::optional<int64_t> parentCategoryId) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("CategoryApi->duplicateCategory does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("CategoryApi->duplicateCategory does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling duplicateCategory: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling duplicateCategory: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling duplicateCategory: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<CategoryTreeResponse>> CategoryApi::getCategory(double version, int64_t categoryId, boost::optional<bool> returnExternal) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("CategoryApi->getCategory does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("CategoryApi->getCategory does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling getCategory: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getCategory: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getCategory: unsupported response type"));
        }
...
pplx::task<std::vector<std::shared_ptr<CategoryResponse>>> CategoryApi::searchCategories(double version, boost::optional<int64_t> accountId, boost::optional<utility::string_t> keyword, boost::optional<utility::string_t> appKey, boost::optional<utility::string_t> categoryId, boost::optional<utility::string_t> categoryIds, boost::optional<utility::string_t> parentCategoryIds, boost::optional<bool> rootOnly, boost::optional<utility::string_t> sortField, boost::optional<utility::string_t> responseGroup, boost::optional<bool> descending, boost::optional<int32_t> start, boost::optional<int32_t> limit, boost::optional<bool> activeOnly, boost::optional<bool> returnExternal, boost::optional<bool> exactMatch, boost::optional<utility::string_t> type, boost::optional<utility::string_t> externalType, boost::optional<bool> excludeExternalType, boost::optional<int32_t> minOfferCount, boost::optional<int32_t> searchDepth, boost::optional<utility::string_t> searchMode) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("CategoryApi->searchCategories does not produce any supported media type"));
    }
    ...
    {
        localVarQueryParams[utility::conversions::to_string_t("excludeExternalType")] = ApiClient::parameterToString(*excludeExternalType);
    }
    if (minOfferCount)
    {
        localVarQueryParams[utility::conversions::to_string_t("minOfferCount")] = ApiClient::parameterToString(*minOfferCount);
    ...
    if (searchDepth)
    {
        localVarQueryParams[utility::conversions::to_string_t("searchDepth")] = ApiClient::parameterToString(*searchDepth);
    }
    if (searchMode)
    {
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("CategoryApi->searchCategories does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling searchCategories: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling searchCategories: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling searchCategories: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<CategoryTreeResponse>> CategoryApi::updateCategory(double version, int64_t accountId, int64_t categoryId, boost::optional<int64_t> parentCategoryId, boost::optional<utility::string_t> name, boost::optional<utility::string_t> description, boost::optional<utility::string_t> type, boost::optional<int64_t> assetId, boost::optional<utility::string_t> externalId, boost::optional<utility::string_t> externalType, boost::optional<utility::string_t> externalCategorySlug, boost::optional<utility::string_t> sqootSlug, boost::optional<bool> active, boost::optional<utility::string_t> metaData, boost::optional<utility::string_t> searchTags) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("CategoryApi->updateCategory does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("CategoryApi->updateCategory does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling updateCategory: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling updateCategory: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling updateCategory: unsupported response type"));
        }
