...
#include "CppRestOpenAPIClient/api/CarrierApi.h"
...
CarrierApi::CarrierApi( std::shared_ptr<const ApiClient> apiClient )
...
pplx::task<std::vector<std::shared_ptr<CellCarrierResponse>>> CarrierApi::searchCarriers(boost::optional<utility::string_t> keyword, boost::optional<bool> descending, boost::optional<int32_t> start, boost::optional<int32_t> limit, boost::optional<bool> activeOnly) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("CarrierApi->searchCarriers does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("CarrierApi->searchCarriers does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        if (localVarResponse.status_code() >= 400)
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling searchCarriers: ") + localVarResponse.reason_phrase()
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( localVarContentType.find(localVarResponseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling searchCarriers: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    {
        std::vector<std::shared_ptr<CellCarrierResponse>> localVarResult;
        ...
        if(localVarResponseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            {
                std::shared_ptr<CellCarrierResponse> localVarItemObj;
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling searchCarriers: unsupported response type"));
        }
