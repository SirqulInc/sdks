...
#include "CppRestOpenAPIClient/api/FacebookApi.h"
...
pplx::task<std::shared_ptr<TokenResponse>> FacebookApi::getToken(double version, boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<double> latitude, boost::optional<double> longitude) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("FacebookApi->getToken does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("FacebookApi->getToken does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<SirqulResponse>> FacebookApi::graphInterface(double version, utility::string_t event, boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<utility::string_t> permissionableType, boost::optional<int64_t> permissionableId, boost::optional<int64_t> assetId, boost::optional<utility::string_t> gameType, boost::optional<utility::string_t> appKey, boost::optional<double> latitude, boost::optional<double> longitude) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("FacebookApi->graphInterface does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("FacebookApi->graphInterface does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling graphInterface: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling graphInterface: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling graphInterface: unsupported response type"));
        }
