...
#include "CppRestOpenAPIClient/api/UserPermissionsApi.h"
...
UserPermissionsApi::UserPermissionsApi( std::shared_ptr<const ApiClient> apiClient )
...
pplx::task<std::shared_ptr<SirqulResponse>> UserPermissionsApi::addUsersToPermissionable(double version, utility::string_t permissionableType, int64_t permissionableId, boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<bool> read, boost::optional<bool> write, boost::optional<bool> r_delete, boost::optional<bool> add, boost::optional<utility::string_t> connectionIds, boost::optional<utility::string_t> connectionAccountIds, boost::optional<utility::string_t> connectionGroupIds, boost::optional<bool> pending, boost::optional<bool> admin, boost::optional<bool> includeFriendGroup, boost::optional<double> latitude, boost::optional<double> longitude, boost::optional<utility::string_t> audienceIds) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("UserPermissionsApi->addUsersToPermissionable does not produce any supported media type"));
    }
    ...
    if (pending)
    {
        localVarQueryParams[utility::conversions::to_string_t("pending")] = ApiClient::parameterToString(*pending);
    }
    if (admin)
    {
        localVarQueryParams[utility::conversions::to_string_t("admin")] = ApiClient::parameterToString(*admin);
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("UserPermissionsApi->addUsersToPermissionable does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        if (localVarResponse.status_code() >= 400)
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling addUsersToPermissionable: ") + localVarResponse.reason_phrase()
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( localVarContentType.find(localVarResponseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling addUsersToPermissionable: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling addUsersToPermissionable: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<SirqulResponse>> UserPermissionsApi::approvePermissionable(double version, utility::string_t permissionableType, int64_t permissionableId, boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<utility::string_t> approvalStatus) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("UserPermissionsApi->approvePermissionable does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("UserPermissionsApi->approvePermissionable does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling approvePermissionable: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling approvePermissionable: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling approvePermissionable: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<SirqulResponse>> UserPermissionsApi::leaveFromPermissionable(double version, utility::string_t permissionableType, int64_t permissionableId, boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<double> latitude, boost::optional<double> longitude) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("UserPermissionsApi->leaveFromPermissionable does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("UserPermissionsApi->leaveFromPermissionable does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling leaveFromPermissionable: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling leaveFromPermissionable: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling leaveFromPermissionable: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<SirqulResponse>> UserPermissionsApi::removeUsersFromPermissionable(double version, utility::string_t permissionableType, int64_t permissionableId, boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<utility::string_t> connectionIds, boost::optional<utility::string_t> connectionAccountIds, boost::optional<utility::string_t> connectionGroupIds, boost::optional<bool> removeFriendGroup, boost::optional<double> latitude, boost::optional<double> longitude, boost::optional<utility::string_t> audienceIds) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("UserPermissionsApi->removeUsersFromPermissionable does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("UserPermissionsApi->removeUsersFromPermissionable does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling removeUsersFromPermissionable: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling removeUsersFromPermissionable: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling removeUsersFromPermissionable: unsupported response type"));
        }
...
pplx::task<std::vector<std::shared_ptr<UserPermissionsResponse>>> UserPermissionsApi::searchPermissionables(double version, boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<int64_t> connectionAccountId, boost::optional<utility::string_t> connectionAccountIds, boost::optional<utility::string_t> permissionableType, boost::optional<int64_t> permissionableId, boost::optional<utility::string_t> keyword, boost::optional<utility::string_t> sortField, boost::optional<bool> descending, boost::optional<bool> pending, boost::optional<bool> admin, boost::optional<int32_t> start, boost::optional<int32_t> limit) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("UserPermissionsApi->searchPermissionables does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("UserPermissionsApi->searchPermissionables does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling searchPermissionables: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling searchPermissionables: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        std::vector<std::shared_ptr<UserPermissionsResponse>> localVarResult;
        ...
        if(localVarResponseHttpContentType == utility::conversions::to_string_t("application/json"))
        {
            ...
            {
                std::shared_ptr<UserPermissionsResponse> localVarItemObj;
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling searchPermissionables: unsupported response type"));
        }
...
pplx::task<std::vector<std::shared_ptr<UserPermissionsResponse>>> UserPermissionsApi::searchPermissionablesFollowingDistance(double version, double latitude, double longitude, boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<int64_t> connectionAccountId, boost::optional<utility::string_t> connectionAccountIds, boost::optional<utility::string_t> permissionableType, boost::optional<int64_t> permissionableId, boost::optional<double> searchRange, boost::optional<utility::string_t> keyword, boost::optional<bool> pending, boost::optional<bool> admin, boost::optional<int32_t> start, boost::optional<int32_t> limit) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("UserPermissionsApi->searchPermissionablesFollowingDistance does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("UserPermissionsApi->searchPermissionablesFollowingDistance does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling searchPermissionablesFollowingDistance: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling searchPermissionablesFollowingDistance: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling searchPermissionablesFollowingDistance: unsupported response type"));
        }
