...
#include "CppRestOpenAPIClient/api/WalletApi.h"
...
pplx::task<std::vector<std::shared_ptr<OfferTransactionResponse>>> WalletApi::createOfferTransaction(boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<int64_t> offerId, boost::optional<int64_t> offerLocationId, boost::optional<utility::string_t> offerCart, boost::optional<utility::string_t> promoCode, boost::optional<utility::string_t> currencyType, boost::optional<bool> usePoints, boost::optional<utility::string_t> metaData, boost::optional<utility::string_t> appKey, boost::optional<int32_t> status) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("WalletApi->createOfferTransaction does not produce any supported media type"));
    }
    ...
    if (offerCart)
    {
        localVarQueryParams[utility::conversions::to_string_t("offerCart")] = ApiClient::parameterToString(*offerCart);
    }
    if (promoCode)
    {
    ...
    if (usePoints)
    {
        localVarQueryParams[utility::conversions::to_string_t("usePoints")] = ApiClient::parameterToString(*usePoints);
    }
    if (metaData)
    {
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("WalletApi->createOfferTransaction does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        if (localVarResponse.status_code() >= 400)
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling createOfferTransaction: ") + localVarResponse.reason_phrase()
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( localVarContentType.find(localVarResponseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling createOfferTransaction: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling createOfferTransaction: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<SirqulResponse>> WalletApi::deleteOfferTransaction(int64_t transactionId, boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("WalletApi->deleteOfferTransaction does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("WalletApi->deleteOfferTransaction does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling deleteOfferTransaction: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling deleteOfferTransaction: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling deleteOfferTransaction: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<OfferTransactionResponse>> WalletApi::getOfferTransaction(int64_t transactionId, boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<bool> includeMission, boost::optional<double> latitude, boost::optional<double> longitude, boost::optional<bool> returnFullResponse) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("WalletApi->getOfferTransaction does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("WalletApi->getOfferTransaction does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling getOfferTransaction: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getOfferTransaction: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        std::shared_ptr<OfferTransactionResponse> localVarResult(new OfferTransactionResponse());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getOfferTransaction: unsupported response type"));
        }
...
pplx::task<std::vector<std::shared_ptr<OfferTransactionResponse>>> WalletApi::previewOfferTransaction(boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<int64_t> offerId, boost::optional<int64_t> offerLocationId, boost::optional<utility::string_t> offerCart, boost::optional<utility::string_t> promoCode, boost::optional<utility::string_t> currencyType, boost::optional<bool> usePoints, boost::optional<utility::string_t> metaData, boost::optional<utility::string_t> appKey) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("WalletApi->previewOfferTransaction does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("WalletApi->previewOfferTransaction does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling previewOfferTransaction: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling previewOfferTransaction: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling previewOfferTransaction: unsupported response type"));
        }
...
pplx::task<std::vector<std::shared_ptr<OfferTransactionResponse>>> WalletApi::searchOfferTransactions(boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<utility::string_t> keyword, boost::optional<int64_t> retailerId, boost::optional<utility::string_t> retailerIds, boost::optional<int64_t> retailerLocationId, boost::optional<utility::string_t> retailerLocationIds, boost::optional<utility::string_t> excludeRetailerLocationIds, boost::optional<int64_t> offerId, boost::optional<utility::string_t> offerIds, boost::optional<int64_t> offerLocationId, boost::optional<utility::string_t> offerLocationIds, boost::optional<utility::string_t> offerType, boost::optional<utility::string_t> offerTypes, boost::optional<utility::string_t> specialOfferType, boost::optional<utility::string_t> specialOfferTypes, boost::optional<utility::string_t> categoryIds, boost::optional<utility::string_t> filterIds, boost::optional<utility::string_t> offerAudienceIds, boost::optional<utility::string_t> sortField, boost::optional<bool> descending, boost::optional<int32_t> start, boost::optional<int32_t> limit, boost::optional<double> latitude, boost::optional<double> longitude, boost::optional<int64_t> redeemableStartDate, boost::optional<int64_t> redeemableEndDate, boost::optional<bool> filterByParentOffer, boost::optional<int64_t> startedSince, boost::optional<int64_t> startedBefore, boost::optional<int64_t> endedSince, boost::optional<int64_t> endedBefore, boost::optional<bool> redeemed, boost::optional<utility::string_t> statuses, boost::optional<bool> reservationsOnly, boost::optional<bool> activeOnly, boost::optional<bool> returnFullResponse, boost::optional<int64_t> recurringStartedSince, boost::optional<int64_t> recurringStartedBefore, boost::optional<int64_t> recurringExpirationSince, boost::optional<int64_t> recurringExpirationBefore) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("WalletApi->searchOfferTransactions does not produce any supported media type"));
    }
    ...
    {
        localVarQueryParams[utility::conversions::to_string_t("excludeRetailerLocationIds")] = ApiClient::parameterToString(*excludeRetailerLocationIds);
    }
    if (offerId)
    {
        localVarQueryParams[utility::conversions::to_string_t("offerId")] = ApiClient::parameterToString(*offerId);
    ...
    {
        localVarQueryParams[utility::conversions::to_string_t("filterByParentOffer")] = ApiClient::parameterToString(*filterByParentOffer);
    }
    if (startedSince)
    {
    ...
    if (recurringStartedSince)
    {
        localVarQueryParams[utility::conversions::to_string_t("recurringStartedSince")] = ApiClient::parameterToString(*recurringStartedSince);
    }
    if (recurringStartedBefore)
    {
        localVarQueryParams[utility::conversions::to_string_t("recurringStartedBefore")] = ApiClient::parameterToString(*recurringStartedBefore);
    }
    if (recurringExpirationSince)
    {
        localVarQueryParams[utility::conversions::to_string_t("recurringExpirationSince")] = ApiClient::parameterToString(*recurringExpirationSince);
    }
    if (recurringExpirationBefore)
    {
        localVarQueryParams[utility::conversions::to_string_t("recurringExpirationBefore")] = ApiClient::parameterToString(*recurringExpirationBefore);
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("WalletApi->searchOfferTransactions does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling searchOfferTransactions: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling searchOfferTransactions: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling searchOfferTransactions: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<OfferTransactionResponse>> WalletApi::updateOfferTransaction(int64_t transactionId, int32_t status, boost::optional<utility::string_t> deviceId, boost::optional<int64_t> accountId, boost::optional<int64_t> offerLocationId, boost::optional<utility::string_t> currencyType, boost::optional<bool> usePoints, boost::optional<utility::string_t> appKey, boost::optional<double> latitude, boost::optional<double> longitude, boost::optional<utility::string_t> metaData, boost::optional<bool> returnFullResponse, boost::optional<utility::string_t> exceptionMembershipOfferIds) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("WalletApi->updateOfferTransaction does not produce any supported media type"));
    }
    ...
    {
        localVarQueryParams[utility::conversions::to_string_t("exceptionMembershipOfferIds")] = ApiClient::parameterToString(*exceptionMembershipOfferIds);
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("WalletApi->updateOfferTransaction does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling updateOfferTransaction: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling updateOfferTransaction: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling updateOfferTransaction: unsupported response type"));
        }
