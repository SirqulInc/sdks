...
#include "CppRestOpenAPIClient/api/DependentApi.h"
...
DependentApi::DependentApi( std::shared_ptr<const ApiClient> apiClient )
...
pplx::task<std::shared_ptr<SirqulResponse>> DependentApi::create(double version, int64_t accountId, boost::optional<std::shared_ptr<Account>> body) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("DependentApi->create does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("DependentApi->create does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<SirqulResponse>> DependentApi::getDependents(double version, int64_t accountId) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("DependentApi->getDependents does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("DependentApi->getDependents does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling getDependents: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getDependents: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=, this](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getDependents: unsupported response type"));
        }
...
pplx::task<void> DependentApi::removeDependent(double version, int64_t accountId, int64_t dependentId) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("DependentApi->removeDependent does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("DependentApi->removeDependent does not consume any supported media type"));
    }
    ...
    .then([=, this](web::http::http_response localVarResponse)
    {
        ...
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling removeDependent: ") + localVarResponse.reason_phrase()
                , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
        }
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling removeDependent: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
