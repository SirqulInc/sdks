...
void TerritoryResponse::validate()
{
    // TODO: implement validation
}

web::json::value TerritoryResponse::toJson() const
{
...
bool TerritoryResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TerritoryResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TerritoryResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
void TerritoryResponse::setId(int64_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
utility::string_t TerritoryResponse::getName() const
{
    return m_Name;
}


void TerritoryResponse::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
