...
class ImportStatuses(BaseModel):
    """
    ImportStatuses
    """ # noqa: E501
    statuses: Optional[List[ShipmentImportStatus]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImportStatuses from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImportStatuses from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "statuses": [ShipmentImportStatus.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
