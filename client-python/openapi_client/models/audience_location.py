...
class AudienceLocation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "active", "valid", "latitude", "longitude", "locationDescription", "radius"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AudienceLocation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AudienceLocation from a dict"""
        if obj is None:
            return None
