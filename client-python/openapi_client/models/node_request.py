...
class NodeRequest(BaseModel):
    ...
    is_waypoint: Optional[StrictBool] = Field(default=None, alias="isWaypoint")
    account_id: Optional[StrictInt] = Field(default=None, alias="accountId")
    node: Optional[Node] = None
    __properties: ClassVar[List[str]] = ["x", "y", "z", "latitude", "longitude", "altitude", "date", "isWaypoint", "accountId", "node"]
