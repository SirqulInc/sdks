...
class CategoryResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["categoryId", "name", "display", "subCategoryCount", "parentId", "parentName", "description", "active", "asset", "favoriteId", "favorite", "applicationId", "type", "externalId", "externalType"]
