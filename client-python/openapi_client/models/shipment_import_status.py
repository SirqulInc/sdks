...
class ShipmentImportStatus(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "active", "valid", "name", "batchId", "message", "shipment", "started", "completed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShipmentImportStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShipmentImportStatus from a dict"""
        if obj is None:
            return None
