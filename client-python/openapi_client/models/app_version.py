...
class AppVersion(BaseModel):
    ...
    version_index: Optional[StrictInt] = Field(default=None, alias="versionIndex")
    __properties: ClassVar[List[str]] = ["minorVersion", "majorVersion", "versionIndex"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versionIndex": obj.get("versionIndex")
        })
        return _obj
