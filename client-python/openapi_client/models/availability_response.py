...
class AvailabilityResponse(BaseModel):
    ...
    """ # noqa: E501
    availability_id: Optional[StrictInt] = Field(default=None, alias="availabilityId")
    ...
    __properties: ClassVar[List[str]] = ["availabilityId", "startDate", "endDate", "dayOfWeek", "startTime", "endTime", "timeZone", "deleted"]
