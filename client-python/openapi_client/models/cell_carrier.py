...
class CellCarrier(BaseModel):
    ...
    email_format: Optional[StrictStr] = Field(default=None, alias="emailFormat")
    ...
    __properties: ClassVar[List[str]] = ["id", "active", "valid", "uid", "display", "emailFormat", "apiUrl", "authUrl", "shortCode", "clientId", "clientSecret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CellCarrier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CellCarrier from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "emailFormat": obj.get("emailFormat"),
