...
class SubscriptionOptionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "price", "quantity", "threshold", "visible", "optionType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionOptionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionOptionResponse from a dict"""
        if obj is None:
            return None
