...
class ListingGroupResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["category", "listings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListingGroupResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListingGroupResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "listings": [ListingResponse.from_dict(_item) for _item in obj["listings"]] if obj.get("listings") is not None else None
        })
        return _obj
