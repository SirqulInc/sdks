...
class Orders(BaseModel):
    ...
    Orders
    """ # noqa: E501
    orders: Optional[List[ShipmentOrder]] = Field(default=None, alias="Orders")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Orders": [ShipmentOrder.from_dict(_item) for _item in obj["Orders"]] if obj.get("Orders") is not None else None
        })
        return _obj
