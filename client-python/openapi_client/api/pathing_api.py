...
class PathingApi:
    ...
    def compute_path(
        ...
        directions: Annotated[StrictBool, Field(description="determines whether to return text directions")],
        ...
        :type units: str
        :param reduce_path: determines whether to reduce the path to go in diagonal lines (required)
    ...
    def _compute_path_serialize(
        ...
        if reduce_path is not None:
            
            _query_params.append(('reducePath', reduce_path))
            
        if directions is not None:
            
            _query_params.append(('directions', directions))
