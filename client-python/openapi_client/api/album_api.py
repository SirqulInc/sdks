...
class AlbumApi:
    ...
    def get_album_collection(
        ...
        device_id: Annotated[Optional[StrictStr], Field(description="a unique ID given by the device (deviceId or accountId required)")] = None,
        account_id: Annotated[Optional[StrictInt], Field(description="the account ID of the user (deviceId or accountId required)")] = None,
        like_preview_size: Annotated[Optional[StrictInt], Field(description="returns the last X likes. To search on and paginate the remaining likes - please use the \"/like/search\"Â endpoint.")] = None,
        asset_preview_size: Annotated[Optional[StrictInt], Field(description="returns the first X assets. To search on and paginate the remaining assets - please use the \"/assets/search\"Â endpoint.")] = None,
