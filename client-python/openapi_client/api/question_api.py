...
class QuestionApi:
    ...
    def create_question(
        ...
        active: Annotated[StrictBool, Field(description="If true set the question to active. Default to false.")],
        ...
        tags: Annotated[Optional[StrictStr], Field(description="The tags of the question for search.")] = None,
        video_url: Annotated[Optional[StrictStr], Field(description="The video link for the question.")] = None,
        asset_id: Annotated[Optional[StrictInt], Field(description="The asset id of the question.")] = None,
    ...
    def _create_question_serialize(
        ...
        if video_url is not None:
            ...
            _query_params.append(('videoURL', video_url))
    ...
    def search_questions(
        ...
        keyword: Annotated[Optional[StrictStr], Field(description="The keyword for searching questions with matching tags or question text.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def update_question(
        ...
        account_id: Annotated[StrictInt, Field(description="The logged in user.")],
        ticket_count: Annotated[StrictInt, Field(description="The number of tickets to reward")],
        question: Annotated[Optional[StrictStr], Field(description="The text of the question.")] = None,
        answers: Annotated[Optional[StrictStr], Field(description="The json representations of answers for the question.")] = None,
        tags: Annotated[Optional[StrictStr], Field(description="The tags of the question for search.")] = None,
        video_url: Annotated[Optional[StrictStr], Field(description="The video link for the question.")] = None,
        asset_id: Annotated[Optional[StrictInt], Field(description="The asset id of the question.")] = None,
        active: Annotated[Optional[StrictBool], Field(description="If true set the question to active.")] = None,
